...
main(void)
{
  ...
  if(open("console", O_RDWR) < 0){
   ...
   e:	f2650513          	addi	a0,a0,-218 # f30 <lock_init+0x1c>
  ...
  28:	f0c50513          	addi	a0,a0,-244 # f30 <lock_init+0x1c>
  2c:	00000097          	auipc	ra,0x0
  30:	5ce080e7          	jalr	1486(ra) # 5fa <mknod>
    open("console", O_RDWR);
  34:	4589                	li	a1,2
  36:	00001517          	auipc	a0,0x1
  3a:	efa50513          	addi	a0,a0,-262 # f30 <lock_init+0x1c>
  ...
  5e:	ede50513          	addi	a0,a0,-290 # f38 <lock_init+0x24>
  ...
  86:	ece50513          	addi	a0,a0,-306 # f50 <lock_init+0x3c>
  ...
  a8:	f5458593          	addi	a1,a1,-172 # ff8 <argv>
  ac:	00001517          	auipc	a0,0x1
  b0:	e7c50513          	addi	a0,a0,-388 # f28 <lock_init+0x14>
  b4:	00000097          	auipc	ra,0x0
  b8:	536080e7          	jalr	1334(ra) # 5ea <exec>
      printf("init: exec sh failed\n");
  bc:	00001517          	auipc	a0,0x1
  c0:	eac50513          	addi	a0,a0,-340 # f68 <lock_init+0x54>
 ...
 106:	e7e50513          	addi	a0,a0,-386 # f80 <lock_init+0x6c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 712:	8fa68693          	addi	a3,a3,-1798 # 1008 <digits>
...
printptr(int fd, uint64 x) {
 ...
 7e6:	82670713          	addi	a4,a4,-2010 # 1008 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 9a6:	5fe78793          	addi	a5,a5,1534 # fa0 <lock_init+0x8c>
...
free(void *ap)
{
 ...
 b52:	4e278793          	addi	a5,a5,1250 # 1030 <freep>
 b56:	639c                	ld	a5,0(a5)
 ...
 c4a:	3ea78793          	addi	a5,a5,1002 # 1030 <freep>
...
malloc(uint nbytes)
{
 ...
 cfe:	33678793          	addi	a5,a5,822 # 1030 <freep>
 d02:	639c                	ld	a5,0(a5)
 ...
 d12:	31278793          	addi	a5,a5,786 # 1020 <base>
 ...
 d40:	2e478793          	addi	a5,a5,740 # 1020 <base>
 ...
 dd0:	26478793          	addi	a5,a5,612 # 1030 <freep>
 dd4:	639c                	ld	a5,0(a5)
...
int thread_create(void (*start_routine)(void*),  void *arg){
 ...
 e40:	16c50513          	addi	a0,a0,364 # fa8 <lock_init+0x94>
...
void lock_acquire (lock_t *)
{
 ...
 efa:	0001                	nop
 efc:	6462                	ld	s0,24(sp)
 efe:	6105                	addi	sp,sp,32
 f00:	8082                	ret

0000000000000f02 <lock_release>:
...
0000000000000f14 <lock_init>:

void lock_init (lock_t *)
{
 f14:	1101                	addi	sp,sp,-32
 f16:	ec22                	sd	s0,24(sp)
 f18:	1000                	addi	s0,sp,32
 f1a:	fea43423          	sd	a0,-24(s0)
