...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
      ...
      22:	0d278793          	addi	a5,a5,210 # 10f0 <ppid>
      26:	c398                	sw	a4,0(a5)
   ...
   assert(fork_pid > 0);
      ...
      58:	fbc58593          	addi	a1,a1,-68 # 1010 <cv_init+0x18>
      5c:	00001517          	auipc	a0,0x1
      60:	fc450513          	addi	a0,a0,-60 # 1020 <cv_init+0x28>
      64:	00001097          	auipc	ra,0x1
      68:	ab6080e7          	jalr	-1354(ra) # b1a <printf>
      6c:	00001597          	auipc	a1,0x1
      70:	fbc58593          	addi	a1,a1,-68 # 1028 <cv_init+0x30>
      74:	00001517          	auipc	a0,0x1
      78:	fc450513          	addi	a0,a0,-60 # 1038 <cv_init+0x40>
      7c:	00001097          	auipc	ra,0x1
      80:	a9e080e7          	jalr	-1378(ra) # b1a <printf>
      84:	00001517          	auipc	a0,0x1
      88:	fcc50513          	addi	a0,a0,-52 # 1050 <cv_init+0x58>
      8c:	00001097          	auipc	ra,0x1
      90:	a8e080e7          	jalr	-1394(ra) # b1a <printf>
      94:	00001797          	auipc	a5,0x1
      98:	05c78793          	addi	a5,a5,92 # 10f0 <ppid>
      9c:	439c                	lw	a5,0(a5)
      9e:	853e                	mv	a0,a5
   ...
   printf("TEST PASSED\n");
     ...
     13a:	f3a50513          	addi	a0,a0,-198 # 1070 <cv_init+0x78>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     742:	99a68693          	addi	a3,a3,-1638 # 10d8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     816:	8c670713          	addi	a4,a4,-1850 # 10d8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     9d6:	6ae78793          	addi	a5,a5,1710 # 1080 <cv_init+0x88>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     b82:	58a78793          	addi	a5,a5,1418 # 1108 <freep>
     b86:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     c7a:	49278793          	addi	a5,a5,1170 # 1108 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     cfc:	41078793          	addi	a5,a5,1040 # 1108 <freep>
     d00:	639c                	ld	a5,0(a5)
}
     d02:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d2e:	3de78793          	addi	a5,a5,990 # 1108 <freep>
     d32:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d42:	3ba78793          	addi	a5,a5,954 # 10f8 <base>
     d46:	fef43023          	sd	a5,-32(s0)
     d4a:	00000797          	auipc	a5,0x0
     d4e:	3be78793          	addi	a5,a5,958 # 1108 <freep>
     d52:	fe043703          	ld	a4,-32(s0)
     d56:	e398                	sd	a4,0(a5)
     d58:	00000797          	auipc	a5,0x0
     d5c:	3b078793          	addi	a5,a5,944 # 1108 <freep>
     d60:	6398                	ld	a4,0(a5)
     d62:	00000797          	auipc	a5,0x0
     d66:	39678793          	addi	a5,a5,918 # 10f8 <base>
     d6a:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     d6c:	00000797          	auipc	a5,0x0
     d70:	38c78793          	addi	a5,a5,908 # 10f8 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     dea:	32278793          	addi	a5,a5,802 # 1108 <freep>
    ...
    if(p == freep)
     ...
     e00:	30c78793          	addi	a5,a5,780 # 1108 <freep>
     e04:	639c                	ld	a5,0(a5)
...
int thread_create(void (*start_routine)(void*),  void *arg){
    ...
    if (!(stack = malloc (PAGE_SIZE))){
     ...
     e70:	21c50513          	addi	a0,a0,540 # 1088 <cv_init+0x90>
...
void lock_acquire (lock_t *lock){
    ...
    while( __sync_lock_test_and_set(lock, 1)!=0){
     ...
     f30:	4705                	li	a4,1
     f32:	0ce7a72f          	amoswap.w.aq	a4,a4,(a5)
     f36:	0007079b          	sext.w	a5,a4
     f3a:	fbed                	bnez	a5,f2c <lock_acquire+0xc>
    ...
    ;
     ...
     f40:	0001                	nop
     f42:	6462                	ld	s0,24(sp)
     f44:	6105                	addi	sp,sp,32
     f46:	8082                	ret

0000000000000f48 <lock_release>:

void lock_release (lock_t *lock){
     f48:	1101                	addi	sp,sp,-32
     f4a:	ec22                	sd	s0,24(sp)
    ...
    __sync_lock_release(lock);
     ...
     f5a:	0f50000f          	fence	iorw,ow
     f5e:	0807a02f          	amoswap.w	zero,zero,(a5)
   
}
     f62:	0001                	nop
     f64:	6462                	ld	s0,24(sp)
     f66:	6105                	addi	sp,sp,32
     f68:	8082                	ret

0000000000000f6a <lock_init>:

void lock_init (lock_t *lock){
     f6a:	1101                	addi	sp,sp,-32
     f6c:	ec22                	sd	s0,24(sp)
     f6e:	1000                	addi	s0,sp,32
     f70:	fea43423          	sd	a0,-24(s0)
    lock = 0;
     f74:	fe043423          	sd	zero,-24(s0)
    
}
     f78:	0001                	nop
     f7a:	6462                	ld	s0,24(sp)
     f7c:	6105                	addi	sp,sp,32
     f7e:	8082                	ret

0000000000000f80 <cv_wait>:
...
void cv_wait (cont_t *cv, lock_t *lock){
    ...
    while( __sync_lock_test_and_set(cv, 0)!=1){
     f90:	a015                	j	fb4 <cv_wait+0x34>
        lock_release(lock);
     f92:	fe043503          	ld	a0,-32(s0)
     f96:	00000097          	auipc	ra,0x0
     f9a:	fb2080e7          	jalr	-78(ra) # f48 <lock_release>
        sleep(1);
     f9e:	4505                	li	a0,1
     fa0:	fffff097          	auipc	ra,0xfffff
     fa4:	6d2080e7          	jalr	1746(ra) # 672 <sleep>
        lock_acquire(lock);
     fa8:	fe043503          	ld	a0,-32(s0)
     fac:	00000097          	auipc	ra,0x0
     fb0:	f74080e7          	jalr	-140(ra) # f20 <lock_acquire>
    while( __sync_lock_test_and_set(cv, 0)!=1){
     fb4:	fe843783          	ld	a5,-24(s0)
     fb8:	4701                	li	a4,0
     fba:	0ce7a72f          	amoswap.w.aq	a4,a4,(a5)
     fbe:	0007079b          	sext.w	a5,a4
     fc2:	873e                	mv	a4,a5
     fc4:	4785                	li	a5,1
     fc6:	fcf716e3          	bne	a4,a5,f92 <cv_wait+0x12>
    }
...
void cv_init (cont_t *cv){
    ...
    cv = 0;
    1002:	fe043423          	sd	zero,-24(s0)
    1006:	0001                	nop
    1008:	6462                	ld	s0,24(sp)
