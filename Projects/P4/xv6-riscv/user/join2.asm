...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
      ...
      22:	57278793          	addi	a5,a5,1394 # 1590 <ppid>
      26:	c398                	sw	a4,0(a5)
   ...
   assert(stack != NULL);
      ...
      42:	36a58593          	addi	a1,a1,874 # 13a8 <cv_init+0x1c>
      46:	00001517          	auipc	a0,0x1
      4a:	37250513          	addi	a0,a0,882 # 13b8 <cv_init+0x2c>
      4e:	00001097          	auipc	ra,0x1
      52:	e60080e7          	jalr	-416(ra) # eae <printf>
      56:	00001597          	auipc	a1,0x1
      5a:	36a58593          	addi	a1,a1,874 # 13c0 <cv_init+0x34>
      5e:	00001517          	auipc	a0,0x1
      62:	37250513          	addi	a0,a0,882 # 13d0 <cv_init+0x44>
      66:	00001097          	auipc	ra,0x1
      6a:	e48080e7          	jalr	-440(ra) # eae <printf>
      6e:	00001517          	auipc	a0,0x1
      72:	37a50513          	addi	a0,a0,890 # 13e8 <cv_init+0x5c>
      76:	00001097          	auipc	ra,0x1
      7a:	e38080e7          	jalr	-456(ra) # eae <printf>
      7e:	00001797          	auipc	a5,0x1
      82:	51278793          	addi	a5,a5,1298 # 1590 <ppid>
      86:	439c                	lw	a5,0(a5)
      88:	853e                	mv	a0,a5
   ...
   printf ("Valor de stack: %d\n", stack); 
      ...
      ca:	33250513          	addi	a0,a0,818 # 13f8 <cv_init+0x6c>
   ...
   */
   ...
   printf ("Asignación join_stack: %d\n", (uint64)sbrk(0) - 8);
     ...
     188:	29c50513          	addi	a0,a0,668 # 1420 <cv_init+0x94>
   ...
   printf ("Primer join pasado.\n");
     ...
     226:	24e50513          	addi	a0,a0,590 # 1470 <cv_init+0xe4>
   ...
   printf ("Join stack aqui vale: %d\n", *join_stack);
     ...
     2ba:	1f250513          	addi	a0,a0,498 # 14a8 <cv_init+0x11c>
   ...
   assert(stack == *join_stack);
     ...
     2dc:	0d058593          	addi	a1,a1,208 # 13a8 <cv_init+0x1c>
     2e0:	00001517          	auipc	a0,0x1
     2e4:	0d850513          	addi	a0,a0,216 # 13b8 <cv_init+0x2c>
     2e8:	00001097          	auipc	ra,0x1
     2ec:	bc6080e7          	jalr	-1082(ra) # eae <printf>
     2f0:	00001597          	auipc	a1,0x1
     2f4:	1d858593          	addi	a1,a1,472 # 14c8 <cv_init+0x13c>
     2f8:	00001517          	auipc	a0,0x1
     2fc:	0d850513          	addi	a0,a0,216 # 13d0 <cv_init+0x44>
     300:	00001097          	auipc	ra,0x1
     304:	bae080e7          	jalr	-1106(ra) # eae <printf>
     308:	00001517          	auipc	a0,0x1
     30c:	0e050513          	addi	a0,a0,224 # 13e8 <cv_init+0x5c>
     310:	00001097          	auipc	ra,0x1
     314:	b9e080e7          	jalr	-1122(ra) # eae <printf>
     318:	00001797          	auipc	a5,0x1
     31c:	27878793          	addi	a5,a5,632 # 1590 <ppid>
     320:	439c                	lw	a5,0(a5)
     322:	853e                	mv	a0,a5
   ...
   assert(global == 2);
     ...
     33a:	25678793          	addi	a5,a5,598 # 158c <global>
     33e:	439c                	lw	a5,0(a5)
     340:	873e                	mv	a4,a5
     342:	4789                	li	a5,2
   ...
   printf("TEST PASSED\n");
     ...
     3ae:	14650513          	addi	a0,a0,326 # 14f0 <cv_init+0x164>
...
worker(void *arg_ptr) {
   ...
   assert(global == 1);
     ...
     450:	14078793          	addi	a5,a5,320 # 158c <global>
     454:	439c                	lw	a5,0(a5)
     456:	873e                	mv	a4,a5
     458:	4785                	li	a5,1
   ...
   global++;
     ...
     4c4:	0cc78793          	addi	a5,a5,204 # 158c <global>
     4c8:	439c                	lw	a5,0(a5)
     4ca:	2785                	addiw	a5,a5,1
     4cc:	0007871b          	sext.w	a4,a5
     4d0:	00001797          	auipc	a5,0x1
     4d4:	0bc78793          	addi	a5,a5,188 # 158c <global>
     4d8:	c398                	sw	a4,0(a5)
   exit(0);
     4da:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ad6:	aa668693          	addi	a3,a3,-1370 # 1578 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     baa:	9d270713          	addi	a4,a4,-1582 # 1578 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     d6a:	7ba78793          	addi	a5,a5,1978 # 1520 <cv_init+0x194>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     f16:	69678793          	addi	a5,a5,1686 # 15a8 <freep>
     f1a:	639c                	ld	a5,0(a5)
  ...
  freep = p;
    ...
    100e:	59e78793          	addi	a5,a5,1438 # 15a8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1090:	51c78793          	addi	a5,a5,1308 # 15a8 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    10c2:	4ea78793          	addi	a5,a5,1258 # 15a8 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    117e:	42e78793          	addi	a5,a5,1070 # 15a8 <freep>
    ...
    1194:	41878793          	addi	a5,a5,1048 # 15a8 <freep>
...
int thread_create(void (*start_routine)(void*),  void *arg){
    ...
    1204:	32850513          	addi	a0,a0,808 # 1528 <cv_init+0x19c>
...
void lock_acquire (lock_t *lock){
    ...
    12c4:	4705                	li	a4,1
    12c6:	0ce7a72f          	amoswap.w.aq	a4,a4,(a5)
    12ca:	0007079b          	sext.w	a5,a4
    12ce:	fbed                	bnez	a5,12c0 <lock_acquire+0xc>
    ...
    12d4:	0001                	nop
    12d6:	6462                	ld	s0,24(sp)
    12d8:	6105                	addi	sp,sp,32
    12da:	8082                	ret

00000000000012dc <lock_release>:

void lock_release (lock_t *lock){
    12dc:	1101                	addi	sp,sp,-32
    12de:	ec22                	sd	s0,24(sp)
    12e0:	1000                	addi	s0,sp,32
    12e2:	fea43423          	sd	a0,-24(s0)
     __sync_synchronize();
    12e6:	0ff0000f          	fence
    __sync_lock_release(lock);
    12ea:	fe843783          	ld	a5,-24(s0)
    12ee:	0f50000f          	fence	iorw,ow
    12f2:	0807a02f          	amoswap.w	zero,zero,(a5)
   
}
    12f6:	0001                	nop
    12f8:	6462                	ld	s0,24(sp)
    12fa:	6105                	addi	sp,sp,32
    12fc:	8082                	ret

00000000000012fe <lock_init>:

void lock_init (lock_t *lock){
    12fe:	1101                	addi	sp,sp,-32
    1300:	ec22                	sd	s0,24(sp)
    1302:	1000                	addi	s0,sp,32
    1304:	fea43423          	sd	a0,-24(s0)
    lock = 0;
    1308:	fe043423          	sd	zero,-24(s0)
    
}
    130c:	0001                	nop
    130e:	6462                	ld	s0,24(sp)
    1310:	6105                	addi	sp,sp,32
    1312:	8082                	ret

0000000000001314 <cv_wait>:
...
void cv_wait (cont_t *cv, lock_t *lock){
    ...
    131c:	fea43423          	sd	a0,-24(s0)
    1320:	feb43023          	sd	a1,-32(s0)
    while( __sync_lock_test_and_set(cv, 0)!=1){
    1324:	a015                	j	1348 <cv_wait+0x34>
        lock_release(lock);
    1326:	fe043503          	ld	a0,-32(s0)
    132a:	00000097          	auipc	ra,0x0
    132e:	fb2080e7          	jalr	-78(ra) # 12dc <lock_release>
        sleep(1);
    1332:	4505                	li	a0,1
    1334:	fffff097          	auipc	ra,0xfffff
    1338:	6d2080e7          	jalr	1746(ra) # a06 <sleep>
        lock_acquire(lock);
    133c:	fe043503          	ld	a0,-32(s0)
    1340:	00000097          	auipc	ra,0x0
    1344:	f74080e7          	jalr	-140(ra) # 12b4 <lock_acquire>
    while( __sync_lock_test_and_set(cv, 0)!=1){
    1348:	fe843783          	ld	a5,-24(s0)
    134c:	4701                	li	a4,0
    134e:	0ce7a72f          	amoswap.w.aq	a4,a4,(a5)
    1352:	0007079b          	sext.w	a5,a4
    1356:	873e                	mv	a4,a5
    1358:	4785                	li	a5,1
    135a:	fcf716e3          	bne	a4,a5,1326 <cv_wait+0x12>
    }
...
void cv_signal (cont_t *cv){
    ...
    1372:	fea43423          	sd	a0,-24(s0)
     __sync_synchronize();
    1376:	0ff0000f          	fence
     __sync_lock_test_and_set(cv, 1);
    137a:	fe843783          	ld	a5,-24(s0)
    137e:	4705                	li	a4,1
    1380:	0ce7a72f          	amoswap.w.aq	a4,a4,(a5)

}
    1384:	0001                	nop
    1386:	6462                	ld	s0,24(sp)
    1388:	6105                	addi	sp,sp,32
    138a:	8082                	ret

000000000000138c <cv_init>:


void cv_init (cont_t *cv){
    138c:	1101                	addi	sp,sp,-32
    138e:	ec22                	sd	s0,24(sp)
    1390:	1000                	addi	s0,sp,32
    1392:	fea43423          	sd	a0,-24(s0)
    cv = 0;
    1396:	fe043423          	sd	zero,-24(s0)
    139a:	0001                	nop
    139c:	6462                	ld	s0,24(sp)
