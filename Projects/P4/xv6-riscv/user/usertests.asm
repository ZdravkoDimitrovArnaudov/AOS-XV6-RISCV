...
copyin(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
      ...
      52:	c9a50513          	addi	a0,a0,-870 # 7ce8 <lock_init+0x16>
    ...
    if(fd < 0){
      ...
      72:	c8250513          	addi	a0,a0,-894 # 7cf0 <lock_init+0x1e>
    ...
    if(n >= 0){
      ...
      bc:	c5050513          	addi	a0,a0,-944 # 7d08 <lock_init+0x36>
    ...
    unlink("copyin1");
      ...
      e4:	c0850513          	addi	a0,a0,-1016 # 7ce8 <lock_init+0x16>
    ...
    if(n > 0){
     ...
     120:	c1c50513          	addi	a0,a0,-996 # 7d38 <lock_init+0x66>
    ...
    if(pipe(fds) < 0){
     ...
     14e:	c1e50513          	addi	a0,a0,-994 # 7d68 <lock_init+0x96>
    ...
    if(n > 0){
     ...
     198:	be450513          	addi	a0,a0,-1052 # 7d78 <lock_init+0xa6>
...
copyout(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     226:	b8650513          	addi	a0,a0,-1146 # 7da8 <lock_init+0xd6>
    ...
    if(fd < 0){
     ...
     246:	b6e50513          	addi	a0,a0,-1170 # 7db0 <lock_init+0xde>
    ...
    if(n > 0){
     ...
     290:	b3c50513          	addi	a0,a0,-1220 # 7dc8 <lock_init+0xf6>
    ...
    if(pipe(fds) < 0){
     ...
     2cc:	aa050513          	addi	a0,a0,-1376 # 7d68 <lock_init+0x96>
    ...
    n = write(fds[1], "x", 1);
     ...
     2ec:	b1058593          	addi	a1,a1,-1264 # 7df8 <lock_init+0x126>
     2f0:	853e                	mv	a0,a5
    ...
    if(n != 1){
     ...
     312:	af250513          	addi	a0,a0,-1294 # 7e00 <lock_init+0x12e>
    ...
    if(n > 0){
     ...
     35c:	ac050513          	addi	a0,a0,-1344 # 7e18 <lock_init+0x146>
...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    if(fd >= 0){
     ...
     414:	a3850513          	addi	a0,a0,-1480 # 7e48 <lock_init+0x176>
...
copyinstr2(char *s)
{
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     4c0:	9ac50513          	addi	a0,a0,-1620 # 7e68 <lock_init+0x196>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     50c:	98050513          	addi	a0,a0,-1664 # 7e88 <lock_init+0x1b6>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     55e:	94e50513          	addi	a0,a0,-1714 # 7ea8 <lock_init+0x1d6>
  ...
  char *args[] = { "xx", 0 };
     ...
     578:	95c78793          	addi	a5,a5,-1700 # 7ed0 <lock_init+0x1fe>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     5bc:	92050513          	addi	a0,a0,-1760 # 7ed8 <lock_init+0x206>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
     ...
     5ee:	90e50513          	addi	a0,a0,-1778 # 7ef8 <lock_init+0x226>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     616:	68e70713          	addi	a4,a4,1678 # fca0 <big.0>
    ...
    ret = exec("echo", args2);
     ...
     67a:	89250513          	addi	a0,a0,-1902 # 7f08 <lock_init+0x236>
    ...
    if(ret != -1){
     ...
     6a4:	87050513          	addi	a0,a0,-1936 # 7f10 <lock_init+0x23e>
  ...
  if(st != 747){
    ...
    printf("exec(echo, BIG) succeeded, should have failed\n");
     ...
     6ea:	85250513          	addi	a0,a0,-1966 # 7f38 <lock_init+0x266>
...
copyinstr3(char *s)
{
  ...
  if(top % PGSIZE){
    ...
    printf("oops\n");
     ...
     780:	80c50513          	addi	a0,a0,-2036 # 7f88 <lock_init+0x2b6>
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     7da:	69250513          	addi	a0,a0,1682 # 7e68 <lock_init+0x196>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     822:	66a50513          	addi	a0,a0,1642 # 7e88 <lock_init+0x1b6>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     86e:	63e50513          	addi	a0,a0,1598 # 7ea8 <lock_init+0x1d6>
  ...
  char *args[] = { "xx", 0 };
     ...
     888:	64c78793          	addi	a5,a5,1612 # 7ed0 <lock_init+0x1fe>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     8c8:	61450513          	addi	a0,a0,1556 # 7ed8 <lock_init+0x206>
...
rwsbrk()
{
  ...
  if(a == 0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) failed\n");
     ...
     90e:	68650513          	addi	a0,a0,1670 # 7f90 <lock_init+0x2be>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) shrink failed\n");
     ...
     93a:	67250513          	addi	a0,a0,1650 # 7fa8 <lock_init+0x2d6>
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
     ...
     958:	67450513          	addi	a0,a0,1652 # 7fc8 <lock_init+0x2f6>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     978:	65c50513          	addi	a0,a0,1628 # 7fd0 <lock_init+0x2fe>
  ...
  if(n >= 0){
    ...
    printf("write(fd, %p, 1024) returned %d, not -1\n", a+4096, n);
     ...
     9d0:	61c50513          	addi	a0,a0,1564 # 7fe8 <lock_init+0x316>
  ...
  unlink("rwsbrk");
     ...
     9f8:	5d450513          	addi	a0,a0,1492 # 7fc8 <lock_init+0x2f6>
  ...
  fd = open("README", O_RDONLY);
     ...
     a0a:	3a250513          	addi	a0,a0,930 # 7da8 <lock_init+0xd6>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     a2a:	5aa50513          	addi	a0,a0,1450 # 7fd0 <lock_init+0x2fe>
  ...
  if(n >= 0){
    ...
    printf("read(fd, %p, 10) returned %d, not -1\n", a+4096, n);
     ...
     a80:	59c50513          	addi	a0,a0,1436 # 8018 <lock_init+0x346>
...
truncate1(char *s)
{
  ...
  write(fd1, "abcd", 4);
     ...
     aee:	56658593          	addi	a1,a1,1382 # 8050 <lock_init+0x37e>
     af2:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     b10:	53450513          	addi	a0,a0,1332 # 8040 <lock_init+0x36e>
  ...
  if(n != 4){
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     b5c:	50050513          	addi	a0,a0,1280 # 8058 <lock_init+0x386>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     b7a:	4ca50513          	addi	a0,a0,1226 # 8040 <lock_init+0x36e>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     b92:	4b250513          	addi	a0,a0,1202 # 8040 <lock_init+0x36e>
  ...
  if(n != 0){
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     bd4:	4a850513          	addi	a0,a0,1192 # 8078 <lock_init+0x3a6>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     bee:	49e50513          	addi	a0,a0,1182 # 8088 <lock_init+0x3b6>
  ...
  if(n != 0){
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     c34:	47850513          	addi	a0,a0,1144 # 80a8 <lock_init+0x3d6>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     c4e:	43e50513          	addi	a0,a0,1086 # 8088 <lock_init+0x3b6>
  ...
  write(fd1, "abcdef", 6);
     ...
     c6e:	44e58593          	addi	a1,a1,1102 # 80b8 <lock_init+0x3e6>
     c72:	853e                	mv	a0,a5
  ...
  if(n != 6){
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     cb6:	40e50513          	addi	a0,a0,1038 # 80c0 <lock_init+0x3ee>
  ...
  if(n != 2){
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     d06:	3de50513          	addi	a0,a0,990 # 80e0 <lock_init+0x40e>
  ...
  unlink("truncfile");
     ...
     d20:	32450513          	addi	a0,a0,804 # 8040 <lock_init+0x36e>
...
truncate2(char *s)
{
  ...
  unlink("truncfile");
     ...
     d70:	2d450513          	addi	a0,a0,724 # 8040 <lock_init+0x36e>
  ...
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     ...
     d84:	2c050513          	addi	a0,a0,704 # 8040 <lock_init+0x36e>
  ...
  write(fd1, "abcd", 4);
     ...
     da0:	2b458593          	addi	a1,a1,692 # 8050 <lock_init+0x37e>
     da4:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     ...
     db6:	28e50513          	addi	a0,a0,654 # 8040 <lock_init+0x36e>
  ...
  int n = write(fd1, "x", 1);
     ...
     dd2:	02a58593          	addi	a1,a1,42 # 7df8 <lock_init+0x126>
     dd6:	853e                	mv	a0,a5
  ...
  if(n != -1){
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     e02:	30250513          	addi	a0,a0,770 # 8100 <lock_init+0x42e>
  ...
  unlink("truncfile");
     ...
     e1c:	22850513          	addi	a0,a0,552 # 8040 <lock_init+0x36e>
...
truncate3(char *s)
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     e62:	1e250513          	addi	a0,a0,482 # 8040 <lock_init+0x36e>
  ...
  if(pid < 0){
    ...
    printf("%s: fork failed\n", s);
     ...
     e9a:	29250513          	addi	a0,a0,658 # 8128 <lock_init+0x456>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < 100; i++){
     ...
     ec6:	17e50513          	addi	a0,a0,382 # 8040 <lock_init+0x36e>
     ...
     eea:	25a50513          	addi	a0,a0,602 # 8140 <lock_init+0x46e>
     ...
     f0a:	25258593          	addi	a1,a1,594 # 8158 <lock_init+0x486>
     f0e:	853e                	mv	a0,a5
     ...
     f3a:	23250513          	addi	a0,a0,562 # 8168 <lock_init+0x496>
     ...
     f64:	0e050513          	addi	a0,a0,224 # 8040 <lock_init+0x36e>
  ...
  for(int i = 0; i < 150; i++){
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     fce:	07650513          	addi	a0,a0,118 # 8040 <lock_init+0x36e>
    ...
    if(fd < 0){
     ...
     ff2:	15250513          	addi	a0,a0,338 # 8140 <lock_init+0x46e>
    ...
    1012:	17a58593          	addi	a1,a1,378 # 8188 <lock_init+0x4b6>
    1016:	853e                	mv	a0,a5
    ...
    1042:	15250513          	addi	a0,a0,338 # 8190 <lock_init+0x4be>
  ...
  unlink("truncfile");
    ...
    1092:	fb250513          	addi	a0,a0,-78 # 8040 <lock_init+0x36e>
...
iputtest(char *s)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    10bc:	0f850513          	addi	a0,a0,248 # 81b0 <lock_init+0x4de>
    ...
    10d6:	0e650513          	addi	a0,a0,230 # 81b8 <lock_init+0x4e6>
  ...
  if(chdir("iputdir") < 0){
    ...
    10f0:	0c450513          	addi	a0,a0,196 # 81b0 <lock_init+0x4de>
    ...
    110a:	0ca50513          	addi	a0,a0,202 # 81d0 <lock_init+0x4fe>
  ...
  if(unlink("../iputdir") < 0){
    ...
    1124:	0d050513          	addi	a0,a0,208 # 81f0 <lock_init+0x51e>
    ...
    113e:	0c650513          	addi	a0,a0,198 # 8200 <lock_init+0x52e>
  ...
  if(chdir("/") < 0){
    ...
    1158:	0cc50513          	addi	a0,a0,204 # 8220 <lock_init+0x54e>
    ...
    1172:	0ba50513          	addi	a0,a0,186 # 8228 <lock_init+0x556>
...
exitiputtest(char *s)
{
  ...
  if(pid < 0){
    ...
    11be:	f6e50513          	addi	a0,a0,-146 # 8128 <lock_init+0x456>
  ...
  if(pid == 0){
    ...
    11e0:	fd450513          	addi	a0,a0,-44 # 81b0 <lock_init+0x4de>
    ...
    11fa:	fc250513          	addi	a0,a0,-62 # 81b8 <lock_init+0x4e6>
    ...
    1214:	fa050513          	addi	a0,a0,-96 # 81b0 <lock_init+0x4de>
    ...
    122e:	01650513          	addi	a0,a0,22 # 8240 <lock_init+0x56e>
    ...
    1248:	fac50513          	addi	a0,a0,-84 # 81f0 <lock_init+0x51e>
    ...
    1262:	fa250513          	addi	a0,a0,-94 # 8200 <lock_init+0x52e>
...
openiputtest(char *s)
{
  ...
  if(mkdir("oidir") < 0){
    ...
    12ae:	fae50513          	addi	a0,a0,-82 # 8258 <lock_init+0x586>
    ...
    12c8:	f9c50513          	addi	a0,a0,-100 # 8260 <lock_init+0x58e>
  ...
  if(pid < 0){
    ...
    12fe:	e2e50513          	addi	a0,a0,-466 # 8128 <lock_init+0x456>
  ...
  if(pid == 0){
    ...
    1322:	f3a50513          	addi	a0,a0,-198 # 8258 <lock_init+0x586>
    ...
    1346:	f3650513          	addi	a0,a0,-202 # 8278 <lock_init+0x5a6>
  ...
  if(unlink("oidir") != 0){
    ...
    1374:	ee850513          	addi	a0,a0,-280 # 8258 <lock_init+0x586>
    ...
    138c:	f1850513          	addi	a0,a0,-232 # 82a0 <lock_init+0x5ce>
...
opentest(char *s)
{
  ...
  fd = open("echo", 0);
    ...
    13d0:	b3c50513          	addi	a0,a0,-1220 # 7f08 <lock_init+0x236>
  ...
  if(fd < 0){
    ...
    13f4:	ec850513          	addi	a0,a0,-312 # 82b8 <lock_init+0x5e6>
  ...
  fd = open("doesnotexist", 0);
    ...
    141e:	eb650513          	addi	a0,a0,-330 # 82d0 <lock_init+0x5fe>
  ...
  if(fd >= 0){
    ...
    1442:	ea250513          	addi	a0,a0,-350 # 82e0 <lock_init+0x60e>
...
writetest(char *s)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    1476:	e9650513          	addi	a0,a0,-362 # 8308 <lock_init+0x636>
  ...
  if(fd < 0){
    ...
    149a:	e7a50513          	addi	a0,a0,-390 # 8310 <lock_init+0x63e>
  ...
  for(i = 0; i < N; i++){
    ...
    14c0:	e7458593          	addi	a1,a1,-396 # 8330 <lock_init+0x65e>
    14c4:	853e                	mv	a0,a5
    ...
    14e6:	e5e50513          	addi	a0,a0,-418 # 8340 <lock_init+0x66e>
    ...
    1506:	e6658593          	addi	a1,a1,-410 # 8368 <lock_init+0x696>
    150a:	853e                	mv	a0,a5
    ...
    152c:	e5050513          	addi	a0,a0,-432 # 8378 <lock_init+0x6a6>
  ...
  fd = open("small", O_RDONLY);
    ...
    1570:	d9c50513          	addi	a0,a0,-612 # 8308 <lock_init+0x636>
  ...
  if(fd < 0){
    ...
    1594:	e1050513          	addi	a0,a0,-496 # 83a0 <lock_init+0x6ce>
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    15b6:	fde58593          	addi	a1,a1,-34 # a590 <buf>
    15ba:	853e                	mv	a0,a5
  ...
  if(i != N*SZ*2){
    ...
    15e2:	de250513          	addi	a0,a0,-542 # 83c0 <lock_init+0x6ee>
  ...
  if(unlink("small") < 0){
    ...
    160a:	d0250513          	addi	a0,a0,-766 # 8308 <lock_init+0x636>
    ...
    1624:	db850513          	addi	a0,a0,-584 # 83d8 <lock_init+0x706>
...
writebig(char *s)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    1658:	da450513          	addi	a0,a0,-604 # 83f8 <lock_init+0x726>
  ...
  if(fd < 0){
    ...
    167c:	d8850513          	addi	a0,a0,-632 # 8400 <lock_init+0x72e>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    169c:	ef878793          	addi	a5,a5,-264 # a590 <buf>
    ...
    16b2:	ee258593          	addi	a1,a1,-286 # a590 <buf>
    16b6:	853e                	mv	a0,a5
    ...
    16da:	d4a50513          	addi	a0,a0,-694 # 8420 <lock_init+0x74e>
  ...
  fd = open("big", O_RDONLY);
    ...
    171c:	ce050513          	addi	a0,a0,-800 # 83f8 <lock_init+0x726>
  ...
  if(fd < 0){
    ...
    1740:	d0c50513          	addi	a0,a0,-756 # 8448 <lock_init+0x776>
  ...
  for(;;){
    ...
    1766:	e2e58593          	addi	a1,a1,-466 # a590 <buf>
    176a:	853e                	mv	a0,a5
    ...
    17a0:	ccc50513          	addi	a0,a0,-820 # 8468 <lock_init+0x796>
    ...
    17d4:	cc050513          	addi	a0,a0,-832 # 8490 <lock_init+0x7be>
    ...
    17ee:	da678793          	addi	a5,a5,-602 # a590 <buf>
    ...
    1802:	d9278793          	addi	a5,a5,-622 # a590 <buf>
      printf("%s: read content of block %d is %d\n", s,
    ...
    1818:	c9450513          	addi	a0,a0,-876 # 84a8 <lock_init+0x7d6>
  ...
  if(unlink("big") < 0){
    ...
    184e:	bae50513          	addi	a0,a0,-1106 # 83f8 <lock_init+0x726>
    ...
    1868:	c6c50513          	addi	a0,a0,-916 # 84d0 <lock_init+0x7fe>
...
void dirtest(char *s)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    1964:	b8850513          	addi	a0,a0,-1144 # 84e8 <lock_init+0x816>
    ...
    197e:	83e50513          	addi	a0,a0,-1986 # 81b8 <lock_init+0x4e6>
  ...
  if(chdir("dir0") < 0){
    ...
    1998:	b5450513          	addi	a0,a0,-1196 # 84e8 <lock_init+0x816>
    ...
    19b2:	b4250513          	addi	a0,a0,-1214 # 84f0 <lock_init+0x81e>
  ...
  if(chdir("..") < 0){
    ...
    19cc:	b4050513          	addi	a0,a0,-1216 # 8508 <lock_init+0x836>
    ...
    19e6:	b2e50513          	addi	a0,a0,-1234 # 8510 <lock_init+0x83e>
  ...
  if(unlink("dir0") < 0){
    ...
    1a00:	aec50513          	addi	a0,a0,-1300 # 84e8 <lock_init+0x816>
    ...
    1a1a:	b1250513          	addi	a0,a0,-1262 # 8528 <lock_init+0x856>
...
exectest(char *s)
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1a4a:	4c278793          	addi	a5,a5,1218 # 7f08 <lock_init+0x236>
    1a4e:	fcf43423          	sd	a5,-56(s0)
    1a52:	00007797          	auipc	a5,0x7
    1a56:	aee78793          	addi	a5,a5,-1298 # 8540 <lock_init+0x86e>
  ...
  unlink("echo-ok");
    ...
    1a66:	ae650513          	addi	a0,a0,-1306 # 8548 <lock_init+0x876>
  ...
  if(pid < 0) {
    ...
    1a92:	69a50513          	addi	a0,a0,1690 # 8128 <lock_init+0x456>
  ...
  if(pid == 0) {
    ...
    1ac2:	a8a50513          	addi	a0,a0,-1398 # 8548 <lock_init+0x876>
    ...
    1ae6:	a6e50513          	addi	a0,a0,-1426 # 8550 <lock_init+0x87e>
    ...
    1b12:	a5a50513          	addi	a0,a0,-1446 # 8568 <lock_init+0x896>
    ...
    1b32:	3da50513          	addi	a0,a0,986 # 7f08 <lock_init+0x236>
    ...
    1b4c:	a3050513          	addi	a0,a0,-1488 # 8578 <lock_init+0x8a6>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1b86:	a0e50513          	addi	a0,a0,-1522 # 8590 <lock_init+0x8be>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1bac:	9a050513          	addi	a0,a0,-1632 # 8548 <lock_init+0x876>
  ...
  if(fd < 0) {
    ...
    1bd0:	57450513          	addi	a0,a0,1396 # 8140 <lock_init+0x46e>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1c0e:	7b650513          	addi	a0,a0,1974 # 83c0 <lock_init+0x6ee>
  ...
  unlink("echo-ok");
    ...
    1c28:	92450513          	addi	a0,a0,-1756 # 8548 <lock_init+0x876>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1c62:	94a50513          	addi	a0,a0,-1718 # 85a8 <lock_init+0x8d6>
...
pipe1(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    1c9e:	92650513          	addi	a0,a0,-1754 # 85c0 <lock_init+0x8ee>
  ...
  if(pid == 0){
    ...
    1cfc:	89868693          	addi	a3,a3,-1896 # a590 <buf>
    ...
    1d30:	86458593          	addi	a1,a1,-1948 # a590 <buf>
    1d34:	853e                	mv	a0,a5
    ...
    1d52:	88a50513          	addi	a0,a0,-1910 # 85d8 <lock_init+0x906>
    ...
    1db8:	7dc70713          	addi	a4,a4,2012 # a590 <buf>
    ...
    1dea:	80a50513          	addi	a0,a0,-2038 # 85f0 <lock_init+0x91e>
    ...
    1e50:	74458593          	addi	a1,a1,1860 # a590 <buf>
    1e54:	853e                	mv	a0,a5
    ...
    1e8a:	78250513          	addi	a0,a0,1922 # 8608 <lock_init+0x936>
    ...
    1ed2:	75a50513          	addi	a0,a0,1882 # 8628 <lock_init+0x956>
...
killstatus(char *s)
{
  ...
  for(int i = 0; i < 100; i++){
    ...
    1f22:	20a50513          	addi	a0,a0,522 # 8128 <lock_init+0x456>
    ...
    1f84:	6c050513          	addi	a0,a0,1728 # 8640 <lock_init+0x96e>
...
preempt(char *s)
{
  ...
  if(pid1 < 0) {
    ...
    1fea:	67a50513          	addi	a0,a0,1658 # 8660 <lock_init+0x98e>
  ...
  if(pid2 < 0) {
    ...
    202a:	10250513          	addi	a0,a0,258 # 8128 <lock_init+0x456>
  ...
  if(pid3 < 0) {
    ...
    2078:	0b450513          	addi	a0,a0,180 # 8128 <lock_init+0x456>
  ...
  if(pid3 == 0){
    ...
    20ae:	d4e58593          	addi	a1,a1,-690 # 7df8 <lock_init+0x126>
    20b2:	853e                	mv	a0,a5
    ...
    20ce:	5a650513          	addi	a0,a0,1446 # 8670 <lock_init+0x99e>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    2102:	49258593          	addi	a1,a1,1170 # a590 <buf>
    2106:	853e                	mv	a0,a5
    ...
    2122:	56a50513          	addi	a0,a0,1386 # 8688 <lock_init+0x9b6>
  ...
  printf("kill... ");
    ...
    2142:	56250513          	addi	a0,a0,1378 # 86a0 <lock_init+0x9ce>
  ...
  printf("wait... ");
    ...
    217c:	53850513          	addi	a0,a0,1336 # 86b0 <lock_init+0x9de>
...
exitwait(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    21e0:	f4c50513          	addi	a0,a0,-180 # 8128 <lock_init+0x456>
    ...
    2222:	4a250513          	addi	a0,a0,1186 # 86c0 <lock_init+0x9ee>
    ...
    224e:	48e50513          	addi	a0,a0,1166 # 86d8 <lock_init+0xa06>
...
reparent(char *s)
{
  ...
  for(int i = 0; i < 200; i++){
    ...
    22d8:	e5450513          	addi	a0,a0,-428 # 8128 <lock_init+0x456>
    ...
    2316:	3ae50513          	addi	a0,a0,942 # 86c0 <lock_init+0x9ee>
...
twochildren(char *s)
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    23bc:	d7050513          	addi	a0,a0,-656 # 8128 <lock_init+0x456>
    ...
    2404:	d2850513          	addi	a0,a0,-728 # 8128 <lock_init+0x456>
...
forkfork(char *s)
{
  ...
  for(int i = 0; i < N; i++){
    ...
    2498:	1cc50513          	addi	a0,a0,460 # 8660 <lock_init+0x98e>
  ...
  for(int i = 0; i < N; i++){
    ...
    2558:	1a450513          	addi	a0,a0,420 # 86f8 <lock_init+0xa26>
...
forkforkfork(char *s)
{
  ...
  unlink("stopforking");
    ...
    25a2:	17a50513          	addi	a0,a0,378 # 8718 <lock_init+0xa46>
  ...
  if(pid < 0){
    ...
    25ce:	09650513          	addi	a0,a0,150 # 8660 <lock_init+0x98e>
  ...
  if(pid == 0){
    ...
    25f2:	12a50513          	addi	a0,a0,298 # 8718 <lock_init+0xa46>
    ...
    262e:	0ee50513          	addi	a0,a0,238 # 8718 <lock_init+0xa46>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    265a:	0c250513          	addi	a0,a0,194 # 8718 <lock_init+0xa46>
...
reparent2(char *s)
{
  ...
  for(int i = 0; i < 800; i++){
    ...
    26be:	83e50513          	addi	a0,a0,-1986 # 7ef8 <lock_init+0x226>
...
mem(char *s)
{
  ...
  if((pid = fork()) == 0){
    ...
    27b8:	f7450513          	addi	a0,a0,-140 # 8728 <lock_init+0xa56>
...
sharedfd(char *s)
{
  ...
  if(fd < 0){
    ...
    285e:	efe50513          	addi	a0,a0,-258 # 8758 <lock_init+0xa86>
  ...
  for(i = 0; i < N; i++){
    ...
    28d4:	eb050513          	addi	a0,a0,-336 # 8780 <lock_init+0xaae>
  ...
  fd = open("sharedfd", 0);
    ...
    294c:	e0050513          	addi	a0,a0,-512 # 8748 <lock_init+0xa76>
  ...
  if(fd < 0){
    ...
    2970:	e3450513          	addi	a0,a0,-460 # 87a0 <lock_init+0xace>
  ...
  unlink("sharedfd");
    ...
    2a28:	d2450513          	addi	a0,a0,-732 # 8748 <lock_init+0xa76>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    2a6a:	d6250513          	addi	a0,a0,-670 # 87c8 <lock_init+0xaf6>
...
fourfiles(char *s)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    2a90:	dc478793          	addi	a5,a5,-572 # 8850 <lock_init+0xb7e>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2af0:	40c50513          	addi	a0,a0,1036 # 7ef8 <lock_init+0x226>
    ...
    2b36:	cae50513          	addi	a0,a0,-850 # 87e0 <lock_init+0xb0e>
    ...
    2b60:	a3450513          	addi	a0,a0,-1484 # a590 <buf>
    ...
    2b7e:	a1658593          	addi	a1,a1,-1514 # a590 <buf>
    2b82:	853e                	mv	a0,a5
    ...
    2bac:	c4850513          	addi	a0,a0,-952 # 87f0 <lock_init+0xb1e>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2c78:	91c70713          	addi	a4,a4,-1764 # a590 <buf>
    ...
    2ca0:	b6c50513          	addi	a0,a0,-1172 # 8808 <lock_init+0xb36>
    ...
    2cec:	8a858593          	addi	a1,a1,-1880 # a590 <buf>
    2cf0:	853e                	mv	a0,a5
    ...
    2d34:	ae850513          	addi	a0,a0,-1304 # 8818 <lock_init+0xb46>
...
createdelete(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2dac:	15050513          	addi	a0,a0,336 # 7ef8 <lock_init+0x226>
    ...
    2e28:	72c50513          	addi	a0,a0,1836 # 8550 <lock_init+0x87e>
    ...
    2e9c:	40850513          	addi	a0,a0,1032 # 82a0 <lock_init+0x5ce>
  ...
  for(i = 0; i < N; i++){
    ...
    2fb4:	8c050513          	addi	a0,a0,-1856 # 8870 <lock_init+0xb9e>
    ...
    2ffa:	8a250513          	addi	a0,a0,-1886 # 8898 <lock_init+0xbc6>
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    30ea:	7da50513          	addi	a0,a0,2010 # 88c0 <lock_init+0xbee>
  ...
  if(fd < 0){
    ...
    310e:	7c650513          	addi	a0,a0,1990 # 88d0 <lock_init+0xbfe>
  ...
  write(fd, "hello", SZ);
    ...
    312e:	7c658593          	addi	a1,a1,1990 # 88f0 <lock_init+0xc1e>
    3132:	853e                	mv	a0,a5
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    3150:	77450513          	addi	a0,a0,1908 # 88c0 <lock_init+0xbee>
  ...
  if(fd < 0){
    ...
    3174:	78850513          	addi	a0,a0,1928 # 88f8 <lock_init+0xc26>
  ...
  if(unlink("unlinkread") != 0){
    ...
    318e:	73650513          	addi	a0,a0,1846 # 88c0 <lock_init+0xbee>
    ...
    31a6:	77650513          	addi	a0,a0,1910 # 8918 <lock_init+0xc46>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    31c4:	70050513          	addi	a0,a0,1792 # 88c0 <lock_init+0xbee>
  ...
  write(fd1, "yyy", 3);
    ...
    31e0:	75c58593          	addi	a1,a1,1884 # 8938 <lock_init+0xc66>
    31e4:	853e                	mv	a0,a5
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3206:	38e58593          	addi	a1,a1,910 # a590 <buf>
    320a:	853e                	mv	a0,a5
    ...
    3226:	71e50513          	addi	a0,a0,1822 # 8940 <lock_init+0xc6e>
  ...
  if(buf[0] != 'h'){
    ...
    3240:	35478793          	addi	a5,a5,852 # a590 <buf>
    ...
    325a:	70a50513          	addi	a0,a0,1802 # 8960 <lock_init+0xc8e>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    327a:	31a58593          	addi	a1,a1,794 # a590 <buf>
    327e:	853e                	mv	a0,a5
    ...
    329a:	6ea50513          	addi	a0,a0,1770 # 8980 <lock_init+0xcae>
  ...
  unlink("unlinkread");
    ...
    32c2:	60250513          	addi	a0,a0,1538 # 88c0 <lock_init+0xbee>
...
linktest(char *s)
{
  ...
  unlink("lf1");
    ...
    32e8:	6bc50513          	addi	a0,a0,1724 # 89a0 <lock_init+0xcce>
    32ec:	00004097          	auipc	ra,0x4
    32f0:	0d4080e7          	jalr	212(ra) # 73c0 <unlink>
  unlink("lf2");
    32f4:	00005517          	auipc	a0,0x5
    32f8:	6b450513          	addi	a0,a0,1716 # 89a8 <lock_init+0xcd6>
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    330c:	69850513          	addi	a0,a0,1688 # 89a0 <lock_init+0xcce>
  ...
  if(fd < 0){
    ...
    3330:	68450513          	addi	a0,a0,1668 # 89b0 <lock_init+0xcde>
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    3350:	5a458593          	addi	a1,a1,1444 # 88f0 <lock_init+0xc1e>
    3354:	853e                	mv	a0,a5
    ...
    3370:	65c50513          	addi	a0,a0,1628 # 89c8 <lock_init+0xcf6>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    3398:	61458593          	addi	a1,a1,1556 # 89a8 <lock_init+0xcd6>
    339c:	00005517          	auipc	a0,0x5
    33a0:	60450513          	addi	a0,a0,1540 # 89a0 <lock_init+0xcce>
    ...
    33ba:	62a50513          	addi	a0,a0,1578 # 89e0 <lock_init+0xd0e>
  ...
  unlink("lf1");
    ...
    33d4:	5d050513          	addi	a0,a0,1488 # 89a0 <lock_init+0xcce>
  ...
  if(open("lf1", 0) >= 0){
    ...
    33e6:	5be50513          	addi	a0,a0,1470 # 89a0 <lock_init+0xcce>
    ...
    3400:	60450513          	addi	a0,a0,1540 # 8a00 <lock_init+0xd2e>
  ...
  fd = open("lf2", 0);
    ...
    341c:	59050513          	addi	a0,a0,1424 # 89a8 <lock_init+0xcd6>
  ...
  if(fd < 0){
    ...
    3440:	5f450513          	addi	a0,a0,1524 # 8a30 <lock_init+0xd5e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3460:	13458593          	addi	a1,a1,308 # a590 <buf>
    3464:	853e                	mv	a0,a5
    ...
    3480:	5cc50513          	addi	a0,a0,1484 # 8a48 <lock_init+0xd76>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    34a8:	50458593          	addi	a1,a1,1284 # 89a8 <lock_init+0xcd6>
    34ac:	00005517          	auipc	a0,0x5
    34b0:	4fc50513          	addi	a0,a0,1276 # 89a8 <lock_init+0xcd6>
    ...
    34ca:	59a50513          	addi	a0,a0,1434 # 8a60 <lock_init+0xd8e>
  ...
  unlink("lf2");
    ...
    34e4:	4c850513          	addi	a0,a0,1224 # 89a8 <lock_init+0xcd6>
    34e8:	00004097          	auipc	ra,0x4
    34ec:	ed8080e7          	jalr	-296(ra) # 73c0 <unlink>
  if(link("lf2", "lf1") >= 0){
    34f0:	00005597          	auipc	a1,0x5
    34f4:	4b058593          	addi	a1,a1,1200 # 89a0 <lock_init+0xcce>
    34f8:	00005517          	auipc	a0,0x5
    34fc:	4b050513          	addi	a0,a0,1200 # 89a8 <lock_init+0xcd6>
    ...
    3516:	57650513          	addi	a0,a0,1398 # 8a88 <lock_init+0xdb6>
  ...
  if(link(".", "lf1") >= 0){
    ...
    3530:	47458593          	addi	a1,a1,1140 # 89a0 <lock_init+0xcce>
    3534:	00005517          	auipc	a0,0x5
    3538:	57c50513          	addi	a0,a0,1404 # 8ab0 <lock_init+0xdde>
    ...
    3552:	56a50513          	addi	a0,a0,1386 # 8ab8 <lock_init+0xde6>
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    35e8:	4f450513          	addi	a0,a0,1268 # 8ad8 <lock_init+0xe06>
    ...
    361e:	4be50513          	addi	a0,a0,1214 # 8ad8 <lock_init+0xe06>
    ...
    3658:	48c50513          	addi	a0,a0,1164 # 8ae0 <lock_init+0xe0e>
  ...
  fd = open(".", 0);
    ...
    36e0:	3d450513          	addi	a0,a0,980 # 8ab0 <lock_init+0xdde>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    374a:	3ba50513          	addi	a0,a0,954 # 8b00 <lock_init+0xe2e>
    ...
    377e:	3a650513          	addi	a0,a0,934 # 8b20 <lock_init+0xe4e>
  ...
  if(n != N){
    ...
    37ee:	35e50513          	addi	a0,a0,862 # 8b48 <lock_init+0xe76>
  ...
  for(i = 0; i < N; i++){
    ...
    383e:	8ee50513          	addi	a0,a0,-1810 # 8128 <lock_init+0x456>
...
linkunlink(char *s)
{
  ...
  unlink("x");
    ...
    39da:	42250513          	addi	a0,a0,1058 # 7df8 <lock_init+0x126>
  ...
  if(pid < 0){
    ...
    3a06:	72650513          	addi	a0,a0,1830 # 8128 <lock_init+0x456>
  ...
  for(i = 0; i < 100; i++){
    ...
    3a70:	38c50513          	addi	a0,a0,908 # 7df8 <lock_init+0x126>
    ...
    3aa4:	35858593          	addi	a1,a1,856 # 7df8 <lock_init+0x126>
    3aa8:	00005517          	auipc	a0,0x5
    3aac:	0d850513          	addi	a0,a0,216 # 8b80 <lock_init+0xeae>
    ...
    3abe:	33e50513          	addi	a0,a0,830 # 7df8 <lock_init+0x126>
...
bigdir(char *s)
{
  ...
  unlink("bd");
    ...
    3b1a:	07250513          	addi	a0,a0,114 # 8b88 <lock_init+0xeb6>
  ...
  fd = open("bd", O_CREATE);
    ...
    3b2e:	05e50513          	addi	a0,a0,94 # 8b88 <lock_init+0xeb6>
  ...
  if(fd < 0){
    ...
    3b52:	04250513          	addi	a0,a0,66 # 8b90 <lock_init+0xebe>
  ...
  for(i = 0; i < N; i++){
    ...
    3be0:	fac50513          	addi	a0,a0,-84 # 8b88 <lock_init+0xeb6>
    ...
    3bfe:	fb650513          	addi	a0,a0,-74 # 8bb0 <lock_init+0xede>
  ...
  unlink("bd");
    ...
    3c32:	f5a50513          	addi	a0,a0,-166 # 8b88 <lock_init+0xeb6>
  ...
  for(i = 0; i < N; i++){
    ...
    3cb8:	f1c50513          	addi	a0,a0,-228 # 8bd0 <lock_init+0xefe>
...
subdir(char *s)
{
  ...
  unlink("ff");
    ...
    3d04:	ef050513          	addi	a0,a0,-272 # 8bf0 <lock_init+0xf1e>
    3d08:	00003097          	auipc	ra,0x3
    3d0c:	6b8080e7          	jalr	1720(ra) # 73c0 <unlink>
  if(mkdir("dd") != 0){
    3d10:	00005517          	auipc	a0,0x5
    3d14:	ee850513          	addi	a0,a0,-280 # 8bf8 <lock_init+0xf26>
    ...
    3d2c:	ed850513          	addi	a0,a0,-296 # 8c00 <lock_init+0xf2e>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3d4a:	ed250513          	addi	a0,a0,-302 # 8c18 <lock_init+0xf46>
  ...
  if(fd < 0){
    ...
    3d6e:	eb650513          	addi	a0,a0,-330 # 8c20 <lock_init+0xf4e>
  ...
  write(fd, "ff", 2);
    ...
    3d8e:	e6658593          	addi	a1,a1,-410 # 8bf0 <lock_init+0xf1e>
    3d92:	853e                	mv	a0,a5
  ...
  if(unlink("dd") >= 0){
    ...
    3dae:	e4e50513          	addi	a0,a0,-434 # 8bf8 <lock_init+0xf26>
    ...
    3dc8:	e7c50513          	addi	a0,a0,-388 # 8c40 <lock_init+0xf6e>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3de2:	e9250513          	addi	a0,a0,-366 # 8c70 <lock_init+0xf9e>
    ...
    3dfa:	e8250513          	addi	a0,a0,-382 # 8c78 <lock_init+0xfa6>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3e18:	e8450513          	addi	a0,a0,-380 # 8c98 <lock_init+0xfc6>
  ...
  if(fd < 0){
    ...
    3e3c:	e7050513          	addi	a0,a0,-400 # 8ca8 <lock_init+0xfd6>
  ...
  write(fd, "FF", 2);
    ...
    3e5c:	e7058593          	addi	a1,a1,-400 # 8cc8 <lock_init+0xff6>
    3e60:	853e                	mv	a0,a5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3e7e:	e5650513          	addi	a0,a0,-426 # 8cd0 <lock_init+0xffe>
  ...
  if(fd < 0){
    ...
    3ea2:	e4250513          	addi	a0,a0,-446 # 8ce0 <lock_init+0x100e>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3ec2:	6d258593          	addi	a1,a1,1746 # a590 <buf>
    3ec6:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3ee8:	6ac78793          	addi	a5,a5,1708 # a590 <buf>
    ...
    3f02:	e0250513          	addi	a0,a0,-510 # 8d00 <lock_init+0x102e>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3f2a:	dfa58593          	addi	a1,a1,-518 # 8d20 <lock_init+0x104e>
    3f2e:	00005517          	auipc	a0,0x5
    3f32:	d6a50513          	addi	a0,a0,-662 # 8c98 <lock_init+0xfc6>
    ...
    3f4a:	dea50513          	addi	a0,a0,-534 # 8d30 <lock_init+0x105e>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3f64:	d3850513          	addi	a0,a0,-712 # 8c98 <lock_init+0xfc6>
    ...
    3f7c:	de050513          	addi	a0,a0,-544 # 8d58 <lock_init+0x1086>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3f98:	d0450513          	addi	a0,a0,-764 # 8c98 <lock_init+0xfc6>
    ...
    3fb2:	dca50513          	addi	a0,a0,-566 # 8d78 <lock_init+0x10a6>
  ...
  if(chdir("dd") != 0){
    ...
    3fcc:	c3050513          	addi	a0,a0,-976 # 8bf8 <lock_init+0xf26>
    ...
    3fe4:	dc050513          	addi	a0,a0,-576 # 8da0 <lock_init+0x10ce>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3ffe:	dbe50513          	addi	a0,a0,-578 # 8db8 <lock_init+0x10e6>
    ...
    4016:	db650513          	addi	a0,a0,-586 # 8dc8 <lock_init+0x10f6>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    4030:	dbc50513          	addi	a0,a0,-580 # 8de8 <lock_init+0x1116>
    ...
    4048:	db450513          	addi	a0,a0,-588 # 8df8 <lock_init+0x1126>
  ...
  if(chdir("./..") != 0){
    ...
    4062:	dba50513          	addi	a0,a0,-582 # 8e18 <lock_init+0x1146>
    ...
    407a:	daa50513          	addi	a0,a0,-598 # 8e20 <lock_init+0x114e>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    4096:	c8e50513          	addi	a0,a0,-882 # 8d20 <lock_init+0x104e>
  ...
  if(fd < 0){
    ...
    40ba:	d8250513          	addi	a0,a0,-638 # 8e38 <lock_init+0x1166>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    40da:	4ba58593          	addi	a1,a1,1210 # a590 <buf>
    40de:	853e                	mv	a0,a5
    ...
    40fa:	d6250513          	addi	a0,a0,-670 # 8e58 <lock_init+0x1186>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    4124:	b7850513          	addi	a0,a0,-1160 # 8c98 <lock_init+0xfc6>
    ...
    413e:	d3e50513          	addi	a0,a0,-706 # 8e78 <lock_init+0x11a6>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    415c:	d5050513          	addi	a0,a0,-688 # 8ea8 <lock_init+0x11d6>
    ...
    4176:	d4650513          	addi	a0,a0,-698 # 8eb8 <lock_init+0x11e6>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    4194:	d4850513          	addi	a0,a0,-696 # 8ed8 <lock_init+0x1206>
    ...
    41ae:	d3e50513          	addi	a0,a0,-706 # 8ee8 <lock_init+0x1216>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    41cc:	a3050513          	addi	a0,a0,-1488 # 8bf8 <lock_init+0xf26>
    ...
    41e6:	d2650513          	addi	a0,a0,-730 # 8f08 <lock_init+0x1236>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    4202:	9fa50513          	addi	a0,a0,-1542 # 8bf8 <lock_init+0xf26>
    ...
    421c:	d1050513          	addi	a0,a0,-752 # 8f28 <lock_init+0x1256>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    4238:	9c450513          	addi	a0,a0,-1596 # 8bf8 <lock_init+0xf26>
    ...
    4252:	cfa50513          	addi	a0,a0,-774 # 8f48 <lock_init+0x1276>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    426c:	d0058593          	addi	a1,a1,-768 # 8f68 <lock_init+0x1296>
    4270:	00005517          	auipc	a0,0x5
    4274:	c3850513          	addi	a0,a0,-968 # 8ea8 <lock_init+0x11d6>
    ...
    428c:	cf050513          	addi	a0,a0,-784 # 8f78 <lock_init+0x12a6>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    42a6:	cc658593          	addi	a1,a1,-826 # 8f68 <lock_init+0x1296>
    42aa:	00005517          	auipc	a0,0x5
    42ae:	c2e50513          	addi	a0,a0,-978 # 8ed8 <lock_init+0x1206>
    ...
    42c6:	cde50513          	addi	a0,a0,-802 # 8fa0 <lock_init+0x12ce>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    42e0:	a4458593          	addi	a1,a1,-1468 # 8d20 <lock_init+0x104e>
    42e4:	00005517          	auipc	a0,0x5
    42e8:	93450513          	addi	a0,a0,-1740 # 8c18 <lock_init+0xf46>
    ...
    4300:	ccc50513          	addi	a0,a0,-820 # 8fc8 <lock_init+0x12f6>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    431a:	b9250513          	addi	a0,a0,-1134 # 8ea8 <lock_init+0x11d6>
    ...
    4332:	cc250513          	addi	a0,a0,-830 # 8ff0 <lock_init+0x131e>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    434c:	b9050513          	addi	a0,a0,-1136 # 8ed8 <lock_init+0x1206>
    ...
    4364:	cb050513          	addi	a0,a0,-848 # 9010 <lock_init+0x133e>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    437e:	9a650513          	addi	a0,a0,-1626 # 8d20 <lock_init+0x104e>
    ...
    4396:	c9e50513          	addi	a0,a0,-866 # 9030 <lock_init+0x135e>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    43b0:	b2c50513          	addi	a0,a0,-1236 # 8ed8 <lock_init+0x1206>
    ...
    43c8:	c9450513          	addi	a0,a0,-876 # 9058 <lock_init+0x1386>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    43e2:	aca50513          	addi	a0,a0,-1334 # 8ea8 <lock_init+0x11d6>
    ...
    43fa:	c8250513          	addi	a0,a0,-894 # 9078 <lock_init+0x13a6>
  ...
  if(chdir("dd/ff") == 0){
    ...
    4414:	80850513          	addi	a0,a0,-2040 # 8c18 <lock_init+0xf46>
    ...
    442c:	c7050513          	addi	a0,a0,-912 # 9098 <lock_init+0x13c6>
  ...
  if(chdir("dd/xx") == 0){
    ...
    4446:	c7650513          	addi	a0,a0,-906 # 90b8 <lock_init+0x13e6>
    ...
    445e:	c6650513          	addi	a0,a0,-922 # 90c0 <lock_init+0x13ee>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    4478:	8ac50513          	addi	a0,a0,-1876 # 8d20 <lock_init+0x104e>
    ...
    4490:	8cc50513          	addi	a0,a0,-1844 # 8d58 <lock_init+0x1086>
  ...
  if(unlink("dd/ff") != 0){
    ...
    44aa:	77250513          	addi	a0,a0,1906 # 8c18 <lock_init+0xf46>
    ...
    44c2:	c2250513          	addi	a0,a0,-990 # 90e0 <lock_init+0x140e>
  ...
  if(unlink("dd") == 0){
    ...
    44dc:	72050513          	addi	a0,a0,1824 # 8bf8 <lock_init+0xf26>
    ...
    44f4:	c1050513          	addi	a0,a0,-1008 # 9100 <lock_init+0x142e>
  ...
  if(unlink("dd/dd") < 0){
    ...
    450e:	c1e50513          	addi	a0,a0,-994 # 9128 <lock_init+0x1456>
    ...
    4528:	c0c50513          	addi	a0,a0,-1012 # 9130 <lock_init+0x145e>
  ...
  if(unlink("dd") < 0){
    ...
    4542:	6ba50513          	addi	a0,a0,1722 # 8bf8 <lock_init+0xf26>
    ...
    455c:	bf850513          	addi	a0,a0,-1032 # 9150 <lock_init+0x147e>
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
    ...
    458c:	be050513          	addi	a0,a0,-1056 # 9168 <lock_init+0x1496>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    45aa:	bc250513          	addi	a0,a0,-1086 # 9168 <lock_init+0x1496>
    ...
    45ce:	bae50513          	addi	a0,a0,-1106 # 9178 <lock_init+0x14a6>
    ...
    45f8:	f9c58593          	addi	a1,a1,-100 # a590 <buf>
    45fc:	853e                	mv	a0,a5
    ...
    4632:	b6a50513          	addi	a0,a0,-1174 # 9198 <lock_init+0x14c6>
    ...
    4672:	afa50513          	addi	a0,a0,-1286 # 9168 <lock_init+0x1496>
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    46de:	81e50513          	addi	a0,a0,-2018 # 7ef8 <lock_init+0x226>
    ...
    4768:	a4c50513          	addi	a0,a0,-1460 # 91b0 <lock_init+0x14de>
    ...
    4792:	e0258593          	addi	a1,a1,-510 # a590 <buf>
    4796:	853e                	mv	a0,a5
    ...
    47cc:	9d050513          	addi	a0,a0,-1584 # 9198 <lock_init+0x14c6>
...
bigfile(char *s)
{
  ...
  if(fd < 0){
    ...
    4904:	8d850513          	addi	a0,a0,-1832 # 91d8 <lock_init+0x1506>
  ...
  for(i = 0; i < N; i++){
    ...
    492e:	c6650513          	addi	a0,a0,-922 # a590 <buf>
    ...
    4946:	c4e58593          	addi	a1,a1,-946 # a590 <buf>
    494a:	853e                	mv	a0,a5
    ...
    4968:	89450513          	addi	a0,a0,-1900 # 91f8 <lock_init+0x1526>
  ...
  fd = open("bigfile.dat", 0);
    ...
    49aa:	82250513          	addi	a0,a0,-2014 # 91c8 <lock_init+0x14f6>
  ...
  if(fd < 0){
    ...
    49ce:	84e50513          	addi	a0,a0,-1970 # 9218 <lock_init+0x1546>
  ...
  for(i = 0; ; i++){
    ...
    49f8:	b9c58593          	addi	a1,a1,-1124 # a590 <buf>
    49fc:	853e                	mv	a0,a5
    ...
    4a1e:	81e50513          	addi	a0,a0,-2018 # 9238 <lock_init+0x1566>
    ...
    4a54:	80850513          	addi	a0,a0,-2040 # 9258 <lock_init+0x1586>
    ...
    4a6e:	b2678793          	addi	a5,a5,-1242 # a590 <buf>
    ...
    4a94:	b0078793          	addi	a5,a5,-1280 # a590 <buf>
    ...
    4abe:	7b650513          	addi	a0,a0,1974 # 9270 <lock_init+0x159e>
  ...
  if(total != N*SZ){
    ...
    4b1a:	77a50513          	addi	a0,a0,1914 # 9290 <lock_init+0x15be>
  ...
  unlink("bigfile.dat");
    ...
    4b34:	69850513          	addi	a0,a0,1688 # 91c8 <lock_init+0x14f6>
...
fourteen(char *s)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    4b5a:	75a50513          	addi	a0,a0,1882 # 92b0 <lock_init+0x15de>
    ...
    4b72:	75250513          	addi	a0,a0,1874 # 92c0 <lock_init+0x15ee>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    4b8c:	76050513          	addi	a0,a0,1888 # 92e8 <lock_init+0x1616>
    ...
    4ba4:	76850513          	addi	a0,a0,1896 # 9308 <lock_init+0x1636>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    4bc2:	78250513          	addi	a0,a0,1922 # 9340 <lock_init+0x166e>
  ...
  if(fd < 0){
    ...
    4be6:	78e50513          	addi	a0,a0,1934 # 9370 <lock_init+0x169e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    4c10:	7ac50513          	addi	a0,a0,1964 # 93b8 <lock_init+0x16e6>
  ...
  if(fd < 0){
    ...
    4c34:	7b850513          	addi	a0,a0,1976 # 93e8 <lock_init+0x1716>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    4c5c:	7d050513          	addi	a0,a0,2000 # 9428 <lock_init+0x1756>
    ...
    4c74:	7d850513          	addi	a0,a0,2008 # 9448 <lock_init+0x1776>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    4c8a:	00004517          	auipc	a0,0x4
    4c8e:	7f650513          	addi	a0,a0,2038 # 9480 <lock_init+0x17ae>
    ...
    4ca2:	00004517          	auipc	a0,0x4
    4ca6:	7fe50513          	addi	a0,a0,2046 # 94a0 <lock_init+0x17ce>
...
rmdot(char *s)
{
  ...
  if(mkdir("dots") != 0){
    ...
    4d36:	7a650513          	addi	a0,a0,1958 # 94d8 <lock_init+0x1806>
    ...
    4d4e:	79650513          	addi	a0,a0,1942 # 94e0 <lock_init+0x180e>
  ...
  if(chdir("dots") != 0){
    ...
    4d68:	77450513          	addi	a0,a0,1908 # 94d8 <lock_init+0x1806>
    ...
    4d80:	77c50513          	addi	a0,a0,1916 # 94f8 <lock_init+0x1826>
  ...
  if(unlink(".") == 0){
    ...
    4d9a:	d1a50513          	addi	a0,a0,-742 # 8ab0 <lock_init+0xdde>
    ...
    4db2:	76250513          	addi	a0,a0,1890 # 9510 <lock_init+0x183e>
  ...
  if(unlink("..") == 0){
    ...
    4dcc:	74050513          	addi	a0,a0,1856 # 8508 <lock_init+0x836>
    ...
    4de4:	74850513          	addi	a0,a0,1864 # 9528 <lock_init+0x1856>
  ...
  if(chdir("/") != 0){
    ...
    4dfe:	42650513          	addi	a0,a0,1062 # 8220 <lock_init+0x54e>
    ...
    4e16:	41650513          	addi	a0,a0,1046 # 8228 <lock_init+0x556>
  ...
  if(unlink("dots/.") == 0){
    ...
    4e30:	71450513          	addi	a0,a0,1812 # 9540 <lock_init+0x186e>
    ...
    4e48:	70450513          	addi	a0,a0,1796 # 9548 <lock_init+0x1876>
  ...
  if(unlink("dots/..") == 0){
    ...
    4e62:	70a50513          	addi	a0,a0,1802 # 9568 <lock_init+0x1896>
    ...
    4e7a:	6fa50513          	addi	a0,a0,1786 # 9570 <lock_init+0x189e>
  ...
  if(unlink("dots") != 0){
    ...
    4e94:	64850513          	addi	a0,a0,1608 # 94d8 <lock_init+0x1806>
    ...
    4eac:	6e850513          	addi	a0,a0,1768 # 9590 <lock_init+0x18be>
...
dirfile(char *s)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4ee0:	6d450513          	addi	a0,a0,1748 # 95b0 <lock_init+0x18de>
  ...
  if(fd < 0){
    ...
    4f04:	6b850513          	addi	a0,a0,1720 # 95b8 <lock_init+0x18e6>
  ...
  if(chdir("dirfile") == 0){
    ...
    4f2c:	68850513          	addi	a0,a0,1672 # 95b0 <lock_init+0x18de>
    ...
    4f44:	69850513          	addi	a0,a0,1688 # 95d8 <lock_init+0x1906>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4f60:	69c50513          	addi	a0,a0,1692 # 95f8 <lock_init+0x1926>
  ...
  if(fd >= 0){
    ...
    4f84:	68850513          	addi	a0,a0,1672 # 9608 <lock_init+0x1936>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4fa2:	65a50513          	addi	a0,a0,1626 # 95f8 <lock_init+0x1926>
  ...
  if(fd >= 0){
    ...
    4fc6:	64650513          	addi	a0,a0,1606 # 9608 <lock_init+0x1936>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4fe0:	61c50513          	addi	a0,a0,1564 # 95f8 <lock_init+0x1926>
    ...
    4ff8:	63c50513          	addi	a0,a0,1596 # 9630 <lock_init+0x195e>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    5012:	5ea50513          	addi	a0,a0,1514 # 95f8 <lock_init+0x1926>
    ...
    502a:	63250513          	addi	a0,a0,1586 # 9658 <lock_init+0x1986>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    5044:	5b858593          	addi	a1,a1,1464 # 95f8 <lock_init+0x1926>
    5048:	00003517          	auipc	a0,0x3
    504c:	d6050513          	addi	a0,a0,-672 # 7da8 <lock_init+0xd6>
    ...
    5064:	62050513          	addi	a0,a0,1568 # 9680 <lock_init+0x19ae>
  ...
  if(unlink("dirfile") != 0){
    ...
    507e:	53650513          	addi	a0,a0,1334 # 95b0 <lock_init+0x18de>
    ...
    5096:	61650513          	addi	a0,a0,1558 # 96a8 <lock_init+0x19d6>
  ...
  fd = open(".", O_RDWR);
    ...
    50b2:	a0250513          	addi	a0,a0,-1534 # 8ab0 <lock_init+0xdde>
  ...
  if(fd >= 0){
    ...
    50d6:	5f650513          	addi	a0,a0,1526 # 96c8 <lock_init+0x19f6>
  ...
  fd = open(".", 0);
    ...
    50f2:	9c250513          	addi	a0,a0,-1598 # 8ab0 <lock_init+0xdde>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    510e:	cee58593          	addi	a1,a1,-786 # 7df8 <lock_init+0x126>
    5112:	853e                	mv	a0,a5
    ...
    512a:	5ca50513          	addi	a0,a0,1482 # 96f0 <lock_init+0x1a1e>
...
iref(char *s)
{
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    516e:	59e50513          	addi	a0,a0,1438 # 9708 <lock_init+0x1a36>
    ...
    5186:	58e50513          	addi	a0,a0,1422 # 9710 <lock_init+0x1a3e>
    ...
    51a0:	56c50513          	addi	a0,a0,1388 # 9708 <lock_init+0x1a36>
    ...
    51b8:	57450513          	addi	a0,a0,1396 # 9728 <lock_init+0x1a56>
    ...
    5230:	ca450513          	addi	a0,a0,-860 # 7ed0 <lock_init+0x1fe>
    ...
    525e:	c7650513          	addi	a0,a0,-906 # 7ed0 <lock_init+0x1fe>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    528e:	27e50513          	addi	a0,a0,638 # 8508 <lock_init+0x836>
    5292:	00002097          	auipc	ra,0x2
    5296:	14e080e7          	jalr	334(ra) # 73e0 <chdir>
    unlink("irefd");
    529a:	00004517          	auipc	a0,0x4
    529e:	46e50513          	addi	a0,a0,1134 # 9708 <lock_init+0x1a36>
  ...
  chdir("/");
    ...
    52c8:	f5c50513          	addi	a0,a0,-164 # 8220 <lock_init+0x54e>
...
forktest(char *s)
{
  ...
  if (n == 0) {
    ...
    5348:	40450513          	addi	a0,a0,1028 # 9748 <lock_init+0x1a76>
  ...
  if(n == N){
    ...
    5376:	3ee50513          	addi	a0,a0,1006 # 9760 <lock_init+0x1a8e>
  ...
  for(; n > 0; n--){
    ...
    53a4:	3e850513          	addi	a0,a0,1000 # 9788 <lock_init+0x1ab6>
  ...
  if(wait(0) != -1){
    ...
    53ea:	3ba50513          	addi	a0,a0,954 # 97a0 <lock_init+0x1ace>
...
sbrkbasic(char *s)
{
  ...
  if(pid < 0){
    ...
    5432:	38a50513          	addi	a0,a0,906 # 97b8 <lock_init+0x1ae6>
  ...
  if(xstatus == 1){
    ...
    54d4:	30850513          	addi	a0,a0,776 # 97d8 <lock_init+0x1b06>
  ...
  for(i = 0; i < 5000; i++){
    ...
    552e:	2ce50513          	addi	a0,a0,718 # 97f8 <lock_init+0x1b26>
    ...
    *b = 1;
    ...
    5548:	4705                	li	a4,1
    554a:	00e78023          	sb	a4,0(a5) # 40000000 <__BSS_END__+0x3ffef240>
    a = b + 1;
  ...
  if(pid < 0){
    ...
    5594:	28850513          	addi	a0,a0,648 # 9818 <lock_init+0x1b46>
  ...
  if(c != a + 1){
    ...
    55dc:	26050513          	addi	a0,a0,608 # 9838 <lock_init+0x1b66>
...
sbrkmuch(char *s)
{
  ...
  if (p != a) {
    ...
    5680:	1dc50513          	addi	a0,a0,476 # 9858 <lock_init+0x1b86>
  ...
  *lastaddr = 99;
    ...
    56e2:	00e78023          	sb	a4,0(a5) # 6400000 <__BSS_END__+0x63ef240>
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5714:	19050513          	addi	a0,a0,400 # 98a0 <lock_init+0x1bce>
  ...
  if(c != a - PGSIZE){
    ...
    5758:	16c50513          	addi	a0,a0,364 # 98c0 <lock_init+0x1bee>
  ...
  if(c != a || sbrk(0) != a + PGSIZE){
    ...
    57be:	14650513          	addi	a0,a0,326 # 9900 <lock_init+0x1c2e>
  ...
  if(*lastaddr == 99){
    ...
    57ee:	14650513          	addi	a0,a0,326 # 9930 <lock_init+0x1c5e>
  ...
  if(c != a){
    ...
    5850:	11c50513          	addi	a0,a0,284 # 9968 <lock_init+0x1c96>
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    58a6:	88650513          	addi	a0,a0,-1914 # 8128 <lock_init+0x456>
    ...
    58dc:	0b850513          	addi	a0,a0,184 # 9990 <lock_init+0x1cbe>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    591c:	35078793          	addi	a5,a5,848 # c350 <__global_pointer$+0x15c7>
    ...
    5930:	47f78793          	addi	a5,a5,1151 # 1003d47f <__BSS_END__+0x1002c6bf>
...
MAXVAplus(char *s)
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    597a:	7b250513          	addi	a0,a0,1970 # 8128 <lock_init+0x456>
...
sbrkfail(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    5a30:	b9450513          	addi	a0,a0,-1132 # 85c0 <lock_init+0x8ee>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    5aa4:	35858593          	addi	a1,a1,856 # 7df8 <lock_init+0x126>
    5aa8:	853e                	mv	a0,a5
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5b7a:	e5250513          	addi	a0,a0,-430 # 99c8 <lock_init+0x1cf6>
  ...
  if(pid < 0){
    ...
    5bb0:	57c50513          	addi	a0,a0,1404 # 8128 <lock_init+0x456>
  ...
  if(pid == 0){
    ...
    5c38:	db450513          	addi	a0,a0,-588 # 99e8 <lock_init+0x1d16>
...
sbrkarg(char *s)
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    5caa:	d7250513          	addi	a0,a0,-654 # 9a18 <lock_init+0x1d46>
  ...
  unlink("sbrk");
    ...
    5cc0:	d5c50513          	addi	a0,a0,-676 # 9a18 <lock_init+0x1d46>
  ...
  if(fd < 0)  {
    ...
    5cde:	d4650513          	addi	a0,a0,-698 # 9a20 <lock_init+0x1d4e>
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    5d20:	d1c50513          	addi	a0,a0,-740 # 9a38 <lock_init+0x1d66>
  ...
  if(pipe((int *) a) != 0){
    ...
    5d6a:	85a50513          	addi	a0,a0,-1958 # 85c0 <lock_init+0x8ee>
...
validatetest(char *s)
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    5dae:	ca650513          	addi	a0,a0,-858 # 9a50 <lock_init+0x1d7e>
    ...
    5dcc:	c9850513          	addi	a0,a0,-872 # 9a60 <lock_init+0x1d8e>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    5e20:	77470713          	addi	a4,a4,1908 # d590 <uninit>
    ...
    5e38:	c4c50513          	addi	a0,a0,-948 # 9a80 <lock_init+0x1dae>
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    ...
    5e84:	c1850513          	addi	a0,a0,-1000 # 9a98 <lock_init+0x1dc6>
  ...
  if(pid == 0){
    ...
    5f46:	c4650513          	addi	a0,a0,-954 # 9b88 <lock_init+0x1eb6>
  ...
  fd = open("bigarg-ok", 0);
    ...
    5f84:	b1850513          	addi	a0,a0,-1256 # 9a98 <lock_init+0x1dc6>
  ...
  if(fd < 0){
    ...
    5fa8:	c0450513          	addi	a0,a0,-1020 # 9ba8 <lock_init+0x1ed6>
...
fsfull()
{
  ...
  printf("fsfull test\n");
    ...
    5fe6:	be650513          	addi	a0,a0,-1050 # 9bc8 <lock_init+0x1ef6>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    60a0:	b3c50513          	addi	a0,a0,-1220 # 9bd8 <lock_init+0x1f06>
    ...
    60d8:	b1450513          	addi	a0,a0,-1260 # 9be8 <lock_init+0x1f16>
    ...
    60f6:	49e58593          	addi	a1,a1,1182 # a590 <buf>
    60fa:	853e                	mv	a0,a5
    ...
    6142:	aba50513          	addi	a0,a0,-1350 # 9bf8 <lock_init+0x1f26>
  ...
  printf("fsfull test finished\n");
    ...
    623a:	9d250513          	addi	a0,a0,-1582 # 9c08 <lock_init+0x1f36>
...
void argptest(char *s)
{
  ...
  fd = open("init", O_RDONLY);
    ...
    6262:	9c250513          	addi	a0,a0,-1598 # 9c20 <lock_init+0x1f4e>
  ...
  if (fd < 0) {
    ...
    6286:	ebe50513          	addi	a0,a0,-322 # 8140 <lock_init+0x46e>
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    6316:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffee240>
    631a:	2781                	sext.w	a5,a5
    631c:	863e                	mv	a2,a5
    631e:	fc843583          	ld	a1,-56(s0)
    6322:	00004517          	auipc	a0,0x4
    6326:	90650513          	addi	a0,a0,-1786 # 9c28 <lock_init+0x1f56>
    ...
    634e:	dde50513          	addi	a0,a0,-546 # 8128 <lock_init+0x456>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    63ae:	16e78793          	addi	a5,a5,366 # a518 <lock_init+0x2846>
  ...
  pipe((int*)0xeaeb0b5b00002f5e);
    ...
    63c4:	15878793          	addi	a5,a5,344 # a518 <lock_init+0x2846>
...
sbrkbugs(char *s)
{
  ...
  if(pid < 0){
    ...
    6406:	af650513          	addi	a0,a0,-1290 # 7ef8 <lock_init+0x226>
  ...
  if(pid < 0){
    ...
    6478:	a8450513          	addi	a0,a0,-1404 # 7ef8 <lock_init+0x226>
  ...
  if(pid < 0){
    ...
    64ee:	a0e50513          	addi	a0,a0,-1522 # 7ef8 <lock_init+0x226>
...
sbrk8000(char *s)
{
  ...
  sbrk(0x80000004);
    ...
    6694:	00478513          	addi	a0,a5,4 # ffffffff80000004 <__BSS_END__+0xffffffff7ffef244>
...
badwrite(char *s)
{
  ...
  unlink("junk");
    ...
    66ee:	56650513          	addi	a0,a0,1382 # 9c50 <lock_init+0x1f7e>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    6708:	54c50513          	addi	a0,a0,1356 # 9c50 <lock_init+0x1f7e>
    ...
    6728:	53450513          	addi	a0,a0,1332 # 9c58 <lock_init+0x1f86>
    ...
    6766:	4ee50513          	addi	a0,a0,1262 # 9c50 <lock_init+0x1f7e>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    6796:	4be50513          	addi	a0,a0,1214 # 9c50 <lock_init+0x1f7e>
  ...
  if(fd < 0){
    ...
    67b6:	4a650513          	addi	a0,a0,1190 # 9c58 <lock_init+0x1f86>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    67d6:	62658593          	addi	a1,a1,1574 # 7df8 <lock_init+0x126>
    67da:	853e                	mv	a0,a5
    ...
    67f2:	48250513          	addi	a0,a0,1154 # 9c70 <lock_init+0x1f9e>
  ...
  unlink("junk");
    ...
    681a:	43a50513          	addi	a0,a0,1082 # 9c50 <lock_init+0x1f7e>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    6858:	6b450513          	addi	a0,a0,1716 # 7f08 <lock_init+0x236>
  ...
  for(int i = 0; i < 50000; i++){
    ...
    6878:	34f78793          	addi	a5,a5,847 # c34f <__global_pointer$+0x15c6>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    68b8:	64450513          	addi	a0,a0,1604 # 7ef8 <lock_init+0x226>
    ...
    6940:	5cc78793          	addi	a5,a5,1484 # 7f08 <lock_init+0x236>
    6944:	fcf43023          	sd	a5,-64(s0)
    6948:	00001797          	auipc	a5,0x1
    694c:	4b078793          	addi	a5,a5,1200 # 7df8 <lock_init+0x126>
    ...
    6962:	5aa50513          	addi	a0,a0,1450 # 7f08 <lock_init+0x236>
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    69c4:	2c050513          	addi	a0,a0,704 # 9c80 <lock_init+0x1fae>
  ...
  if(pid < 0){
    ...
    69f6:	2ae50513          	addi	a0,a0,686 # 9ca0 <lock_init+0x1fce>
  ...
  if(pid == 0){
    ...
    6a58:	3a458593          	addi	a1,a1,932 # 7df8 <lock_init+0x126>
    6a5c:	853e                	mv	a0,a5
    ...
    6a74:	25050513          	addi	a0,a0,592 # 9cc0 <lock_init+0x1fee>
  ...
  while(1){
    ...
    6ad2:	21250513          	addi	a0,a0,530 # 9ce0 <lock_init+0x200e>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    6b3c:	1c850513          	addi	a0,a0,456 # 9d00 <lock_init+0x202e>
  ...
  if((pid = fork()) < 0) {
    ...
    6b64:	1b050513          	addi	a0,a0,432 # 9d10 <lock_init+0x203e>
  ...
  if(pid == 0) {
    ...
    6bae:	17e50513          	addi	a0,a0,382 # 9d28 <lock_init+0x2056>
    ...
    6bc0:	17450513          	addi	a0,a0,372 # 9d30 <lock_init+0x205e>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    6c20:	11c58593          	addi	a1,a1,284 # 9d38 <lock_init+0x2066>
    6c24:	853e                	mv	a0,a5
    ...
    6c54:	0f058593          	addi	a1,a1,240 # 9d40 <lock_init+0x206e>
    6c58:	853e                	mv	a0,a5
    ...
    6cb0:	09c50513          	addi	a0,a0,156 # 9d48 <lock_init+0x2076>
  ...
  struct test {
    ...
    6cca:	46270713          	addi	a4,a4,1122 # a128 <lock_init+0x2456>
  ...
  if(continuous){
    ...
    6cf2:	08250513          	addi	a0,a0,130 # 9d70 <lock_init+0x209e>
    ...
    6d5c:	03850513          	addi	a0,a0,56 # 9d90 <lock_init+0x20be>
    ...
    6db6:	ff650513          	addi	a0,a0,-10 # 9da8 <lock_init+0x20d6>
  ...
  printf("usertests starting\n");
    ...
    6dde:	fee50513          	addi	a0,a0,-18 # 9dc8 <lock_init+0x20f6>
  ...
  if(fail){
    ...
    6e68:	f2c50513          	addi	a0,a0,-212 # 9d90 <lock_init+0x20be>
    ...
    6eae:	f3650513          	addi	a0,a0,-202 # 9de0 <lock_init+0x210e>
    ...
    6ec8:	f4c50513          	addi	a0,a0,-180 # 9e10 <lock_init+0x213e>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    74d0:	0ac68693          	addi	a3,a3,172 # a578 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    75a4:	fd870713          	addi	a4,a4,-40 # a578 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    7764:	dc078793          	addi	a5,a5,-576 # a520 <lock_init+0x284e>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    7910:	4ac78793          	addi	a5,a5,1196 # 10db8 <freep>
  ...
  freep = p;
    ...
    7a08:	3b478793          	addi	a5,a5,948 # 10db8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    7a8a:	33278793          	addi	a5,a5,818 # 10db8 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    7abc:	30078793          	addi	a5,a5,768 # 10db8 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    7b78:	24478793          	addi	a5,a5,580 # 10db8 <freep>
    ...
    7b8e:	22e78793          	addi	a5,a5,558 # 10db8 <freep>
...
int thread_create(void (*start_routine)(void*),  void *arg){
    ...
    7bfe:	92e50513          	addi	a0,a0,-1746 # a528 <lock_init+0x2856>
...
void lock_acquire (lock_t *)
{
    ...
    7cb8:	0001                	nop
    7cba:	6462                	ld	s0,24(sp)
    7cbc:	6105                	addi	sp,sp,32
    7cbe:	8082                	ret

0000000000007cc0 <lock_release>:

void lock_release (lock_t *)
{
    7cc0:	1101                	addi	sp,sp,-32
    7cc2:	ec22                	sd	s0,24(sp)
    7cc4:	1000                	addi	s0,sp,32
    7cc6:	fea43423          	sd	a0,-24(s0)
    
}
    7cca:	0001                	nop
    7ccc:	6462                	ld	s0,24(sp)
    7cce:	6105                	addi	sp,sp,32
    7cd0:	8082                	ret

0000000000007cd2 <lock_init>:

void lock_init (lock_t *)
{
    7cd2:	1101                	addi	sp,sp,-32
    7cd4:	ec22                	sd	s0,24(sp)
    7cd6:	1000                	addi	s0,sp,32
    7cd8:	fea43423          	sd	a0,-24(s0)
    
}
    7cdc:	0001                	nop
    7cde:	6462                	ld	s0,24(sp)
    7ce0:	6105                	addi	sp,sp,32
    7ce2:	8082                	ret
