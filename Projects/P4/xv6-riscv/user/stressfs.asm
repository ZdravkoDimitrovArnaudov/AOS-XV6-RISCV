...
main(int argc, char *argv[])
{
  ...
  char path[] = "stressfs0";
      ...
      1c:	06078793          	addi	a5,a5,96 # 1078 <cv_init+0x46>
      20:	6398                	ld	a4,0(a5)
  ...
  printf("stressfs starting\n");
      ...
      32:	01a50513          	addi	a0,a0,26 # 1048 <cv_init+0x16>
  ...
  printf("write %d\n", i);
      ...
      8e:	fd650513          	addi	a0,a0,-42 # 1060 <cv_init+0x2e>
...
//    printf(fd, "%d\n", i);
  ...
  printf("read\n");
     ...
     110:	f6450513          	addi	a0,a0,-156 # 1070 <cv_init+0x3e>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     77c:	96868693          	addi	a3,a3,-1688 # 10e0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     850:	89470713          	addi	a4,a4,-1900 # 10e0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     a10:	67c78793          	addi	a5,a5,1660 # 1088 <cv_init+0x56>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     bbc:	55078793          	addi	a5,a5,1360 # 1108 <freep>
     bc0:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     cb4:	45878793          	addi	a5,a5,1112 # 1108 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     d36:	3d678793          	addi	a5,a5,982 # 1108 <freep>
     d3a:	639c                	ld	a5,0(a5)
}
     d3c:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d68:	3a478793          	addi	a5,a5,932 # 1108 <freep>
     d6c:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d7c:	38078793          	addi	a5,a5,896 # 10f8 <base>
     d80:	fef43023          	sd	a5,-32(s0)
     d84:	00000797          	auipc	a5,0x0
     d88:	38478793          	addi	a5,a5,900 # 1108 <freep>
     d8c:	fe043703          	ld	a4,-32(s0)
     d90:	e398                	sd	a4,0(a5)
     d92:	00000797          	auipc	a5,0x0
     d96:	37678793          	addi	a5,a5,886 # 1108 <freep>
     d9a:	6398                	ld	a4,0(a5)
     d9c:	00000797          	auipc	a5,0x0
     da0:	35c78793          	addi	a5,a5,860 # 10f8 <base>
     da4:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     da6:	00000797          	auipc	a5,0x0
     daa:	35278793          	addi	a5,a5,850 # 10f8 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     e24:	2e878793          	addi	a5,a5,744 # 1108 <freep>
    ...
    if(p == freep)
     ...
     e3a:	2d278793          	addi	a5,a5,722 # 1108 <freep>
     e3e:	639c                	ld	a5,0(a5)
...
int thread_create(void (*start_routine)(void*),  void *arg){
    ...
    if (!(stack = malloc (PAGE_SIZE))){
     ...
     eaa:	1ea50513          	addi	a0,a0,490 # 1090 <cv_init+0x5e>
...
void lock_acquire (lock_t *lock){
    ...
    while( __sync_lock_test_and_set(lock, 1)!=0){
     ...
     f6a:	4705                	li	a4,1
     f6c:	0ce7a72f          	amoswap.w.aq	a4,a4,(a5)
     f70:	0007079b          	sext.w	a5,a4
     f74:	fbed                	bnez	a5,f66 <lock_acquire+0xc>
...
void lock_release (lock_t *lock){
    ...
    __sync_lock_release(lock);
     ...
     f94:	0f50000f          	fence	iorw,ow
     f98:	0807a02f          	amoswap.w	zero,zero,(a5)
...
0000000000000fa4 <lock_init>:

void lock_init (lock_t *lock){
     fa4:	1101                	addi	sp,sp,-32
     fa6:	ec22                	sd	s0,24(sp)
    ...
    lock = 0;
     ...
     fb2:	0001                	nop
     fb4:	6462                	ld	s0,24(sp)
     fb6:	6105                	addi	sp,sp,32
     fb8:	8082                	ret

0000000000000fba <cv_wait>:
...
void cv_wait (cont_t *cv, lock_t *lock){
     ...
     fc6:	feb43023          	sd	a1,-32(s0)
    while( __sync_lock_test_and_set(cv, 0)!=1){
     fca:	a015                	j	fee <cv_wait+0x34>
        lock_release(lock);
     fcc:	fe043503          	ld	a0,-32(s0)
     fd0:	00000097          	auipc	ra,0x0
     fd4:	fb2080e7          	jalr	-78(ra) # f82 <lock_release>
        sleep(1);
     fd8:	4505                	li	a0,1
     fda:	fffff097          	auipc	ra,0xfffff
     fde:	6d2080e7          	jalr	1746(ra) # 6ac <sleep>
        lock_acquire(lock);
     fe2:	fe043503          	ld	a0,-32(s0)
     fe6:	00000097          	auipc	ra,0x0
     fea:	f74080e7          	jalr	-140(ra) # f5a <lock_acquire>
    while( __sync_lock_test_and_set(cv, 0)!=1){
     ...
     ffc:	873e                	mv	a4,a5
     ffe:	4785                	li	a5,1
    1000:	fcf716e3          	bne	a4,a5,fcc <cv_wait+0x12>
    }
...
void cv_signal (cont_t *cv){
    ...
    1024:	4705                	li	a4,1
    1026:	0ce7a72f          	amoswap.w.aq	a4,a4,(a5)

}
    102a:	0001                	nop
    102c:	6462                	ld	s0,24(sp)
    102e:	6105                	addi	sp,sp,32
    1030:	8082                	ret

0000000000001032 <cv_init>:
...
void cv_init (cont_t *cv){
    ...
    cv = 0;
    103c:	fe043423          	sd	zero,-24(s0)
    1040:	0001                	nop
    1042:	6462                	ld	s0,24(sp)
