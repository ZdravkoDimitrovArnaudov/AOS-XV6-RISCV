...
main()
{
  ...
  scheduler();        
    ...
    80000f64:	486080e7          	jalr	1158(ra) # 800043e6 <fileinit>
    virtio_disk_init(); // emulated hard disk
...
0000000080001c6e <userinit>:
{
  ...
  p->cwd = namei("/");
    ...
    80001cd0:	116080e7          	jalr	278(ra) # 80003de2 <namei>
...
0000000080001d68 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001e1c:	660080e7          	jalr	1632(ra) # 80004478 <filedup>
...
00000000800022b6 <exit>:
{
  ...
  if(p == initproc)
    ...
    800022fa:	1d4080e7          	jalr	468(ra) # 800044ca <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    ...
    80002312:	cf4080e7          	jalr	-780(ra) # 80004002 <begin_op>
  iput(p->cwd);
  ...
  end_op();
    ...
    80002326:	d5e080e7          	jalr	-674(ra) # 80004080 <end_op>
  p->cwd = 0;
...
binit(void)
{
  ...
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    ...
    80002d96:	52a080e7          	jalr	1322(ra) # 800042bc <initsleeplock>
...
bread(uint dev, uint blockno)
{
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80002e26:	4d4080e7          	jalr	1236(ra) # 800042f6 <acquiresleep>
      return b;
  ...
  panic("bget: no buffers");
    ...
    80002e84:	476080e7          	jalr	1142(ra) # 800042f6 <acquiresleep>
  struct buf *b;
...
bwrite(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    80002ec0:	4d4080e7          	jalr	1236(ra) # 80004390 <holdingsleep>
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    80002f04:	490080e7          	jalr	1168(ra) # 80004390 <holdingsleep>
  ...
  releasesleep(&b->lock);
    ...
    80002f10:	440080e7          	jalr	1088(ra) # 8000434c <releasesleep>
...
bfree(int dev, uint b)
{
  ...
  log_write(bp);
    ...
    80003054:	188080e7          	jalr	392(ra) # 800041d8 <log_write>
  brelse(bp);
...
000000008000307e <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    8000314e:	08e080e7          	jalr	142(ra) # 800041d8 <log_write>
        brelse(bp);
  ...
  log_write(bp);
    ...
    80003182:	05a080e7          	jalr	90(ra) # 800041d8 <log_write>
  brelse(bp);
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    80003272:	f6a080e7          	jalr	-150(ra) # 800041d8 <log_write>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    800033a2:	bbe080e7          	jalr	-1090(ra) # 80003f5c <initlog>
}
...
00000000800033c4 <iinit>:
{
  ...
  for(i = 0; i < NINODE; i++) {
    ...
    8000340a:	eb6080e7          	jalr	-330(ra) # 800042bc <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
0000000080003424 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    800034c2:	d1a080e7          	jalr	-742(ra) # 800041d8 <log_write>
      brelse(bp);
...
00000000800034f2 <iupdate>:
{
  ...
  log_write(bp);
    ...
    80003566:	c76080e7          	jalr	-906(ra) # 800041d8 <log_write>
  brelse(bp);
...
00000000800035be <ilock>:
{
  ...
  acquiresleep(&ip->lock);
    ...
    800035da:	d20080e7          	jalr	-736(ra) # 800042f6 <acquiresleep>
  if(ip->valid == 0){
...
0000000080003680 <iunlock>:
{
  ...
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    ...
    8000369a:	cfa080e7          	jalr	-774(ra) # 80004390 <holdingsleep>
  ...
  releasesleep(&ip->lock);
    ...
    800036ac:	ca4080e7          	jalr	-860(ra) # 8000434c <releasesleep>
}
...
0000000080003778 <iput>:
{
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    800037d4:	b26080e7          	jalr	-1242(ra) # 800042f6 <acquiresleep>
    release(&itable.lock);
    ...
    8000380a:	b46080e7          	jalr	-1210(ra) # 8000434c <releasesleep>
    acquire(&itable.lock);
...
readi(struct inode *ip, int user_dst, uint64 dst, uint off, uint n)
{
    ...
    80003882:	f85a                	sd	s6,48(sp)
    80003884:	f45e                	sd	s7,40(sp)
    80003886:	f062                	sd	s8,32(sp)
    80003888:	ec66                	sd	s9,24(sp)
    8000388a:	e86a                	sd	s10,16(sp)
    8000388c:	e46e                	sd	s11,8(sp)
    8000388e:	1880                	addi	s0,sp,112
  uint tot, m;
  struct buf *bp = NULL;
  m = 0;

  if(off > ip->size || off + n < off)
    80003890:	04c52983          	lw	s3,76(a0)
    80003894:	10d9e463          	bltu	s3,a3,8000399c <readi+0x12a>
    80003898:	8b2a                	mv	s6,a0
    8000389a:	8c2e                	mv	s8,a1
    8000389c:	8ab2                	mv	s5,a2
    8000389e:	84b6                	mv	s1,a3
    800038a0:	8bba                	mv	s7,a4
    800038a2:	00e687bb          	addw	a5,a3,a4
    return 0;
    800038a6:	4501                	li	a0,0
  if(off > ip->size || off + n < off)
    800038a8:	0cd7eb63          	bltu	a5,a3,8000397e <readi+0x10c>

  if(off + n > ip->size)
    800038ac:	00f9f463          	bgeu	s3,a5,800038b4 <readi+0x42>
    n = ip->size - off;
    800038b0:	40d98bbb          	subw	s7,s3,a3


  if (ip->type == T_SMALLFILE){ //small file
    800038b4:	044b1703          	lh	a4,68(s6)
    800038b8:	4791                	li	a5,4
    800038ba:	00f70a63          	beq	a4,a5,800038ce <readi+0x5c>
    }
    ...
    800038c0:	40000d13          	li	s10,1024
    if(either_copyout(user_dst, dst, bp->data + (off % BSIZE), m) == -1) {
    800038c4:	5cfd                	li	s9,-1
    for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    800038c6:	060b9563          	bnez	s7,80003930 <readi+0xbe>
    800038ca:	895e                	mv	s2,s7
    800038cc:	a07d                	j	8000397a <readi+0x108>
    if(either_copyout(user_dst, dst, bp->data + (off % BSIZE), m) == -1) {
    800038ce:	3ff4f493          	andi	s1,s1,1023
    800038d2:	4681                	li	a3,0
    800038d4:	05848613          	addi	a2,s1,88
    800038d8:	85d6                	mv	a1,s5
    800038da:	8562                	mv	a0,s8
    800038dc:	fffff097          	auipc	ra,0xfffff
    800038e0:	b22080e7          	jalr	-1246(ra) # 800023fe <either_copyout>
    800038e4:	57fd                	li	a5,-1
      tot = -1;
    800038e6:	597d                	li	s2,-1
    if(either_copyout(user_dst, dst, bp->data + (off % BSIZE), m) == -1) {
    800038e8:	08f50963          	beq	a0,a5,8000397a <readi+0x108>
    800038ec:	894e                	mv	s2,s3
    800038ee:	013bf363          	bgeu	s7,s3,800038f4 <readi+0x82>
    800038f2:	895e                	mv	s2,s7
    800038f4:	2901                	sext.w	s2,s2
    800038f6:	a051                	j	8000397a <readi+0x108>
    if(either_copyout(user_dst, dst, bp->data + (off % BSIZE), m) == -1) {
    800038f8:	020a1d93          	slli	s11,s4,0x20
    800038fc:	020ddd93          	srli	s11,s11,0x20
    80003900:	05898613          	addi	a2,s3,88
    80003904:	86ee                	mv	a3,s11
    80003906:	963a                	add	a2,a2,a4
    80003908:	85d6                	mv	a1,s5
    8000390a:	8562                	mv	a0,s8
    8000390c:	fffff097          	auipc	ra,0xfffff
    80003910:	af2080e7          	jalr	-1294(ra) # 800023fe <either_copyout>
    80003914:	05950d63          	beq	a0,s9,8000396e <readi+0xfc>
      brelse(bp);
      tot = -1;
      break;
    }
    ...
    8000391e:	5d2080e7          	jalr	1490(ra) # 80002eec <brelse>
    for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80003922:	012a093b          	addw	s2,s4,s2
    80003926:	009a04bb          	addw	s1,s4,s1
    8000392a:	9aee                	add	s5,s5,s11
    8000392c:	05797763          	bgeu	s2,s7,8000397a <readi+0x108>
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
    80003930:	000b2983          	lw	s3,0(s6)
    80003934:	00a4d59b          	srliw	a1,s1,0xa
    80003938:	855a                	mv	a0,s6
    8000393a:	00000097          	auipc	ra,0x0
    8000393e:	872080e7          	jalr	-1934(ra) # 800031ac <bmap>
    80003942:	0005059b          	sext.w	a1,a0
    80003946:	854e                	mv	a0,s3
    80003948:	fffff097          	auipc	ra,0xfffff
    8000394c:	474080e7          	jalr	1140(ra) # 80002dbc <bread>
    80003950:	89aa                	mv	s3,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    80003952:	3ff4f713          	andi	a4,s1,1023
    80003956:	40ed07bb          	subw	a5,s10,a4
    8000395a:	412b86bb          	subw	a3,s7,s2
    8000395e:	8a3e                	mv	s4,a5
    80003960:	2781                	sext.w	a5,a5
    80003962:	0006861b          	sext.w	a2,a3
    80003966:	f8f679e3          	bgeu	a2,a5,800038f8 <readi+0x86>
    8000396a:	8a36                	mv	s4,a3
    8000396c:	b771                	j	800038f8 <readi+0x86>
      brelse(bp);
    8000396e:	854e                	mv	a0,s3
    80003970:	fffff097          	auipc	ra,0xfffff
    80003974:	57c080e7          	jalr	1404(ra) # 80002eec <brelse>
      tot = -1;
    80003978:	597d                	li	s2,-1
  }
  ...
  return tot;
    8000397a:	0009051b          	sext.w	a0,s2
}
    ...
    8000399e:	b7c5                	j	8000397e <readi+0x10c>
...
00000000800039a0 <writei>:
  ...
  if(off > ip->size || off + n < off){
    ...
    800039a2:	12d7ef63          	bltu	a5,a3,80003ae0 <writei+0x140>
{
  ...
  if(off > ip->size || off + n < off){
    ...
    800039d2:	10d7e963          	bltu	a5,a3,80003ae4 <writei+0x144>
    return -1;
  }
  
  if (ip->type == T_SMALLFILE){ //small file
    800039d6:	04451683          	lh	a3,68(a0)
    800039da:	4711                	li	a4,4
    800039dc:	00e68d63          	beq	a3,a4,800039f6 <writei+0x56>
    ...
    800039e0:	00043737          	lui	a4,0x43
    800039e4:	10f76463          	bltu	a4,a5,80003aec <writei+0x14c>
      return -1;

    for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    800039e8:	0e0b8a63          	beqz	s7,80003adc <writei+0x13c>
    800039ec:	4981                	li	s3,0
      bp = bread(ip->dev, bmap(ip, off/BSIZE));
      m = min(n - tot, BSIZE - off%BSIZE);
    800039ee:	40000d13          	li	s10,1024
      if(either_copyin(bp->data + (off % BSIZE), user_src, src, m) == -1) {
    800039f2:	5cfd                	li	s9,-1
    800039f4:	a879                	j	80003a92 <writei+0xf2>
    if(off + n > (sizeof(uint) * (NDIRECT +1))){
    800039f6:	03400713          	li	a4,52
    800039fa:	0ef76763          	bltu	a4,a5,80003ae8 <writei+0x148>
    if(either_copyin((void*)ip->addrs, user_src, src, n) == -1) {
    800039fe:	020b9693          	slli	a3,s7,0x20
    80003a02:	9281                	srli	a3,a3,0x20
    80003a04:	05050513          	addi	a0,a0,80
    80003a08:	fffff097          	auipc	ra,0xfffff
    80003a0c:	a4c080e7          	jalr	-1460(ra) # 80002454 <either_copyin>
    80003a10:	57fd                	li	a5,-1
    80003a12:	02f50063          	beq	a0,a5,80003a32 <writei+0x92>
  tot = 0;
  ...
  if(off > ip->size)
    80003a18:	04cb2783          	lw	a5,76(s6)
    80003a1c:	0127f463          	bgeu	a5,s2,80003a24 <writei+0x84>
    ip->size = off;
    80003a20:	052b2623          	sw	s2,76(s6)

  // write the i-node back to disk even if the size didn't change
  // because the loop above might have called bmap() and added a new
  // block to ip->addrs[].
  iupdate(ip);
    80003a24:	855a                	mv	a0,s6
    80003a26:	00000097          	auipc	ra,0x0
    80003a2a:	acc080e7          	jalr	-1332(ra) # 800034f2 <iupdate>

  return tot;
    80003a2e:	0009851b          	sext.w	a0,s3
}
    80003a32:	70a6                	ld	ra,104(sp)
    80003a34:	7406                	ld	s0,96(sp)
    80003a36:	64e6                	ld	s1,88(sp)
    80003a38:	6946                	ld	s2,80(sp)
    80003a3a:	69a6                	ld	s3,72(sp)
    80003a3c:	6a06                	ld	s4,64(sp)
    80003a3e:	7ae2                	ld	s5,56(sp)
    ...
    80003a68:	9f0080e7          	jalr	-1552(ra) # 80002454 <either_copyin>
    80003a6c:	07950263          	beq	a0,s9,80003ad0 <writei+0x130>
      log_write(bp);
    80003a70:	8526                	mv	a0,s1
    80003a72:	00000097          	auipc	ra,0x0
    80003a76:	766080e7          	jalr	1894(ra) # 800041d8 <log_write>
      brelse(bp);
    80003a7a:	8526                	mv	a0,s1
    80003a7c:	fffff097          	auipc	ra,0xfffff
    80003a80:	470080e7          	jalr	1136(ra) # 80002eec <brelse>
    for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003a84:	013a09bb          	addw	s3,s4,s3
    80003a88:	012a093b          	addw	s2,s4,s2
    80003a8c:	9aee                	add	s5,s5,s11
    80003a8e:	f979f5e3          	bgeu	s3,s7,80003a18 <writei+0x78>
      bp = bread(ip->dev, bmap(ip, off/BSIZE));
    80003a92:	000b2483          	lw	s1,0(s6)
    80003a96:	00a9559b          	srliw	a1,s2,0xa
    80003a9a:	855a                	mv	a0,s6
    80003a9c:	fffff097          	auipc	ra,0xfffff
    80003aa0:	710080e7          	jalr	1808(ra) # 800031ac <bmap>
    80003aa4:	0005059b          	sext.w	a1,a0
    80003aa8:	8526                	mv	a0,s1
    80003aaa:	fffff097          	auipc	ra,0xfffff
    80003aae:	312080e7          	jalr	786(ra) # 80002dbc <bread>
    80003ab2:	84aa                	mv	s1,a0
      m = min(n - tot, BSIZE - off%BSIZE);
    80003ab4:	3ff97713          	andi	a4,s2,1023
    80003ab8:	40ed07bb          	subw	a5,s10,a4
    80003abc:	413b86bb          	subw	a3,s7,s3
    80003ac0:	8a3e                	mv	s4,a5
    80003ac2:	2781                	sext.w	a5,a5
    80003ac4:	0006861b          	sext.w	a2,a3
    80003ac8:	f8f674e3          	bgeu	a2,a5,80003a50 <writei+0xb0>
    80003acc:	8a36                	mv	s4,a3
    80003ace:	b749                	j	80003a50 <writei+0xb0>
        brelse(bp);
    80003ad0:	8526                	mv	a0,s1
    80003ad2:	fffff097          	auipc	ra,0xfffff
    80003ad6:	41a080e7          	jalr	1050(ra) # 80002eec <brelse>
        break;
    80003ada:	bf3d                	j	80003a18 <writei+0x78>
    for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003adc:	89de                	mv	s3,s7
    80003ade:	b799                	j	80003a24 <writei+0x84>
    return -1;
    ...
    80003ae6:	b7b1                	j	80003a32 <writei+0x92>
      return -1;
    80003ae8:	557d                	li	a0,-1
    80003aea:	b7a1                	j	80003a32 <writei+0x92>
      return -1;
    80003aec:	557d                	li	a0,-1
    80003aee:	b791                	j	80003a32 <writei+0x92>

0000000080003af0 <namecmp>:
...
namecmp(const char *s, const char *t)
{
  ...
  return strncmp(s, t, DIRSIZ);
    80003af8:	4639                	li	a2,14
    80003afa:	ffffd097          	auipc	ra,0xffffd
    80003afe:	2a2080e7          	jalr	674(ra) # 80000d9c <strncmp>
}
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
    ...
    80003b18:	0080                	addi	s0,sp,64
  uint off, inum;
  struct dirent de;

  if(dp->type != T_DIR)
    80003b1a:	04451703          	lh	a4,68(a0)
    80003b1e:	4785                	li	a5,1
    80003b20:	00f71a63          	bne	a4,a5,80003b34 <dirlookup+0x2a>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    80003b30:	e79d                	bnez	a5,80003b5e <dirlookup+0x54>
    80003b32:	a8a5                	j	80003baa <dirlookup+0xa0>
    panic("dirlookup not DIR");
    80003b34:	00005517          	auipc	a0,0x5
    80003b38:	ab450513          	addi	a0,a0,-1356 # 800085e8 <syscalls+0x1a0>
    80003b3c:	ffffd097          	auipc	ra,0xffffd
    80003b40:	9fe080e7          	jalr	-1538(ra) # 8000053a <panic>
      panic("dirlookup read");
    80003b44:	00005517          	auipc	a0,0x5
    80003b48:	abc50513          	addi	a0,a0,-1348 # 80008600 <syscalls+0x1b8>
    80003b4c:	ffffd097          	auipc	ra,0xffffd
    80003b50:	9ee080e7          	jalr	-1554(ra) # 8000053a <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
    80003b54:	24c1                	addiw	s1,s1,16
    80003b56:	04c92783          	lw	a5,76(s2)
    80003b5a:	04f4f763          	bgeu	s1,a5,80003ba8 <dirlookup+0x9e>
    if(readi(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    80003b5e:	4741                	li	a4,16
    80003b60:	86a6                	mv	a3,s1
    80003b62:	fc040613          	addi	a2,s0,-64
    80003b66:	4581                	li	a1,0
    80003b68:	854a                	mv	a0,s2
    80003b6a:	00000097          	auipc	ra,0x0
    80003b6e:	d08080e7          	jalr	-760(ra) # 80003872 <readi>
    80003b72:	47c1                	li	a5,16
    80003b74:	fcf518e3          	bne	a0,a5,80003b44 <dirlookup+0x3a>
    if(de.inum == 0)
    80003b78:	fc045783          	lhu	a5,-64(s0)
    80003b7c:	dfe1                	beqz	a5,80003b54 <dirlookup+0x4a>
    if(namecmp(name, de.name) == 0){
    80003b7e:	fc240593          	addi	a1,s0,-62
    80003b82:	854e                	mv	a0,s3
    80003b84:	00000097          	auipc	ra,0x0
    80003b88:	f6c080e7          	jalr	-148(ra) # 80003af0 <namecmp>
    80003b8c:	f561                	bnez	a0,80003b54 <dirlookup+0x4a>
      if(poff)
    80003b8e:	000a0463          	beqz	s4,80003b96 <dirlookup+0x8c>
        *poff = off;
    80003b92:	009a2023          	sw	s1,0(s4)
      return iget(dp->dev, inum);
    80003b96:	fc045583          	lhu	a1,-64(s0)
    80003b9a:	00092503          	lw	a0,0(s2)
    80003b9e:	fffff097          	auipc	ra,0xfffff
    80003ba2:	6ea080e7          	jalr	1770(ra) # 80003288 <iget>
    80003ba6:	a011                	j	80003baa <dirlookup+0xa0>
  return 0;
...
{
    80003bba:	711d                	addi	sp,sp,-96
    80003bbc:	ec86                	sd	ra,88(sp)
    80003bbe:	e8a2                	sd	s0,80(sp)
    80003bc0:	e4a6                	sd	s1,72(sp)
    80003bc2:	e0ca                	sd	s2,64(sp)
    80003bc4:	fc4e                	sd	s3,56(sp)
    80003bc6:	f852                	sd	s4,48(sp)
    80003bc8:	f456                	sd	s5,40(sp)
    80003bca:	f05a                	sd	s6,32(sp)
    80003bcc:	ec5e                	sd	s7,24(sp)
    80003bce:	e862                	sd	s8,16(sp)
    80003bd0:	e466                	sd	s9,8(sp)
    80003bd2:	e06a                	sd	s10,0(sp)
    80003bd4:	1080                	addi	s0,sp,96
    80003bd6:	84aa                	mv	s1,a0
    80003bd8:	8b2e                	mv	s6,a1
    80003bda:	8ab2                	mv	s5,a2
  struct inode *ip, *next;

  if(*path == '/')
    80003bdc:	00054703          	lbu	a4,0(a0)
    80003be0:	02f00793          	li	a5,47
    80003be4:	02f70363          	beq	a4,a5,80003c0a <namex+0x50>
    ip = iget(ROOTDEV, ROOTINO);
  else
    ip = idup(myproc()->cwd);
    80003be8:	ffffe097          	auipc	ra,0xffffe
    80003bec:	dae080e7          	jalr	-594(ra) # 80001996 <myproc>
    80003bf0:	15053503          	ld	a0,336(a0)
    80003bf4:	00000097          	auipc	ra,0x0
    80003bf8:	98c080e7          	jalr	-1652(ra) # 80003580 <idup>
    80003bfc:	8a2a                	mv	s4,a0
  while(*path == '/')
    80003bfe:	02f00913          	li	s2,47
  if(len >= DIRSIZ)
    80003c02:	4cb5                	li	s9,13
  len = path - s;
    80003c04:	4b81                	li	s7,0

  while((path = skipelem(path, name)) != 0){
    ilock(ip);
    if(ip->type != T_DIR){
    80003c06:	4c05                	li	s8,1
    80003c08:	a87d                	j	80003cc6 <namex+0x10c>
    ip = iget(ROOTDEV, ROOTINO);
    80003c0a:	4585                	li	a1,1
    80003c0c:	4505                	li	a0,1
    80003c0e:	fffff097          	auipc	ra,0xfffff
    80003c12:	67a080e7          	jalr	1658(ra) # 80003288 <iget>
    80003c16:	8a2a                	mv	s4,a0
    80003c18:	b7dd                	j	80003bfe <namex+0x44>
      iunlockput(ip);
    80003c1a:	8552                	mv	a0,s4
    80003c1c:	00000097          	auipc	ra,0x0
    80003c20:	c04080e7          	jalr	-1020(ra) # 80003820 <iunlockput>
      return 0;
  ...
  return ip;
    ...
    80003c28:	60e6                	ld	ra,88(sp)
    80003c2a:	6446                	ld	s0,80(sp)
    80003c2c:	64a6                	ld	s1,72(sp)
    80003c2e:	6906                	ld	s2,64(sp)
    80003c30:	79e2                	ld	s3,56(sp)
    80003c32:	7a42                	ld	s4,48(sp)
    80003c34:	7aa2                	ld	s5,40(sp)
    80003c36:	7b02                	ld	s6,32(sp)
    80003c38:	6be2                	ld	s7,24(sp)
    80003c3a:	6c42                	ld	s8,16(sp)
    80003c3c:	6ca2                	ld	s9,8(sp)
    80003c3e:	6d02                	ld	s10,0(sp)
    80003c40:	6125                	addi	sp,sp,96
    80003c42:	8082                	ret
      iunlock(ip);
    80003c44:	8552                	mv	a0,s4
    80003c46:	00000097          	auipc	ra,0x0
    80003c4a:	a3a080e7          	jalr	-1478(ra) # 80003680 <iunlock>
      return ip;
    80003c4e:	bfe1                	j	80003c26 <namex+0x6c>
      iunlockput(ip);
    80003c50:	8552                	mv	a0,s4
    80003c52:	00000097          	auipc	ra,0x0
    80003c56:	bce080e7          	jalr	-1074(ra) # 80003820 <iunlockput>
      return 0;
    80003c5a:	8a4e                	mv	s4,s3
    80003c5c:	b7e9                	j	80003c26 <namex+0x6c>
  len = path - s;
    80003c5e:	40998633          	sub	a2,s3,s1
    80003c62:	00060d1b          	sext.w	s10,a2
  if(len >= DIRSIZ)
    80003c66:	09acd863          	bge	s9,s10,80003cf6 <namex+0x13c>
    memmove(name, s, DIRSIZ);
    80003c6a:	4639                	li	a2,14
    80003c6c:	85a6                	mv	a1,s1
    80003c6e:	8556                	mv	a0,s5
    80003c70:	ffffd097          	auipc	ra,0xffffd
    80003c74:	0b8080e7          	jalr	184(ra) # 80000d28 <memmove>
    80003c78:	84ce                	mv	s1,s3
  while(*path == '/')
    80003c7a:	0004c783          	lbu	a5,0(s1)
    80003c7e:	01279763          	bne	a5,s2,80003c8c <namex+0xd2>
    path++;
    80003c82:	0485                	addi	s1,s1,1
  while(*path == '/')
    80003c84:	0004c783          	lbu	a5,0(s1)
    80003c88:	ff278de3          	beq	a5,s2,80003c82 <namex+0xc8>
    ilock(ip);
    80003c8c:	8552                	mv	a0,s4
    80003c8e:	00000097          	auipc	ra,0x0
    80003c92:	930080e7          	jalr	-1744(ra) # 800035be <ilock>
    if(ip->type != T_DIR){
    80003c96:	044a1783          	lh	a5,68(s4)
    80003c9a:	f98790e3          	bne	a5,s8,80003c1a <namex+0x60>
    if(nameiparent && *path == '\0'){
    80003c9e:	000b0563          	beqz	s6,80003ca8 <namex+0xee>
    80003ca2:	0004c783          	lbu	a5,0(s1)
    80003ca6:	dfd9                	beqz	a5,80003c44 <namex+0x8a>
    if((next = dirlookup(ip, name, 0)) == 0){
    80003ca8:	865e                	mv	a2,s7
    80003caa:	85d6                	mv	a1,s5
    80003cac:	8552                	mv	a0,s4
    80003cae:	00000097          	auipc	ra,0x0
    80003cb2:	e5c080e7          	jalr	-420(ra) # 80003b0a <dirlookup>
    80003cb6:	89aa                	mv	s3,a0
    80003cb8:	dd41                	beqz	a0,80003c50 <namex+0x96>
    iunlockput(ip);
    80003cba:	8552                	mv	a0,s4
    80003cbc:	00000097          	auipc	ra,0x0
    80003cc0:	b64080e7          	jalr	-1180(ra) # 80003820 <iunlockput>
    ip = next;
    80003cc4:	8a4e                	mv	s4,s3
  while(*path == '/')
    80003cc6:	0004c783          	lbu	a5,0(s1)
    80003cca:	01279763          	bne	a5,s2,80003cd8 <namex+0x11e>
    path++;
    80003cce:	0485                	addi	s1,s1,1
  while(*path == '/')
    80003cd0:	0004c783          	lbu	a5,0(s1)
    80003cd4:	ff278de3          	beq	a5,s2,80003cce <namex+0x114>
  if(*path == 0)
    80003cd8:	cb9d                	beqz	a5,80003d0e <namex+0x154>
  while(*path != '/' && *path != 0)
    80003cda:	0004c783          	lbu	a5,0(s1)
    80003cde:	89a6                	mv	s3,s1
  len = path - s;
    80003ce0:	8d5e                	mv	s10,s7
    80003ce2:	865e                	mv	a2,s7
  while(*path != '/' && *path != 0)
    80003ce4:	01278963          	beq	a5,s2,80003cf6 <namex+0x13c>
    80003ce8:	dbbd                	beqz	a5,80003c5e <namex+0xa4>
    path++;
    80003cea:	0985                	addi	s3,s3,1
  while(*path != '/' && *path != 0)
    80003cec:	0009c783          	lbu	a5,0(s3)
    80003cf0:	ff279ce3          	bne	a5,s2,80003ce8 <namex+0x12e>
    80003cf4:	b7ad                	j	80003c5e <namex+0xa4>
    memmove(name, s, len);
    80003cf6:	2601                	sext.w	a2,a2
    80003cf8:	85a6                	mv	a1,s1
    80003cfa:	8556                	mv	a0,s5
    80003cfc:	ffffd097          	auipc	ra,0xffffd
    80003d00:	02c080e7          	jalr	44(ra) # 80000d28 <memmove>
    name[len] = 0;
    80003d04:	9d56                	add	s10,s10,s5
    80003d06:	000d0023          	sb	zero,0(s10)
    80003d0a:	84ce                	mv	s1,s3
    80003d0c:	b7bd                	j	80003c7a <namex+0xc0>
  if(nameiparent){
    80003d0e:	f00b0ce3          	beqz	s6,80003c26 <namex+0x6c>
    iput(ip);
    80003d12:	8552                	mv	a0,s4
    80003d14:	00000097          	auipc	ra,0x0
    80003d18:	a64080e7          	jalr	-1436(ra) # 80003778 <iput>
    return 0;
    80003d1c:	4a01                	li	s4,0
    80003d1e:	b721                	j	80003c26 <namex+0x6c>
...
0000000080003d20 <dirlink>:
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80003d3c:	dd2080e7          	jalr	-558(ra) # 80003b0a <dirlookup>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003d5a:	b1c080e7          	jalr	-1252(ra) # 80003872 <readi>
  ...
  strncpy(de.name, name, DIRSIZ);
    ...
    80003d80:	05c080e7          	jalr	92(ra) # 80000dd8 <strncpy>
  de.inum = inum;
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003d98:	c0c080e7          	jalr	-1012(ra) # 800039a0 <writei>
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003dba:	9c2080e7          	jalr	-1598(ra) # 80003778 <iput>
    return -1;
    ...
    80003dce:	770080e7          	jalr	1904(ra) # 8000053a <panic>
    panic("dirlink");
...
namei(char *path)
{
  ...
  return namex(path, 0, name);
    ...
    80003df4:	dca080e7          	jalr	-566(ra) # 80003bba <namex>
}
...
nameiparent(char *path, char *name)
{
  ...
  return namex(path, 1, name);
    ...
    80003e10:	dae080e7          	jalr	-594(ra) # 80003bba <namex>
}
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80003e3c:	f84080e7          	jalr	-124(ra) # 80002dbc <bread>
  ...
  for (i = 0; i < log.lh.n; i++) {
    80003e48:	02d05863          	blez	a3,80003e78 <write_head+0x5c>
    ...
    80003e5a:	02069613          	slli	a2,a3,0x20
    80003e5e:	01e65693          	srli	a3,a2,0x1e
    80003e62:	0001d617          	auipc	a2,0x1d
    80003e66:	44260613          	addi	a2,a2,1090 # 800212a4 <log+0x34>
    80003e6a:	96b2                	add	a3,a3,a2
    hb->block[i] = log.lh.block[i];
    80003e6c:	4390                	lw	a2,0(a5)
    80003e6e:	c310                	sw	a2,0(a4)
  for (i = 0; i < log.lh.n; i++) {
    80003e70:	0791                	addi	a5,a5,4
    80003e72:	0711                	addi	a4,a4,4
    80003e74:	fed79ce3          	bne	a5,a3,80003e6c <write_head+0x50>
  }
  bwrite(buf);
    80003e78:	8526                	mv	a0,s1
    80003e7a:	fffff097          	auipc	ra,0xfffff
    80003e7e:	034080e7          	jalr	52(ra) # 80002eae <bwrite>
  brelse(buf);
    80003e82:	8526                	mv	a0,s1
    80003e84:	fffff097          	auipc	ra,0xfffff
    80003e88:	068080e7          	jalr	104(ra) # 80002eec <brelse>
}
...
0000000080003e98 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    80003e98:	0001d797          	auipc	a5,0x1d
    80003e9c:	4047a783          	lw	a5,1028(a5) # 8002129c <log+0x2c>
    80003ea0:	0af05d63          	blez	a5,80003f5a <install_trans+0xc2>
{
    ...
    80003eba:	0001da97          	auipc	s5,0x1d
    80003ebe:	3e6a8a93          	addi	s5,s5,998 # 800212a0 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003ec2:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003ec4:	0001d997          	auipc	s3,0x1d
    80003ec8:	3ac98993          	addi	s3,s3,940 # 80021270 <log>
    80003ecc:	a00d                	j	80003eee <install_trans+0x56>
    brelse(lbuf);
    80003ece:	854a                	mv	a0,s2
    80003ed0:	fffff097          	auipc	ra,0xfffff
    80003ed4:	01c080e7          	jalr	28(ra) # 80002eec <brelse>
    brelse(dbuf);
    80003ed8:	8526                	mv	a0,s1
    80003eda:	fffff097          	auipc	ra,0xfffff
    80003ede:	012080e7          	jalr	18(ra) # 80002eec <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003ee2:	2a05                	addiw	s4,s4,1
    80003ee4:	0a91                	addi	s5,s5,4
    80003ee6:	02c9a783          	lw	a5,44(s3)
    80003eea:	04fa5e63          	bge	s4,a5,80003f46 <install_trans+0xae>
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003eee:	0189a583          	lw	a1,24(s3)
    80003ef2:	014585bb          	addw	a1,a1,s4
    80003ef6:	2585                	addiw	a1,a1,1
    80003ef8:	0289a503          	lw	a0,40(s3)
    80003efc:	fffff097          	auipc	ra,0xfffff
    80003f00:	ec0080e7          	jalr	-320(ra) # 80002dbc <bread>
    ...
    80003f12:	eae080e7          	jalr	-338(ra) # 80002dbc <bread>
    80003f16:	84aa                	mv	s1,a0
    memmove(dbuf->data, lbuf->data, BSIZE);  // copy block to dst
    80003f18:	40000613          	li	a2,1024
    80003f1c:	05890593          	addi	a1,s2,88
    80003f20:	05850513          	addi	a0,a0,88
    80003f24:	ffffd097          	auipc	ra,0xffffd
    80003f28:	e04080e7          	jalr	-508(ra) # 80000d28 <memmove>
    bwrite(dbuf);  // write dst to disk
    80003f2c:	8526                	mv	a0,s1
    80003f2e:	fffff097          	auipc	ra,0xfffff
    80003f32:	f80080e7          	jalr	-128(ra) # 80002eae <bwrite>
    if(recovering == 0)
    80003f36:	f80b1ce3          	bnez	s6,80003ece <install_trans+0x36>
      bunpin(dbuf);
    80003f3a:	8526                	mv	a0,s1
    80003f3c:	fffff097          	auipc	ra,0xfffff
    80003f40:	08a080e7          	jalr	138(ra) # 80002fc6 <bunpin>
    80003f44:	b769                	j	80003ece <install_trans+0x36>
}
    ...
    80003f52:	6aa2                	ld	s5,8(sp)
    80003f54:	6b02                	ld	s6,0(sp)
    80003f56:	6121                	addi	sp,sp,64
    80003f58:	8082                	ret
    80003f5a:	8082                	ret

0000000080003f5c <initlog>:
{
  ...
  initlock(&log.lock, "log");
    80003f6e:	0001d497          	auipc	s1,0x1d
    80003f72:	30248493          	addi	s1,s1,770 # 80021270 <log>
    80003f76:	00004597          	auipc	a1,0x4
    80003f7a:	6aa58593          	addi	a1,a1,1706 # 80008620 <syscalls+0x1d8>
    80003f7e:	8526                	mv	a0,s1
    80003f80:	ffffd097          	auipc	ra,0xffffd
    80003f84:	bc0080e7          	jalr	-1088(ra) # 80000b40 <initlock>
  log.start = sb->logstart;
    80003f88:	0149a583          	lw	a1,20(s3)
    80003f8c:	cc8c                	sw	a1,24(s1)
  log.size = sb->nlog;
    80003f8e:	0109a783          	lw	a5,16(s3)
    80003f92:	ccdc                	sw	a5,28(s1)
  log.dev = dev;
    80003f94:	0324a423          	sw	s2,40(s1)
  struct buf *buf = bread(log.dev, log.start);
    80003f98:	854a                	mv	a0,s2
    80003f9a:	fffff097          	auipc	ra,0xfffff
    80003f9e:	e22080e7          	jalr	-478(ra) # 80002dbc <bread>
  log.lh.n = lh->n;
    80003fa2:	4d34                	lw	a3,88(a0)
    80003fa4:	d4d4                	sw	a3,44(s1)
  for (i = 0; i < log.lh.n; i++) {
    80003fa6:	02d05663          	blez	a3,80003fd2 <initlog+0x76>
    80003faa:	05c50793          	addi	a5,a0,92
    80003fae:	0001d717          	auipc	a4,0x1d
    80003fb2:	2f270713          	addi	a4,a4,754 # 800212a0 <log+0x30>
    80003fb6:	36fd                	addiw	a3,a3,-1
    80003fb8:	02069613          	slli	a2,a3,0x20
    80003fbc:	01e65693          	srli	a3,a2,0x1e
    80003fc0:	06050613          	addi	a2,a0,96
    80003fc4:	96b2                	add	a3,a3,a2
    log.lh.block[i] = lh->block[i];
    80003fc6:	4390                	lw	a2,0(a5)
    80003fc8:	c310                	sw	a2,0(a4)
  for (i = 0; i < log.lh.n; i++) {
    80003fca:	0791                	addi	a5,a5,4
    80003fcc:	0711                	addi	a4,a4,4
    80003fce:	fed79ce3          	bne	a5,a3,80003fc6 <initlog+0x6a>
  brelse(buf);
    80003fd2:	fffff097          	auipc	ra,0xfffff
    80003fd6:	f1a080e7          	jalr	-230(ra) # 80002eec <brelse>
...
recover_from_log(void)
{
  ...
  install_trans(1); // if committed, copy from log to disk
    ...
    80003fe0:	ebc080e7          	jalr	-324(ra) # 80003e98 <install_trans>
  log.lh.n = 0;
    80003fe4:	0001d797          	auipc	a5,0x1d
    80003fe8:	2a07ac23          	sw	zero,696(a5) # 8002129c <log+0x2c>
  write_head(); // clear the log
    80003fec:	00000097          	auipc	ra,0x0
    80003ff0:	e30080e7          	jalr	-464(ra) # 80003e1c <write_head>
}
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    8000400e:	0001d517          	auipc	a0,0x1d
    80004012:	26250513          	addi	a0,a0,610 # 80021270 <log>
    80004016:	ffffd097          	auipc	ra,0xffffd
    8000401a:	bba080e7          	jalr	-1094(ra) # 80000bd0 <acquire>
  while(1){
    if(log.committing){
    8000401e:	0001d497          	auipc	s1,0x1d
    80004022:	25248493          	addi	s1,s1,594 # 80021270 <log>
      sleep(&log, &log.lock);
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
    80004026:	4979                	li	s2,30
    80004028:	a039                	j	80004036 <begin_op+0x34>
      sleep(&log, &log.lock);
    8000402a:	85a6                	mv	a1,s1
    8000402c:	8526                	mv	a0,s1
    8000402e:	ffffe097          	auipc	ra,0xffffe
    80004032:	02c080e7          	jalr	44(ra) # 8000205a <sleep>
    if(log.committing){
    80004036:	50dc                	lw	a5,36(s1)
    80004038:	fbed                	bnez	a5,8000402a <begin_op+0x28>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
    8000403a:	5098                	lw	a4,32(s1)
    8000403c:	2705                	addiw	a4,a4,1
    8000403e:	0007069b          	sext.w	a3,a4
    80004042:	0027179b          	slliw	a5,a4,0x2
    80004046:	9fb9                	addw	a5,a5,a4
    80004048:	0017979b          	slliw	a5,a5,0x1
    8000404c:	54d8                	lw	a4,44(s1)
    8000404e:	9fb9                	addw	a5,a5,a4
    80004050:	00f95963          	bge	s2,a5,80004062 <begin_op+0x60>
      // this op might exhaust log space; wait for commit.
      sleep(&log, &log.lock);
    80004054:	85a6                	mv	a1,s1
    80004056:	8526                	mv	a0,s1
    80004058:	ffffe097          	auipc	ra,0xffffe
    8000405c:	002080e7          	jalr	2(ra) # 8000205a <sleep>
    80004060:	bfd9                	j	80004036 <begin_op+0x34>
    } else {
      log.outstanding += 1;
    80004062:	0001d517          	auipc	a0,0x1d
    80004066:	20e50513          	addi	a0,a0,526 # 80021270 <log>
    8000406a:	d114                	sw	a3,32(a0)
      release(&log.lock);
    8000406c:	ffffd097          	auipc	ra,0xffffd
    80004070:	c18080e7          	jalr	-1000(ra) # 80000c84 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  log.outstanding -= 1;
    ...
    800040a6:	37fd                	addiw	a5,a5,-1
    800040a8:	0007891b          	sext.w	s2,a5
    800040ac:	d09c                	sw	a5,32(s1)
  if(log.committing)
    800040ae:	50dc                	lw	a5,36(s1)
    800040b0:	e7b9                	bnez	a5,800040fe <end_op+0x7e>
    panic("log.committing");
  if(log.outstanding == 0){
    800040b2:	04091e63          	bnez	s2,8000410e <end_op+0x8e>
    do_commit = 1;
    log.committing = 1;
    800040b6:	0001d497          	auipc	s1,0x1d
    800040ba:	1ba48493          	addi	s1,s1,442 # 80021270 <log>
    800040be:	4785                	li	a5,1
    800040c0:	d0dc                	sw	a5,36(s1)
  ...
  release(&log.lock);
    ...
    800040c8:	bc0080e7          	jalr	-1088(ra) # 80000c84 <release>
}
...
{
  if (log.lh.n > 0) {
    800040cc:	54dc                	lw	a5,44(s1)
    800040ce:	06f04763          	bgtz	a5,8000413c <end_op+0xbc>
    acquire(&log.lock);
    ...
    wakeup(&log);
    8000410e:	0001d497          	auipc	s1,0x1d
    80004112:	16248493          	addi	s1,s1,354 # 80021270 <log>
    80004116:	8526                	mv	a0,s1
    80004118:	ffffe097          	auipc	ra,0xffffe
    8000411c:	0ce080e7          	jalr	206(ra) # 800021e6 <wakeup>
  release(&log.lock);
    80004120:	8526                	mv	a0,s1
    80004122:	ffffd097          	auipc	ra,0xffffd
    80004126:	b62080e7          	jalr	-1182(ra) # 80000c84 <release>
}
    ...
    8000413a:	8082                	ret
  for (tail = 0; tail < log.lh.n; tail++) {
    8000413c:	0001da97          	auipc	s5,0x1d
    80004140:	164a8a93          	addi	s5,s5,356 # 800212a0 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004144:	0001da17          	auipc	s4,0x1d
    80004148:	12ca0a13          	addi	s4,s4,300 # 80021270 <log>
    8000414c:	018a2583          	lw	a1,24(s4)
    80004150:	012585bb          	addw	a1,a1,s2
    80004154:	2585                	addiw	a1,a1,1
    80004156:	028a2503          	lw	a0,40(s4)
    8000415a:	fffff097          	auipc	ra,0xfffff
    8000415e:	c62080e7          	jalr	-926(ra) # 80002dbc <bread>
    80004162:	84aa                	mv	s1,a0
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
    80004164:	000aa583          	lw	a1,0(s5)
    80004168:	028a2503          	lw	a0,40(s4)
    8000416c:	fffff097          	auipc	ra,0xfffff
    80004170:	c50080e7          	jalr	-944(ra) # 80002dbc <bread>
    ...
    80004186:	ba6080e7          	jalr	-1114(ra) # 80000d28 <memmove>
    bwrite(to);  // write the log
    8000418a:	8526                	mv	a0,s1
    8000418c:	fffff097          	auipc	ra,0xfffff
    80004190:	d22080e7          	jalr	-734(ra) # 80002eae <bwrite>
    brelse(from);
    80004194:	854e                	mv	a0,s3
    80004196:	fffff097          	auipc	ra,0xfffff
    8000419a:	d56080e7          	jalr	-682(ra) # 80002eec <brelse>
    brelse(to);
    8000419e:	8526                	mv	a0,s1
    800041a0:	fffff097          	auipc	ra,0xfffff
    800041a4:	d4c080e7          	jalr	-692(ra) # 80002eec <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    800041a8:	2905                	addiw	s2,s2,1
    800041aa:	0a91                	addi	s5,s5,4
    800041ac:	02ca2783          	lw	a5,44(s4)
    800041b0:	f8f94ee3          	blt	s2,a5,8000414c <end_op+0xcc>
    write_log();     // Write modified blocks from cache to log
    write_head();    // Write header to disk -- the real commit
    800041b4:	00000097          	auipc	ra,0x0
    800041b8:	c68080e7          	jalr	-920(ra) # 80003e1c <write_head>
    install_trans(0); // Now install writes to home locations
    800041bc:	4501                	li	a0,0
    800041be:	00000097          	auipc	ra,0x0
    800041c2:	cda080e7          	jalr	-806(ra) # 80003e98 <install_trans>
    log.lh.n = 0;
    800041c6:	0001d797          	auipc	a5,0x1d
    800041ca:	0c07ab23          	sw	zero,214(a5) # 8002129c <log+0x2c>
    write_head();    // Erase the transaction from the log
    800041ce:	00000097          	auipc	ra,0x0
    800041d2:	c4e080e7          	jalr	-946(ra) # 80003e1c <write_head>
    800041d6:	bdf5                	j	800040d2 <end_op+0x52>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800041ea:	08a90913          	addi	s2,s2,138 # 80021270 <log>
    800041ee:	854a                	mv	a0,s2
    800041f0:	ffffd097          	auipc	ra,0xffffd
    800041f4:	9e0080e7          	jalr	-1568(ra) # 80000bd0 <acquire>
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    800041f8:	02c92603          	lw	a2,44(s2)
    800041fc:	47f5                	li	a5,29
    800041fe:	06c7c563          	blt	a5,a2,80004268 <log_write+0x90>
    80004202:	0001d797          	auipc	a5,0x1d
    80004206:	08a7a783          	lw	a5,138(a5) # 8002128c <log+0x1c>
    8000420a:	37fd                	addiw	a5,a5,-1
    8000420c:	04f65e63          	bge	a2,a5,80004268 <log_write+0x90>
    panic("too big a transaction");
  if (log.outstanding < 1)
    80004210:	0001d797          	auipc	a5,0x1d
    80004214:	0807a783          	lw	a5,128(a5) # 80021290 <log+0x20>
    80004218:	06f05063          	blez	a5,80004278 <log_write+0xa0>
    panic("log_write outside of trans");

  for (i = 0; i < log.lh.n; i++) {
    8000421c:	4781                	li	a5,0
    8000421e:	06c05563          	blez	a2,80004288 <log_write+0xb0>
    if (log.lh.block[i] == b->blockno)   // log absorption
    80004222:	44cc                	lw	a1,12(s1)
    80004224:	0001d717          	auipc	a4,0x1d
    80004228:	07c70713          	addi	a4,a4,124 # 800212a0 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
    8000422c:	4781                	li	a5,0
    if (log.lh.block[i] == b->blockno)   // log absorption
    8000422e:	4314                	lw	a3,0(a4)
    80004230:	04b68c63          	beq	a3,a1,80004288 <log_write+0xb0>
  for (i = 0; i < log.lh.n; i++) {
    80004234:	2785                	addiw	a5,a5,1
    80004236:	0711                	addi	a4,a4,4
    80004238:	fef61be3          	bne	a2,a5,8000422e <log_write+0x56>
      break;
  }
  log.lh.block[i] = b->blockno;
    8000423c:	0621                	addi	a2,a2,8
    8000423e:	060a                	slli	a2,a2,0x2
    80004240:	0001d797          	auipc	a5,0x1d
    80004244:	03078793          	addi	a5,a5,48 # 80021270 <log>
    80004248:	97b2                	add	a5,a5,a2
    8000424a:	44d8                	lw	a4,12(s1)
    8000424c:	cb98                	sw	a4,16(a5)
  if (i == log.lh.n) {  // Add new block to log?
    bpin(b);
    8000424e:	8526                	mv	a0,s1
    80004250:	fffff097          	auipc	ra,0xfffff
    80004254:	d3a080e7          	jalr	-710(ra) # 80002f8a <bpin>
    log.lh.n++;
    80004258:	0001d717          	auipc	a4,0x1d
    8000425c:	01870713          	addi	a4,a4,24 # 80021270 <log>
    80004260:	575c                	lw	a5,44(a4)
    80004262:	2785                	addiw	a5,a5,1
    80004264:	d75c                	sw	a5,44(a4)
    80004266:	a82d                	j	800042a0 <log_write+0xc8>
    panic("too big a transaction");
    80004268:	00004517          	auipc	a0,0x4
    8000426c:	3d050513          	addi	a0,a0,976 # 80008638 <syscalls+0x1f0>
    80004270:	ffffc097          	auipc	ra,0xffffc
    80004274:	2ca080e7          	jalr	714(ra) # 8000053a <panic>
    panic("log_write outside of trans");
    80004278:	00004517          	auipc	a0,0x4
    8000427c:	3d850513          	addi	a0,a0,984 # 80008650 <syscalls+0x208>
    80004280:	ffffc097          	auipc	ra,0xffffc
    80004284:	2ba080e7          	jalr	698(ra) # 8000053a <panic>
  log.lh.block[i] = b->blockno;
    80004288:	00878693          	addi	a3,a5,8
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800042da:	86a080e7          	jalr	-1942(ra) # 80000b40 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000430e:	8c6080e7          	jalr	-1850(ra) # 80000bd0 <acquire>
  while (lk->locked) {
    ...
    8000431e:	d40080e7          	jalr	-704(ra) # 8000205a <sleep>
  while (lk->locked) {
  ...
  lk->pid = myproc()->pid;
    ...
    8000432e:	66c080e7          	jalr	1644(ra) # 80001996 <myproc>
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80004364:	870080e7          	jalr	-1936(ra) # 80000bd0 <acquire>
  lk->locked = 0;
  ...
  wakeup(lk);
    ...
    80004376:	e74080e7          	jalr	-396(ra) # 800021e6 <wakeup>
  release(&lk->lk);
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800043aa:	82a080e7          	jalr	-2006(ra) # 80000bd0 <acquire>
  ...
  release(&lk->lk);
    ...
    800043ba:	8ce080e7          	jalr	-1842(ra) # 80000c84 <release>
  return r;
}
  ...
  r = lk->locked && (lk->pid == myproc()->pid);
    ...
    800043d6:	5c4080e7          	jalr	1476(ra) # 80001996 <myproc>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80004402:	742080e7          	jalr	1858(ra) # 80000b40 <initlock>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80004490:	744080e7          	jalr	1860(ra) # 80000bd0 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800044aa:	7de080e7          	jalr	2014(ra) # 80000c84 <release>
  return f;
}
    ...
    800044c6:	078080e7          	jalr	120(ra) # 8000053a <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800044ea:	6ea080e7          	jalr	1770(ra) # 80000bd0 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80004524:	764080e7          	jalr	1892(ra) # 80000c84 <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    8000453a:	acc080e7          	jalr	-1332(ra) # 80004002 <begin_op>
    iput(ff.ip);
    8000453e:	854e                	mv	a0,s3
    80004540:	fffff097          	auipc	ra,0xfffff
    80004544:	238080e7          	jalr	568(ra) # 80003778 <iput>
    end_op();
    80004548:	00000097          	auipc	ra,0x0
    8000454c:	b38080e7          	jalr	-1224(ra) # 80004080 <end_op>
...
filestat(struct file *f, uint64 addr)
{
  ...
  struct proc *p = myproc();
    ...
    800045a8:	3f2080e7          	jalr	1010(ra) # 80001996 <myproc>
  struct stat st;
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    800045ea:	074080e7          	jalr	116(ra) # 8000165a <copyout>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80004638:	f8a080e7          	jalr	-118(ra) # 800035be <ilock>
    ...
    8000464a:	22c080e7          	jalr	556(ra) # 80003872 <readi>
    ...
    80004660:	024080e7          	jalr	36(ra) # 80003680 <iunlock>
  } else {
    panic("fileread");
  }
  ...
  return r;
    ...
    8000467a:	3c0080e7          	jalr	960(ra) # 80004a36 <piperead>
    ...
    800046b6:	e88080e7          	jalr	-376(ra) # 8000053a <panic>
    return -1;
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80004706:	6b85                	lui	s7,0x1
    80004708:	c00b8b93          	addi	s7,s7,-1024 # c00 <_entry-0x7ffff400>
    8000470c:	6c05                	lui	s8,0x1
    8000470e:	c00c0c1b          	addiw	s8,s8,-1024
    ...
    8000474a:	00048a9b          	sext.w	s5,s1
      int n1 = n - i;
      if(n1 > max)
        n1 = max;
    ...
    80004752:	8b4080e7          	jalr	-1868(ra) # 80004002 <begin_op>
      ilock(f->ip);
    80004756:	01893503          	ld	a0,24(s2)
    8000475a:	fffff097          	auipc	ra,0xfffff
    8000475e:	e64080e7          	jalr	-412(ra) # 800035be <ilock>
      if ((r = writei(f->ip, 1, addr + i, f->off, n1)) > 0)
    80004762:	8756                	mv	a4,s5
    80004764:	02092683          	lw	a3,32(s2)
    80004768:	01698633          	add	a2,s3,s6
    8000476c:	4585                	li	a1,1
    8000476e:	01893503          	ld	a0,24(s2)
    80004772:	fffff097          	auipc	ra,0xfffff
    80004776:	22e080e7          	jalr	558(ra) # 800039a0 <writei>
    ...
    80004792:	ef2080e7          	jalr	-270(ra) # 80003680 <iunlock>
      end_op();
    80004796:	00000097          	auipc	ra,0x0
    8000479a:	8ea080e7          	jalr	-1814(ra) # 80004080 <end_op>

      if(r != n1){
    8000479e:	009a9f63          	bne	s5,s1,800047bc <filewrite+0xf6>
        // error from writei
        break;
      }
      i += r;
    ...
    800047a6:	0149db63          	bge	s3,s4,800047bc <filewrite+0xf6>
      int n1 = n - i;
    800047aa:	413a04bb          	subw	s1,s4,s3
    800047ae:	0004879b          	sext.w	a5,s1
    800047b2:	f8fbdce3          	bge	s7,a5,8000474a <filewrite+0x84>
    800047b6:	84e2                	mv	s1,s8
  ...
  return ret;
    ...
    800047ea:	d54080e7          	jalr	-684(ra) # 8000053a <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  if((pi = (struct pipe*)kalloc()) == 0)
    ...
    80004834:	2b0080e7          	jalr	688(ra) # 80000ae0 <kalloc>
  ...
  initlock(&pi->lock, "pipe");
    ...
    8000485a:	2ea080e7          	jalr	746(ra) # 80000b40 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    800048e8:	2ec080e7          	jalr	748(ra) # 80000bd0 <acquire>
  if(writable){
    ...
    800048fc:	8ee080e7          	jalr	-1810(ra) # 800021e6 <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    8000490c:	37c080e7          	jalr	892(ra) # 80000c84 <release>
    kfree((char*)pi);
    80004910:	8526                	mv	a0,s1
    80004912:	ffffc097          	auipc	ra,0xffffc
    80004916:	0d0080e7          	jalr	208(ra) # 800009e2 <kfree>
  } else
    release(&pi->lock);
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80004966:	034080e7          	jalr	52(ra) # 80001996 <myproc>
    8000496a:	89aa                	mv	s3,a0

  acquire(&pi->lock);
    8000496c:	8526                	mv	a0,s1
    8000496e:	ffffc097          	auipc	ra,0xffffc
    80004972:	262080e7          	jalr	610(ra) # 80000bd0 <acquire>
  while(i < n){
    80004976:	0b405363          	blez	s4,80004a1c <pipewrite+0xd8>
  int i = 0;
  ...
  return i;
    ...
    800049b4:	836080e7          	jalr	-1994(ra) # 800021e6 <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    800049b8:	85a6                	mv	a1,s1
    800049ba:	855e                	mv	a0,s7
    800049bc:	ffffd097          	auipc	ra,0xffffd
    800049c0:	69e080e7          	jalr	1694(ra) # 8000205a <sleep>
  while(i < n){
    800049c4:	05495d63          	bge	s2,s4,80004a1e <pipewrite+0xda>
    if(pi->readopen == 0 || pr->killed){
    800049c8:	2204a783          	lw	a5,544(s1)
    800049cc:	dfd5                	beqz	a5,80004988 <pipewrite+0x44>
    800049ce:	0289a783          	lw	a5,40(s3)
    800049d2:	fbdd                	bnez	a5,80004988 <pipewrite+0x44>
    if(pi->nwrite == pi->nread + PIPESIZE){ //DOC: pipewrite-full
    800049d4:	2184a783          	lw	a5,536(s1)
    800049d8:	21c4a703          	lw	a4,540(s1)
    800049dc:	2007879b          	addiw	a5,a5,512
    800049e0:	fcf707e3          	beq	a4,a5,800049ae <pipewrite+0x6a>
      if(copyin(pr->pagetable, &ch, addr + i, 1) == -1)
    ...
    800049f6:	cf4080e7          	jalr	-780(ra) # 800016e6 <copyin>
    800049fa:	03650263          	beq	a0,s6,80004a1e <pipewrite+0xda>
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80004a54:	f46080e7          	jalr	-186(ra) # 80001996 <myproc>
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80004a70:	02f71463          	bne	a4,a5,80004a98 <piperead+0x62>
    80004a74:	2244a783          	lw	a5,548(s1)
    80004a78:	c385                	beqz	a5,80004a98 <piperead+0x62>
    if(pr->killed){
    80004a7a:	028a2783          	lw	a5,40(s4)
    80004a7e:	ebc9                	bnez	a5,80004b10 <piperead+0xda>
    sleep(&pi->nread, &pi->lock); //DOC: piperead-sleep
    80004a80:	85a6                	mv	a1,s1
    80004a82:	854e                	mv	a0,s3
    80004a84:	ffffd097          	auipc	ra,0xffffd
    80004a88:	5d6080e7          	jalr	1494(ra) # 8000205a <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    80004a8c:	2184a703          	lw	a4,536(s1)
    80004a90:	21c4a783          	lw	a5,540(s1)
    80004a94:	fef700e3          	beq	a4,a5,80004a74 <piperead+0x3e>
  }
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80004a9c:	05505463          	blez	s5,80004ae4 <piperead+0xae>
    if(pi->nread == pi->nwrite)
    80004aa0:	2184a783          	lw	a5,536(s1)
    80004aa4:	21c4a703          	lw	a4,540(s1)
    80004aa8:	02f70e63          	beq	a4,a5,80004ae4 <piperead+0xae>
    ch = pi->data[pi->nread++ % PIPESIZE];
    80004aac:	0017871b          	addiw	a4,a5,1
    80004ab0:	20e4ac23          	sw	a4,536(s1)
    80004ab4:	1ff7f793          	andi	a5,a5,511
    80004ab8:	97a6                	add	a5,a5,s1
    80004aba:	0187c783          	lbu	a5,24(a5)
    80004abe:	faf40fa3          	sb	a5,-65(s0)
    if(copyout(pr->pagetable, addr + i, &ch, 1) == -1)
    80004ac2:	4685                	li	a3,1
    80004ac4:	fbf40613          	addi	a2,s0,-65
    80004ac8:	85ca                	mv	a1,s2
    80004aca:	050a3503          	ld	a0,80(s4)
    80004ace:	ffffd097          	auipc	ra,0xffffd
    80004ad2:	b8c080e7          	jalr	-1140(ra) # 8000165a <copyout>
    80004ad6:	01650763          	beq	a0,s6,80004ae4 <piperead+0xae>
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80004ada:	2985                	addiw	s3,s3,1
    80004adc:	0905                	addi	s2,s2,1
    80004ade:	fd3a91e3          	bne	s5,s3,80004aa0 <piperead+0x6a>
    80004ae2:	89d6                	mv	s3,s5
      break;
  }
  ...
  return i;
    ...
    80004b16:	172080e7          	jalr	370(ra) # 80000c84 <release>
      return -1;
    80004b1a:	59fd                	li	s3,-1
    80004b1c:	bff9                	j	80004afa <piperead+0xc4>
...
exec(char *path, char **argv)
{
  ...
  struct proc *p = myproc();
    ...
    80004b54:	e46080e7          	jalr	-442(ra) # 80001996 <myproc>
    80004b58:	84aa                	mv	s1,a0

  begin_op();
    80004b5a:	fffff097          	auipc	ra,0xfffff
    80004b5e:	4a8080e7          	jalr	1192(ra) # 80004002 <begin_op>

  if((ip = namei(path)) == 0){
    80004b62:	854a                	mv	a0,s2
    80004b64:	fffff097          	auipc	ra,0xfffff
    80004b68:	27e080e7          	jalr	638(ra) # 80003de2 <namei>
 ...
 bad:
  ...
  if(ip){
    ...
    80004bac:	c78080e7          	jalr	-904(ra) # 80003820 <iunlockput>
    end_op();
    80004bb0:	fffff097          	auipc	ra,0xfffff
    80004bb4:	4d0080e7          	jalr	1232(ra) # 80004080 <end_op>
  }
  return -1;
    ...
    80004be6:	49e080e7          	jalr	1182(ra) # 80004080 <end_op>
    return -1;
  ...
  if((pagetable = proc_pagetable(p)) == 0)
    ...
    80004bf4:	e6a080e7          	jalr	-406(ra) # 80001a5a <proc_pagetable>
    80004bf8:	8b2a                	mv	s6,a0
    80004bfa:	d555                	beqz	a0,80004ba6 <exec+0x88>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80004bfc:	e7042783          	lw	a5,-400(s0)
    80004c00:	e8845703          	lhu	a4,-376(s0)
...
loadseg(pagetable_t pagetable, uint64 va, struct inode *ip, uint offset, uint sz)
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004c20:	aac50513          	addi	a0,a0,-1364 # 800086c8 <syscalls+0x280>
    80004c24:	ffffc097          	auipc	ra,0xffffc
    80004c28:	916080e7          	jalr	-1770(ra) # 8000053a <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
    ...
    80004c3a:	c3c080e7          	jalr	-964(ra) # 80003872 <readi>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004c5e:	3f8080e7          	jalr	1016(ra) # 80001052 <walkaddr>
  ...
  iunlockput(ip);
    ...
    80004c78:	bac080e7          	jalr	-1108(ra) # 80003820 <iunlockput>
  end_op();
    80004c7c:	fffff097          	auipc	ra,0xfffff
    80004c80:	404080e7          	jalr	1028(ra) # 80004080 <end_op>
  p = myproc();
    80004c84:	ffffd097          	auipc	ra,0xffffd
    80004c88:	d12080e7          	jalr	-750(ra) # 80001996 <myproc>
  ...
  sz = PGROUNDUP(sz);
    ...
    80004c98:	777d                	lui	a4,0xfffff
    80004c9a:	8ff9                	and	a5,a5,a4
  ...
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    ...
    80004cac:	75e080e7          	jalr	1886(ra) # 80001406 <uvmalloc>
  ...
  uvmclear(pagetable, sz-2*PGSIZE);
    ...
    80004cc2:	96a080e7          	jalr	-1686(ra) # 80001628 <uvmclear>
  stackbase = sp - PGSIZE;
  ...
  for(argc = 0; argv[argc]; argc++) {
    ...
    80004cd2:	e9040993          	addi	s3,s0,-368
    80004cd6:	f9040c93          	addi	s9,s0,-112
  sp = sz;
  ...
  for(argc = 0; argv[argc]; argc++) {
    ...
    80004ce2:	16a080e7          	jalr	362(ra) # 80000e48 <strlen>
    80004ce6:	0015079b          	addiw	a5,a0,1
    80004cea:	40f907b3          	sub	a5,s2,a5
    sp -= sp % 16; // riscv sp must be 16-byte aligned
    80004cee:	ff07f913          	andi	s2,a5,-16
    if(sp < stackbase)
    ...
    80004d16:	948080e7          	jalr	-1720(ra) # 8000165a <copyout>
  ...
  ustack[argc] = 0;
    ...
    80004d48:	f9078793          	addi	a5,a5,-112 # f90 <_entry-0x7ffff070>
    80004d4c:	97a2                	add	a5,a5,s0
    80004d4e:	f007b023          	sd	zero,-256(a5)
  ...
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    ...
    80004d78:	8e6080e7          	jalr	-1818(ra) # 8000165a <copyout>
    80004d7c:	0a054663          	bltz	a0,80004e28 <exec+0x30a>
  p->trapframe->a1 = sp;
    80004d80:	058bb783          	ld	a5,88(s7)
  ...
  safestrcpy(p->name, last, sizeof(p->name));
    ...
    80004dba:	060080e7          	jalr	96(ra) # 80000e16 <safestrcpy>
  ...
  proc_freepagetable(oldpagetable, oldsz);
    ...
    80004de2:	d18080e7          	jalr	-744(ra) # 80001af6 <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    ...
    80004dfa:	d00080e7          	jalr	-768(ra) # 80001af6 <proc_freepagetable>
  if(ip){
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    ...
    80004e48:	e8845703          	lhu	a4,-376(s0)
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  if(argint(n, &fd) < 0)
    ...
    80004ede:	b72080e7          	jalr	-1166(ra) # 80002a4c <argint>
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    80004ef4:	aa6080e7          	jalr	-1370(ra) # 80001996 <myproc>
    80004ef8:	fdc42703          	lw	a4,-36(s0)
    80004efc:	01a70793          	addi	a5,a4,26 # fffffffffffff01a <end+0xffffffff7ffd901a>
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    80004f3e:	a5c080e7          	jalr	-1444(ra) # 80001996 <myproc>
...
create(char *path, short type, short major, short minor)
{
  ...
  if((dp = nameiparent(path, name)) == 0)
    ...
    80004f90:	e74080e7          	jalr	-396(ra) # 80003e00 <nameiparent>
    80004f94:	892a                	mv	s2,a0
    80004f96:	14050d63          	beqz	a0,800050f0 <create+0x180>
    return 0;

  ilock(dp);
    80004f9a:	ffffe097          	auipc	ra,0xffffe
    80004f9e:	624080e7          	jalr	1572(ra) # 800035be <ilock>
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80004fae:	b60080e7          	jalr	-1184(ra) # 80003b0a <dirlookup>
    80004fb2:	84aa                	mv	s1,a0
    80004fb4:	c535                	beqz	a0,80005020 <create+0xb0>
    iunlockput(dp);
    80004fb6:	854a                	mv	a0,s2
    80004fb8:	fffff097          	auipc	ra,0xfffff
    80004fbc:	868080e7          	jalr	-1944(ra) # 80003820 <iunlockput>
    ilock(ip);
    80004fc0:	8526                	mv	a0,s1
    80004fc2:	ffffe097          	auipc	ra,0xffffe
    80004fc6:	5fc080e7          	jalr	1532(ra) # 800035be <ilock>
    if(type == T_FILE && (ip->type == T_FILE || ip->type == T_DEVICE)) //MODIFICAR
    80004fca:	000a879b          	sext.w	a5,s5
    80004fce:	4709                	li	a4,2
    80004fd0:	02e78963          	beq	a5,a4,80005002 <create+0x92>
      return ip;

    if(type == T_SMALLFILE && (ip->type == T_SMALLFILE || ip->type == T_DEVICE)) //smallfile
    80004fd4:	000a859b          	sext.w	a1,s5
    80004fd8:	4791                	li	a5,4
    80004fda:	02f59c63          	bne	a1,a5,80005012 <create+0xa2>
    80004fde:	0444d783          	lhu	a5,68(s1)
    80004fe2:	37f5                	addiw	a5,a5,-3
    80004fe4:	17c2                	slli	a5,a5,0x30
    80004fe6:	93c1                	srli	a5,a5,0x30
    80004fe8:	4705                	li	a4,1
    80004fea:	02f76463          	bltu	a4,a5,80005012 <create+0xa2>
  ...
  return ip;
    ...
    80005000:	8082                	ret
    if(type == T_FILE && (ip->type == T_FILE || ip->type == T_DEVICE)) //MODIFICAR
    80005002:	0444d783          	lhu	a5,68(s1)
    80005006:	37f9                	addiw	a5,a5,-2
    80005008:	17c2                	slli	a5,a5,0x30
    8000500a:	93c1                	srli	a5,a5,0x30
    8000500c:	4705                	li	a4,1
    8000500e:	fef770e3          	bgeu	a4,a5,80004fee <create+0x7e>
    iunlockput(ip);
    80005012:	8526                	mv	a0,s1
    80005014:	fffff097          	auipc	ra,0xfffff
    80005018:	80c080e7          	jalr	-2036(ra) # 80003820 <iunlockput>
    return 0;
    8000501c:	4481                	li	s1,0
    8000501e:	bfc1                	j	80004fee <create+0x7e>
  if((ip = ialloc(dp->dev, type)) == 0)
    80005020:	85d6                	mv	a1,s5
    80005022:	00092503          	lw	a0,0(s2)
    80005026:	ffffe097          	auipc	ra,0xffffe
    8000502a:	3fe080e7          	jalr	1022(ra) # 80003424 <ialloc>
    8000502e:	84aa                	mv	s1,a0
    80005030:	c529                	beqz	a0,8000507a <create+0x10a>
  ilock(ip);
    80005032:	ffffe097          	auipc	ra,0xffffe
    80005036:	58c080e7          	jalr	1420(ra) # 800035be <ilock>
  ip->major = major;
    8000503a:	05449323          	sh	s4,70(s1)
  ip->minor = minor;
    8000503e:	05349423          	sh	s3,72(s1)
  ip->nlink = 1;
    80005042:	4985                	li	s3,1
    80005044:	05349523          	sh	s3,74(s1)
  iupdate(ip);
    80005048:	8526                	mv	a0,s1
    8000504a:	ffffe097          	auipc	ra,0xffffe
    8000504e:	4a8080e7          	jalr	1192(ra) # 800034f2 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
    80005052:	000a859b          	sext.w	a1,s5
    80005056:	03358a63          	beq	a1,s3,8000508a <create+0x11a>
  if(dirlink(dp, name, ip->inum) < 0)
    8000505a:	40d0                	lw	a2,4(s1)
    8000505c:	fb040593          	addi	a1,s0,-80
    80005060:	854a                	mv	a0,s2
    80005062:	fffff097          	auipc	ra,0xfffff
    80005066:	cbe080e7          	jalr	-834(ra) # 80003d20 <dirlink>
    8000506a:	06054b63          	bltz	a0,800050e0 <create+0x170>
  iunlockput(dp);
    8000506e:	854a                	mv	a0,s2
    80005070:	ffffe097          	auipc	ra,0xffffe
    80005074:	7b0080e7          	jalr	1968(ra) # 80003820 <iunlockput>
  return ip;
    80005078:	bf9d                	j	80004fee <create+0x7e>
    panic("create: ialloc");
    8000507a:	00003517          	auipc	a0,0x3
    8000507e:	66e50513          	addi	a0,a0,1646 # 800086e8 <syscalls+0x2a0>
    80005082:	ffffb097          	auipc	ra,0xffffb
    80005086:	4b8080e7          	jalr	1208(ra) # 8000053a <panic>
    dp->nlink++;  // for ".."
    ...
    8000509a:	45c080e7          	jalr	1116(ra) # 800034f2 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
    8000509e:	40d0                	lw	a2,4(s1)
    800050a0:	00003597          	auipc	a1,0x3
    800050a4:	65858593          	addi	a1,a1,1624 # 800086f8 <syscalls+0x2b0>
    800050a8:	8526                	mv	a0,s1
    800050aa:	fffff097          	auipc	ra,0xfffff
    800050ae:	c76080e7          	jalr	-906(ra) # 80003d20 <dirlink>
    800050b2:	00054f63          	bltz	a0,800050d0 <create+0x160>
    800050b6:	00492603          	lw	a2,4(s2)
    800050ba:	00003597          	auipc	a1,0x3
    800050be:	64658593          	addi	a1,a1,1606 # 80008700 <syscalls+0x2b8>
    800050c2:	8526                	mv	a0,s1
    800050c4:	fffff097          	auipc	ra,0xfffff
    800050c8:	c5c080e7          	jalr	-932(ra) # 80003d20 <dirlink>
    800050cc:	f80557e3          	bgez	a0,8000505a <create+0xea>
      panic("create dots");
    800050d0:	00003517          	auipc	a0,0x3
    800050d4:	63850513          	addi	a0,a0,1592 # 80008708 <syscalls+0x2c0>
    800050d8:	ffffb097          	auipc	ra,0xffffb
    800050dc:	462080e7          	jalr	1122(ra) # 8000053a <panic>
    panic("create: dirlink");
    800050e0:	00003517          	auipc	a0,0x3
    800050e4:	63850513          	addi	a0,a0,1592 # 80008718 <syscalls+0x2d0>
    800050e8:	ffffb097          	auipc	ra,0xffffb
    800050ec:	452080e7          	jalr	1106(ra) # 8000053a <panic>
    return 0;
    800050f0:	84aa                	mv	s1,a0
    800050f2:	bdf5                	j	80004fee <create+0x7e>
...
00000000800050f4 <sys_dup>:
{
  ...
  if(argfd(0, 0, &f) < 0)
    ...
    8000510c:	dbe080e7          	jalr	-578(ra) # 80004ec6 <argfd>
    return -1;
    80005110:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0)
    80005112:	02054363          	bltz	a0,80005138 <sys_dup+0x44>
  if((fd=fdalloc(f)) < 0)
    80005116:	fd843903          	ld	s2,-40(s0)
    8000511a:	854a                	mv	a0,s2
    8000511c:	00000097          	auipc	ra,0x0
    80005120:	e12080e7          	jalr	-494(ra) # 80004f2e <fdalloc>
    80005124:	84aa                	mv	s1,a0
    return -1;
    80005126:	57fd                	li	a5,-1
  if((fd=fdalloc(f)) < 0)
    80005128:	00054863          	bltz	a0,80005138 <sys_dup+0x44>
  filedup(f);
    8000512c:	854a                	mv	a0,s2
    8000512e:	fffff097          	auipc	ra,0xfffff
    80005132:	34a080e7          	jalr	842(ra) # 80004478 <filedup>
  return fd;
...
0000000080005146 <sys_read>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    8000514e:	fe840613          	addi	a2,s0,-24
    80005152:	4581                	li	a1,0
    80005154:	4501                	li	a0,0
    80005156:	00000097          	auipc	ra,0x0
    8000515a:	d70080e7          	jalr	-656(ra) # 80004ec6 <argfd>
    return -1;
    8000515e:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005160:	04054163          	bltz	a0,800051a2 <sys_read+0x5c>
    80005164:	fe440593          	addi	a1,s0,-28
    80005168:	4509                	li	a0,2
    8000516a:	ffffe097          	auipc	ra,0xffffe
    8000516e:	8e2080e7          	jalr	-1822(ra) # 80002a4c <argint>
    return -1;
    80005172:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005174:	02054763          	bltz	a0,800051a2 <sys_read+0x5c>
    80005178:	fd840593          	addi	a1,s0,-40
    8000517c:	4505                	li	a0,1
    8000517e:	ffffe097          	auipc	ra,0xffffe
    80005182:	8f0080e7          	jalr	-1808(ra) # 80002a6e <argaddr>
    return -1;
    80005186:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    80005188:	00054d63          	bltz	a0,800051a2 <sys_read+0x5c>
  return fileread(f, p, n);
    8000518c:	fe442603          	lw	a2,-28(s0)
    80005190:	fd843583          	ld	a1,-40(s0)
    80005194:	fe843503          	ld	a0,-24(s0)
    80005198:	fffff097          	auipc	ra,0xfffff
    8000519c:	46c080e7          	jalr	1132(ra) # 80004604 <fileread>
    800051a0:	87aa                	mv	a5,a0
}
    800051a2:	853e                	mv	a0,a5
    800051a4:	70a2                	ld	ra,40(sp)
    800051a6:	7402                	ld	s0,32(sp)
    800051a8:	6145                	addi	sp,sp,48
    800051aa:	8082                	ret

00000000800051ac <sys_write>:
{
    800051ac:	7179                	addi	sp,sp,-48
    800051ae:	f406                	sd	ra,40(sp)
    800051b0:	f022                	sd	s0,32(sp)
    800051b2:	1800                	addi	s0,sp,48
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800051b4:	fe840613          	addi	a2,s0,-24
    800051b8:	4581                	li	a1,0
    800051ba:	4501                	li	a0,0
    800051bc:	00000097          	auipc	ra,0x0
    800051c0:	d0a080e7          	jalr	-758(ra) # 80004ec6 <argfd>
    return -1;
    800051c4:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800051c6:	04054163          	bltz	a0,80005208 <sys_write+0x5c>
    800051ca:	fe440593          	addi	a1,s0,-28
    800051ce:	4509                	li	a0,2
    800051d0:	ffffe097          	auipc	ra,0xffffe
    800051d4:	87c080e7          	jalr	-1924(ra) # 80002a4c <argint>
    return -1;
    800051d8:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800051da:	02054763          	bltz	a0,80005208 <sys_write+0x5c>
    800051de:	fd840593          	addi	a1,s0,-40
    800051e2:	4505                	li	a0,1
    800051e4:	ffffe097          	auipc	ra,0xffffe
    800051e8:	88a080e7          	jalr	-1910(ra) # 80002a6e <argaddr>
    return -1;
    800051ec:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    800051ee:	00054d63          	bltz	a0,80005208 <sys_write+0x5c>
  return filewrite(f, p, n);
    ...
    80005202:	4c8080e7          	jalr	1224(ra) # 800046c6 <filewrite>
...
0000000080005212 <sys_close>:
{
  ...
  if(argfd(0, &fd, &f) < 0)
    8000521a:	fe040613          	addi	a2,s0,-32
    8000521e:	fec40593          	addi	a1,s0,-20
    80005222:	4501                	li	a0,0
    80005224:	00000097          	auipc	ra,0x0
    80005228:	ca2080e7          	jalr	-862(ra) # 80004ec6 <argfd>
    return -1;
    8000522c:	57fd                	li	a5,-1
  if(argfd(0, &fd, &f) < 0)
    8000522e:	02054463          	bltz	a0,80005256 <sys_close+0x44>
  myproc()->ofile[fd] = 0;
    80005232:	ffffc097          	auipc	ra,0xffffc
    80005236:	764080e7          	jalr	1892(ra) # 80001996 <myproc>
    8000523a:	fec42783          	lw	a5,-20(s0)
    8000523e:	07e9                	addi	a5,a5,26
    80005240:	078e                	slli	a5,a5,0x3
    80005242:	953e                	add	a0,a0,a5
    80005244:	00053023          	sd	zero,0(a0)
  fileclose(f);
    80005248:	fe043503          	ld	a0,-32(s0)
    8000524c:	fffff097          	auipc	ra,0xfffff
    80005250:	27e080e7          	jalr	638(ra) # 800044ca <fileclose>
  return 0;
...
0000000080005260 <sys_fstat>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    80005274:	c56080e7          	jalr	-938(ra) # 80004ec6 <argfd>
    return -1;
    80005278:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    8000527a:	02054563          	bltz	a0,800052a4 <sys_fstat+0x44>
    8000527e:	fe040593          	addi	a1,s0,-32
    80005282:	4505                	li	a0,1
    80005284:	ffffd097          	auipc	ra,0xffffd
    80005288:	7ea080e7          	jalr	2026(ra) # 80002a6e <argaddr>
    return -1;
    8000528c:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    8000528e:	00054b63          	bltz	a0,800052a4 <sys_fstat+0x44>
  return filestat(f, st);
    80005292:	fe043583          	ld	a1,-32(s0)
    80005296:	fe843503          	ld	a0,-24(s0)
    8000529a:	fffff097          	auipc	ra,0xfffff
    8000529e:	2f8080e7          	jalr	760(ra) # 80004592 <filestat>
...
00000000800052ae <sys_link>:
{
    ...
    800052b4:	ee26                	sd	s1,280(sp)
    800052b6:	ea4a                	sd	s2,272(sp)
    800052b8:	1a00                	addi	s0,sp,304
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    800052ba:	08000613          	li	a2,128
    800052be:	ed040593          	addi	a1,s0,-304
    800052c2:	4501                	li	a0,0
    800052c4:	ffffd097          	auipc	ra,0xffffd
    800052c8:	7cc080e7          	jalr	1996(ra) # 80002a90 <argstr>
    return -1;
    800052cc:	57fd                	li	a5,-1
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    800052ce:	10054e63          	bltz	a0,800053ea <sys_link+0x13c>
    800052d2:	08000613          	li	a2,128
    800052d6:	f5040593          	addi	a1,s0,-176
    800052da:	4505                	li	a0,1
    800052dc:	ffffd097          	auipc	ra,0xffffd
    800052e0:	7b4080e7          	jalr	1972(ra) # 80002a90 <argstr>
    return -1;
    800052e4:	57fd                	li	a5,-1
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    800052e6:	10054263          	bltz	a0,800053ea <sys_link+0x13c>
  begin_op();
    800052ea:	fffff097          	auipc	ra,0xfffff
    800052ee:	d18080e7          	jalr	-744(ra) # 80004002 <begin_op>
  if((ip = namei(old)) == 0){
    800052f2:	ed040513          	addi	a0,s0,-304
    800052f6:	fffff097          	auipc	ra,0xfffff
    800052fa:	aec080e7          	jalr	-1300(ra) # 80003de2 <namei>
    800052fe:	84aa                	mv	s1,a0
    80005300:	c551                	beqz	a0,8000538c <sys_link+0xde>
  ilock(ip);
    80005302:	ffffe097          	auipc	ra,0xffffe
    80005306:	2bc080e7          	jalr	700(ra) # 800035be <ilock>
  if(ip->type == T_DIR){
    8000530a:	04449703          	lh	a4,68(s1)
    8000530e:	4785                	li	a5,1
    80005310:	08f70463          	beq	a4,a5,80005398 <sys_link+0xea>
  ip->nlink++;
    80005314:	04a4d783          	lhu	a5,74(s1)
    80005318:	2785                	addiw	a5,a5,1
    8000531a:	04f49523          	sh	a5,74(s1)
  iupdate(ip);
    8000531e:	8526                	mv	a0,s1
    80005320:	ffffe097          	auipc	ra,0xffffe
    80005324:	1d2080e7          	jalr	466(ra) # 800034f2 <iupdate>
  iunlock(ip);
    80005328:	8526                	mv	a0,s1
    8000532a:	ffffe097          	auipc	ra,0xffffe
    8000532e:	356080e7          	jalr	854(ra) # 80003680 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
    80005332:	fd040593          	addi	a1,s0,-48
    80005336:	f5040513          	addi	a0,s0,-176
    8000533a:	fffff097          	auipc	ra,0xfffff
    8000533e:	ac6080e7          	jalr	-1338(ra) # 80003e00 <nameiparent>
    80005342:	892a                	mv	s2,a0
    80005344:	c935                	beqz	a0,800053b8 <sys_link+0x10a>
  ilock(dp);
    80005346:	ffffe097          	auipc	ra,0xffffe
    8000534a:	278080e7          	jalr	632(ra) # 800035be <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
    8000534e:	00092703          	lw	a4,0(s2)
    80005352:	409c                	lw	a5,0(s1)
    80005354:	04f71d63          	bne	a4,a5,800053ae <sys_link+0x100>
    80005358:	40d0                	lw	a2,4(s1)
    8000535a:	fd040593          	addi	a1,s0,-48
    8000535e:	854a                	mv	a0,s2
    80005360:	fffff097          	auipc	ra,0xfffff
    80005364:	9c0080e7          	jalr	-1600(ra) # 80003d20 <dirlink>
    80005368:	04054363          	bltz	a0,800053ae <sys_link+0x100>
  iunlockput(dp);
    8000536c:	854a                	mv	a0,s2
    8000536e:	ffffe097          	auipc	ra,0xffffe
    80005372:	4b2080e7          	jalr	1202(ra) # 80003820 <iunlockput>
  iput(ip);
    80005376:	8526                	mv	a0,s1
    80005378:	ffffe097          	auipc	ra,0xffffe
    8000537c:	400080e7          	jalr	1024(ra) # 80003778 <iput>
  end_op();
    80005380:	fffff097          	auipc	ra,0xfffff
    80005384:	d00080e7          	jalr	-768(ra) # 80004080 <end_op>
  return 0;
    80005388:	4781                	li	a5,0
    8000538a:	a085                	j	800053ea <sys_link+0x13c>
    end_op();
    8000538c:	fffff097          	auipc	ra,0xfffff
    80005390:	cf4080e7          	jalr	-780(ra) # 80004080 <end_op>
    return -1;
    80005394:	57fd                	li	a5,-1
    80005396:	a891                	j	800053ea <sys_link+0x13c>
    iunlockput(ip);
    80005398:	8526                	mv	a0,s1
    8000539a:	ffffe097          	auipc	ra,0xffffe
    8000539e:	486080e7          	jalr	1158(ra) # 80003820 <iunlockput>
    end_op();
    800053a2:	fffff097          	auipc	ra,0xfffff
    800053a6:	cde080e7          	jalr	-802(ra) # 80004080 <end_op>
    return -1;
    800053aa:	57fd                	li	a5,-1
    800053ac:	a83d                	j	800053ea <sys_link+0x13c>
    iunlockput(dp);
    800053ae:	854a                	mv	a0,s2
    800053b0:	ffffe097          	auipc	ra,0xffffe
    800053b4:	470080e7          	jalr	1136(ra) # 80003820 <iunlockput>
  ilock(ip);
    800053b8:	8526                	mv	a0,s1
    800053ba:	ffffe097          	auipc	ra,0xffffe
    800053be:	204080e7          	jalr	516(ra) # 800035be <ilock>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    800053d2:	124080e7          	jalr	292(ra) # 800034f2 <iupdate>
  iunlockput(ip);
    800053d6:	8526                	mv	a0,s1
    800053d8:	ffffe097          	auipc	ra,0xffffe
    800053dc:	448080e7          	jalr	1096(ra) # 80003820 <iunlockput>
  end_op();
    800053e0:	fffff097          	auipc	ra,0xfffff
    800053e4:	ca0080e7          	jalr	-864(ra) # 80004080 <end_op>
  return -1;
    800053e8:	57fd                	li	a5,-1
}
    800053ea:	853e                	mv	a0,a5
    800053ec:	70b2                	ld	ra,296(sp)
    800053ee:	7412                	ld	s0,288(sp)
...
00000000800053f8 <sys_unlink>:
{
    ...
    800053fe:	eda6                	sd	s1,216(sp)
    80005400:	e9ca                	sd	s2,208(sp)
    80005402:	e5ce                	sd	s3,200(sp)
  ...
  if(argstr(0, path, MAXPATH) < 0)
    ...
    80005414:	680080e7          	jalr	1664(ra) # 80002a90 <argstr>
    80005418:	18054163          	bltz	a0,8000559a <sys_unlink+0x1a2>
  begin_op();
    8000541c:	fffff097          	auipc	ra,0xfffff
    80005420:	be6080e7          	jalr	-1050(ra) # 80004002 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
    80005424:	fb040593          	addi	a1,s0,-80
    80005428:	f3040513          	addi	a0,s0,-208
    8000542c:	fffff097          	auipc	ra,0xfffff
    80005430:	9d4080e7          	jalr	-1580(ra) # 80003e00 <nameiparent>
    80005434:	84aa                	mv	s1,a0
    80005436:	c979                	beqz	a0,8000550c <sys_unlink+0x114>
  ilock(dp);
    80005438:	ffffe097          	auipc	ra,0xffffe
    8000543c:	186080e7          	jalr	390(ra) # 800035be <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    80005440:	00003597          	auipc	a1,0x3
    80005444:	2b858593          	addi	a1,a1,696 # 800086f8 <syscalls+0x2b0>
    80005448:	fb040513          	addi	a0,s0,-80
    8000544c:	ffffe097          	auipc	ra,0xffffe
    80005450:	6a4080e7          	jalr	1700(ra) # 80003af0 <namecmp>
    80005454:	14050a63          	beqz	a0,800055a8 <sys_unlink+0x1b0>
    80005458:	00003597          	auipc	a1,0x3
    8000545c:	2a858593          	addi	a1,a1,680 # 80008700 <syscalls+0x2b8>
    80005460:	fb040513          	addi	a0,s0,-80
    80005464:	ffffe097          	auipc	ra,0xffffe
    80005468:	68c080e7          	jalr	1676(ra) # 80003af0 <namecmp>
    8000546c:	12050e63          	beqz	a0,800055a8 <sys_unlink+0x1b0>
  if((ip = dirlookup(dp, name, &off)) == 0)
    80005470:	f2c40613          	addi	a2,s0,-212
    80005474:	fb040593          	addi	a1,s0,-80
    80005478:	8526                	mv	a0,s1
    8000547a:	ffffe097          	auipc	ra,0xffffe
    8000547e:	690080e7          	jalr	1680(ra) # 80003b0a <dirlookup>
    80005482:	892a                	mv	s2,a0
    80005484:	12050263          	beqz	a0,800055a8 <sys_unlink+0x1b0>
  ilock(ip);
    80005488:	ffffe097          	auipc	ra,0xffffe
    8000548c:	136080e7          	jalr	310(ra) # 800035be <ilock>
  if(ip->nlink < 1)
    80005490:	04a91783          	lh	a5,74(s2)
    80005494:	08f05263          	blez	a5,80005518 <sys_unlink+0x120>
  if(ip->type == T_DIR && !isdirempty(ip)){
    80005498:	04491703          	lh	a4,68(s2)
    8000549c:	4785                	li	a5,1
    8000549e:	08f70563          	beq	a4,a5,80005528 <sys_unlink+0x130>
  memset(&de, 0, sizeof(de));
    800054a2:	4641                	li	a2,16
    800054a4:	4581                	li	a1,0
    800054a6:	fc040513          	addi	a0,s0,-64
    800054aa:	ffffc097          	auipc	ra,0xffffc
    800054ae:	822080e7          	jalr	-2014(ra) # 80000ccc <memset>
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    800054b2:	4741                	li	a4,16
    800054b4:	f2c42683          	lw	a3,-212(s0)
    800054b8:	fc040613          	addi	a2,s0,-64
    800054bc:	4581                	li	a1,0
    800054be:	8526                	mv	a0,s1
    800054c0:	ffffe097          	auipc	ra,0xffffe
    800054c4:	4e0080e7          	jalr	1248(ra) # 800039a0 <writei>
    800054c8:	47c1                	li	a5,16
    800054ca:	0af51563          	bne	a0,a5,80005574 <sys_unlink+0x17c>
  if(ip->type == T_DIR){
    800054ce:	04491703          	lh	a4,68(s2)
    800054d2:	4785                	li	a5,1
    800054d4:	0af70863          	beq	a4,a5,80005584 <sys_unlink+0x18c>
  iunlockput(dp);
    800054d8:	8526                	mv	a0,s1
    800054da:	ffffe097          	auipc	ra,0xffffe
    800054de:	346080e7          	jalr	838(ra) # 80003820 <iunlockput>
  ip->nlink--;
    800054e2:	04a95783          	lhu	a5,74(s2)
    800054e6:	37fd                	addiw	a5,a5,-1
    800054e8:	04f91523          	sh	a5,74(s2)
  iupdate(ip);
    800054ec:	854a                	mv	a0,s2
    800054ee:	ffffe097          	auipc	ra,0xffffe
    800054f2:	004080e7          	jalr	4(ra) # 800034f2 <iupdate>
  iunlockput(ip);
    800054f6:	854a                	mv	a0,s2
    800054f8:	ffffe097          	auipc	ra,0xffffe
    800054fc:	328080e7          	jalr	808(ra) # 80003820 <iunlockput>
  end_op();
    80005500:	fffff097          	auipc	ra,0xfffff
    80005504:	b80080e7          	jalr	-1152(ra) # 80004080 <end_op>
  return 0;
    80005508:	4501                	li	a0,0
    8000550a:	a84d                	j	800055bc <sys_unlink+0x1c4>
    end_op();
    8000550c:	fffff097          	auipc	ra,0xfffff
    80005510:	b74080e7          	jalr	-1164(ra) # 80004080 <end_op>
    return -1;
    80005514:	557d                	li	a0,-1
    80005516:	a05d                	j	800055bc <sys_unlink+0x1c4>
    panic("unlink: nlink < 1");
    80005518:	00003517          	auipc	a0,0x3
    8000551c:	21050513          	addi	a0,a0,528 # 80008728 <syscalls+0x2e0>
    80005520:	ffffb097          	auipc	ra,0xffffb
    80005524:	01a080e7          	jalr	26(ra) # 8000053a <panic>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    80005528:	04c92703          	lw	a4,76(s2)
    8000552c:	02000793          	li	a5,32
    80005530:	f6e7f9e3          	bgeu	a5,a4,800054a2 <sys_unlink+0xaa>
    80005534:	02000993          	li	s3,32
    if(readi(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    80005538:	4741                	li	a4,16
    8000553a:	86ce                	mv	a3,s3
    8000553c:	f1840613          	addi	a2,s0,-232
    80005540:	4581                	li	a1,0
    80005542:	854a                	mv	a0,s2
    80005544:	ffffe097          	auipc	ra,0xffffe
    80005548:	32e080e7          	jalr	814(ra) # 80003872 <readi>
    8000554c:	47c1                	li	a5,16
    8000554e:	00f51b63          	bne	a0,a5,80005564 <sys_unlink+0x16c>
    if(de.inum != 0)
    80005552:	f1845783          	lhu	a5,-232(s0)
    80005556:	e7a1                	bnez	a5,8000559e <sys_unlink+0x1a6>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    80005558:	29c1                	addiw	s3,s3,16
    8000555a:	04c92783          	lw	a5,76(s2)
    8000555e:	fcf9ede3          	bltu	s3,a5,80005538 <sys_unlink+0x140>
    80005562:	b781                	j	800054a2 <sys_unlink+0xaa>
      panic("isdirempty: readi");
    80005564:	00003517          	auipc	a0,0x3
    80005568:	1dc50513          	addi	a0,a0,476 # 80008740 <syscalls+0x2f8>
    8000556c:	ffffb097          	auipc	ra,0xffffb
    80005570:	fce080e7          	jalr	-50(ra) # 8000053a <panic>
    panic("unlink: writei");
    80005574:	00003517          	auipc	a0,0x3
    80005578:	1e450513          	addi	a0,a0,484 # 80008758 <syscalls+0x310>
    ...
    80005594:	f62080e7          	jalr	-158(ra) # 800034f2 <iupdate>
    80005598:	b781                	j	800054d8 <sys_unlink+0xe0>
    return -1;
    8000559a:	557d                	li	a0,-1
    8000559c:	a005                	j	800055bc <sys_unlink+0x1c4>
    iunlockput(ip);
    8000559e:	854a                	mv	a0,s2
    800055a0:	ffffe097          	auipc	ra,0xffffe
    800055a4:	280080e7          	jalr	640(ra) # 80003820 <iunlockput>
  iunlockput(dp);
    800055a8:	8526                	mv	a0,s1
    800055aa:	ffffe097          	auipc	ra,0xffffe
    800055ae:	276080e7          	jalr	630(ra) # 80003820 <iunlockput>
  end_op();
    800055b2:	fffff097          	auipc	ra,0xfffff
    800055b6:	ace080e7          	jalr	-1330(ra) # 80004080 <end_op>
  return -1;
    800055ba:	557d                	li	a0,-1
}
    800055bc:	70ae                	ld	ra,232(sp)
    800055be:	740e                	ld	s0,224(sp)
    800055c0:	64ee                	ld	s1,216(sp)
    800055c2:	694e                	ld	s2,208(sp)
    800055c4:	69ae                	ld	s3,200(sp)
    800055c6:	616d                	addi	sp,sp,240
    800055c8:	8082                	ret

00000000800055ca <sys_open>:

uint64
sys_open(void)
{
    800055ca:	7131                	addi	sp,sp,-192
    800055cc:	fd06                	sd	ra,184(sp)
    800055ce:	f922                	sd	s0,176(sp)
    800055d0:	f526                	sd	s1,168(sp)
    800055d2:	f14a                	sd	s2,160(sp)
    800055d4:	ed4e                	sd	s3,152(sp)
    800055d6:	0180                	addi	s0,sp,192
  int fd, omode;
  struct file *f;
  struct inode *ip;
  int n;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    800055e6:	4ae080e7          	jalr	1198(ra) # 80002a90 <argstr>
    return -1;
    800055ea:	54fd                	li	s1,-1
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    800055ec:	0c054563          	bltz	a0,800056b6 <sys_open+0xec>
    800055f0:	f4c40593          	addi	a1,s0,-180
    800055f4:	4505                	li	a0,1
    800055f6:	ffffd097          	auipc	ra,0xffffd
    800055fa:	456080e7          	jalr	1110(ra) # 80002a4c <argint>
    800055fe:	0a054c63          	bltz	a0,800056b6 <sys_open+0xec>

  begin_op();
    80005602:	fffff097          	auipc	ra,0xfffff
    80005606:	a00080e7          	jalr	-1536(ra) # 80004002 <begin_op>

  if(omode & O_CREATE){
    8000560a:	f4c42783          	lw	a5,-180(s0)
    8000560e:	2007f713          	andi	a4,a5,512
    80005612:	cb79                	beqz	a4,800056e8 <sys_open+0x11e>

    //discerninr fichero normal de small file

    if (omode & O_SMALLFILE){//small file
    80005614:	83ad                	srli	a5,a5,0xb
    80005616:	8b85                	andi	a5,a5,1
    80005618:	c7dd                	beqz	a5,800056c6 <sys_open+0xfc>
      ip = create(path, T_SMALLFILE, 0, 0);
    8000561a:	4681                	li	a3,0
    8000561c:	4601                	li	a2,0
    8000561e:	4591                	li	a1,4
    80005620:	f5040513          	addi	a0,s0,-176
    80005624:	00000097          	auipc	ra,0x0
    80005628:	94c080e7          	jalr	-1716(ra) # 80004f70 <create>
    ...
    if(ip == 0){
    8000562e:	0a090763          	beqz	s2,800056dc <sys_open+0x112>
      end_op();
      return -1;
    }
  }
  ...
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    ...
    80005638:	00f71763          	bne	a4,a5,80005646 <sys_open+0x7c>
    8000563c:	04695703          	lhu	a4,70(s2)
    80005640:	47a5                	li	a5,9
    80005642:	0ee7e863          	bltu	a5,a4,80005732 <sys_open+0x168>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    ...
    8000564a:	dc8080e7          	jalr	-568(ra) # 8000440e <filealloc>
    8000564e:	89aa                	mv	s3,a0
    80005650:	10050e63          	beqz	a0,8000576c <sys_open+0x1a2>
    80005654:	00000097          	auipc	ra,0x0
    80005658:	8da080e7          	jalr	-1830(ra) # 80004f2e <fdalloc>
    8000565c:	84aa                	mv	s1,a0
    8000565e:	10054263          	bltz	a0,80005762 <sys_open+0x198>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_DEVICE){
    ...
    80005668:	0ef70063          	beq	a4,a5,80005748 <sys_open+0x17e>
    f->type = FD_DEVICE;
    f->major = ip->major;
  } else {
    f->type = FD_INODE;
  ...
  if((omode & O_TRUNC) && ip->type == T_FILE){ //CAMBIAR
    ...
    80005698:	c791                	beqz	a5,800056a4 <sys_open+0xda>
    8000569a:	04491703          	lh	a4,68(s2)
    8000569e:	4789                	li	a5,2
    800056a0:	0af70b63          	beq	a4,a5,80005756 <sys_open+0x18c>
    itrunc(ip);
  }
  ...
  iunlock(ip);
    ...
    800056aa:	fda080e7          	jalr	-38(ra) # 80003680 <iunlock>
  end_op();
    800056ae:	fffff097          	auipc	ra,0xfffff
    800056b2:	9d2080e7          	jalr	-1582(ra) # 80004080 <end_op>
  ...
  return fd;
    ...
    800056c4:	8082                	ret
      ip = create(path, T_FILE, 0, 0);
    800056c6:	4681                	li	a3,0
    800056c8:	4601                	li	a2,0
    800056ca:	4589                	li	a1,2
    800056cc:	f5040513          	addi	a0,s0,-176
    800056d0:	00000097          	auipc	ra,0x0
    800056d4:	8a0080e7          	jalr	-1888(ra) # 80004f70 <create>
    800056d8:	892a                	mv	s2,a0
    800056da:	bf91                	j	8000562e <sys_open+0x64>
      end_op();
    800056dc:	fffff097          	auipc	ra,0xfffff
    800056e0:	9a4080e7          	jalr	-1628(ra) # 80004080 <end_op>
      return -1;
    800056e4:	54fd                	li	s1,-1
    800056e6:	bfc1                	j	800056b6 <sys_open+0xec>
    if((ip = namei(path)) == 0){
    800056e8:	f5040513          	addi	a0,s0,-176
    800056ec:	ffffe097          	auipc	ra,0xffffe
    800056f0:	6f6080e7          	jalr	1782(ra) # 80003de2 <namei>
    800056f4:	892a                	mv	s2,a0
    800056f6:	c905                	beqz	a0,80005726 <sys_open+0x15c>
    ilock(ip);
    800056f8:	ffffe097          	auipc	ra,0xffffe
    800056fc:	ec6080e7          	jalr	-314(ra) # 800035be <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
    80005700:	04491703          	lh	a4,68(s2)
    80005704:	4785                	li	a5,1
    80005706:	f2f716e3          	bne	a4,a5,80005632 <sys_open+0x68>
    8000570a:	f4c42783          	lw	a5,-180(s0)
    8000570e:	df85                	beqz	a5,80005646 <sys_open+0x7c>
      iunlockput(ip);
    80005710:	854a                	mv	a0,s2
    80005712:	ffffe097          	auipc	ra,0xffffe
    80005716:	10e080e7          	jalr	270(ra) # 80003820 <iunlockput>
      end_op();
    8000571a:	fffff097          	auipc	ra,0xfffff
    8000571e:	966080e7          	jalr	-1690(ra) # 80004080 <end_op>
      return -1;
    80005722:	54fd                	li	s1,-1
    80005724:	bf49                	j	800056b6 <sys_open+0xec>
      end_op();
    80005726:	fffff097          	auipc	ra,0xfffff
    8000572a:	95a080e7          	jalr	-1702(ra) # 80004080 <end_op>
      return -1;
    8000572e:	54fd                	li	s1,-1
    80005730:	b759                	j	800056b6 <sys_open+0xec>
    iunlockput(ip);
    80005732:	854a                	mv	a0,s2
    80005734:	ffffe097          	auipc	ra,0xffffe
    80005738:	0ec080e7          	jalr	236(ra) # 80003820 <iunlockput>
    end_op();
    8000573c:	fffff097          	auipc	ra,0xfffff
    80005740:	944080e7          	jalr	-1724(ra) # 80004080 <end_op>
    return -1;
    80005744:	54fd                	li	s1,-1
    80005746:	bf85                	j	800056b6 <sys_open+0xec>
    f->type = FD_DEVICE;
    80005748:	00f9a023          	sw	a5,0(s3)
    f->major = ip->major;
    8000574c:	04691783          	lh	a5,70(s2)
    80005750:	02f99223          	sh	a5,36(s3)
    80005754:	b70d                	j	80005676 <sys_open+0xac>
    itrunc(ip);
    80005756:	854a                	mv	a0,s2
    80005758:	ffffe097          	auipc	ra,0xffffe
    8000575c:	f74080e7          	jalr	-140(ra) # 800036cc <itrunc>
    80005760:	b791                	j	800056a4 <sys_open+0xda>
      fileclose(f);
    80005762:	854e                	mv	a0,s3
    80005764:	fffff097          	auipc	ra,0xfffff
    80005768:	d66080e7          	jalr	-666(ra) # 800044ca <fileclose>
    iunlockput(ip);
    8000576c:	854a                	mv	a0,s2
    8000576e:	ffffe097          	auipc	ra,0xffffe
    80005772:	0b2080e7          	jalr	178(ra) # 80003820 <iunlockput>
    end_op();
    80005776:	fffff097          	auipc	ra,0xfffff
    8000577a:	90a080e7          	jalr	-1782(ra) # 80004080 <end_op>
    return -1;
    8000577e:	54fd                	li	s1,-1
    80005780:	bf1d                	j	800056b6 <sys_open+0xec>

0000000080005782 <sys_mkdir>:

uint64
sys_mkdir(void)
{
    80005782:	7175                	addi	sp,sp,-144
    80005784:	e506                	sd	ra,136(sp)
    80005786:	e122                	sd	s0,128(sp)
    80005788:	0900                	addi	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;

  begin_op();
    8000578a:	fffff097          	auipc	ra,0xfffff
    8000578e:	878080e7          	jalr	-1928(ra) # 80004002 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    800057a0:	2f4080e7          	jalr	756(ra) # 80002a90 <argstr>
    800057a4:	02054963          	bltz	a0,800057d6 <sys_mkdir+0x54>
    800057a8:	4681                	li	a3,0
    800057aa:	4601                	li	a2,0
    800057ac:	4585                	li	a1,1
    800057ae:	f7040513          	addi	a0,s0,-144
    800057b2:	fffff097          	auipc	ra,0xfffff
    800057b6:	7be080e7          	jalr	1982(ra) # 80004f70 <create>
    800057ba:	cd11                	beqz	a0,800057d6 <sys_mkdir+0x54>
    end_op();
    return -1;
  }
  iunlockput(ip);
    800057bc:	ffffe097          	auipc	ra,0xffffe
    800057c0:	064080e7          	jalr	100(ra) # 80003820 <iunlockput>
  end_op();
    800057c4:	fffff097          	auipc	ra,0xfffff
    800057c8:	8bc080e7          	jalr	-1860(ra) # 80004080 <end_op>
  return 0;
    800057cc:	4501                	li	a0,0
}
    800057ce:	60aa                	ld	ra,136(sp)
    800057d0:	640a                	ld	s0,128(sp)
    800057d2:	6149                	addi	sp,sp,144
    800057d4:	8082                	ret
    end_op();
    800057d6:	fffff097          	auipc	ra,0xfffff
    800057da:	8aa080e7          	jalr	-1878(ra) # 80004080 <end_op>
    return -1;
    800057de:	557d                	li	a0,-1
    800057e0:	b7fd                	j	800057ce <sys_mkdir+0x4c>

00000000800057e2 <sys_mknod>:
...
sys_mknod(void)
{
  ...
  begin_op();
    ...
    800057ee:	818080e7          	jalr	-2024(ra) # 80004002 <begin_op>
  if((argstr(0, path, MAXPATH)) < 0 ||
    800057f2:	08000613          	li	a2,128
    800057f6:	f7040593          	addi	a1,s0,-144
    800057fa:	4501                	li	a0,0
    800057fc:	ffffd097          	auipc	ra,0xffffd
    80005800:	294080e7          	jalr	660(ra) # 80002a90 <argstr>
    80005804:	04054a63          	bltz	a0,80005858 <sys_mknod+0x76>
     argint(1, &major) < 0 ||
    80005808:	f6c40593          	addi	a1,s0,-148
    8000580c:	4505                	li	a0,1
    8000580e:	ffffd097          	auipc	ra,0xffffd
    80005812:	23e080e7          	jalr	574(ra) # 80002a4c <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80005816:	04054163          	bltz	a0,80005858 <sys_mknod+0x76>
     argint(2, &minor) < 0 ||
    8000581a:	f6840593          	addi	a1,s0,-152
    8000581e:	4509                	li	a0,2
    80005820:	ffffd097          	auipc	ra,0xffffd
    80005824:	22c080e7          	jalr	556(ra) # 80002a4c <argint>
     argint(1, &major) < 0 ||
    80005828:	02054863          	bltz	a0,80005858 <sys_mknod+0x76>
     (ip = create(path, T_DEVICE, major, minor)) == 0){
    8000582c:	f6841683          	lh	a3,-152(s0)
    80005830:	f6c41603          	lh	a2,-148(s0)
    80005834:	458d                	li	a1,3
    80005836:	f7040513          	addi	a0,s0,-144
    8000583a:	fffff097          	auipc	ra,0xfffff
    8000583e:	736080e7          	jalr	1846(ra) # 80004f70 <create>
     argint(2, &minor) < 0 ||
    80005842:	c919                	beqz	a0,80005858 <sys_mknod+0x76>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80005844:	ffffe097          	auipc	ra,0xffffe
    80005848:	fdc080e7          	jalr	-36(ra) # 80003820 <iunlockput>
  end_op();
    8000584c:	fffff097          	auipc	ra,0xfffff
    80005850:	834080e7          	jalr	-1996(ra) # 80004080 <end_op>
  return 0;
    80005854:	4501                	li	a0,0
    80005856:	a031                	j	80005862 <sys_mknod+0x80>
    end_op();
    80005858:	fffff097          	auipc	ra,0xfffff
    8000585c:	828080e7          	jalr	-2008(ra) # 80004080 <end_op>
    return -1;
    80005860:	557d                	li	a0,-1
}
    80005862:	60ea                	ld	ra,152(sp)
    80005864:	644a                	ld	s0,144(sp)
    80005866:	610d                	addi	sp,sp,160
    80005868:	8082                	ret

000000008000586a <sys_chdir>:
...
sys_chdir(void)
{
    ...
    80005870:	e526                	sd	s1,136(sp)
    80005872:	e14a                	sd	s2,128(sp)
    80005874:	1100                	addi	s0,sp,160
  char path[MAXPATH];
  struct inode *ip;
  struct proc *p = myproc();
    80005876:	ffffc097          	auipc	ra,0xffffc
    8000587a:	120080e7          	jalr	288(ra) # 80001996 <myproc>
    8000587e:	892a                	mv	s2,a0
  
  begin_op();
    80005880:	ffffe097          	auipc	ra,0xffffe
    80005884:	782080e7          	jalr	1922(ra) # 80004002 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    80005888:	08000613          	li	a2,128
    8000588c:	f6040593          	addi	a1,s0,-160
    80005890:	4501                	li	a0,0
    80005892:	ffffd097          	auipc	ra,0xffffd
    80005896:	1fe080e7          	jalr	510(ra) # 80002a90 <argstr>
    8000589a:	04054b63          	bltz	a0,800058f0 <sys_chdir+0x86>
    8000589e:	f6040513          	addi	a0,s0,-160
    800058a2:	ffffe097          	auipc	ra,0xffffe
    800058a6:	540080e7          	jalr	1344(ra) # 80003de2 <namei>
    800058aa:	84aa                	mv	s1,a0
    800058ac:	c131                	beqz	a0,800058f0 <sys_chdir+0x86>
    end_op();
    return -1;
  }
  ilock(ip);
    800058ae:	ffffe097          	auipc	ra,0xffffe
    800058b2:	d10080e7          	jalr	-752(ra) # 800035be <ilock>
  if(ip->type != T_DIR){
    800058b6:	04449703          	lh	a4,68(s1)
    800058ba:	4785                	li	a5,1
    800058bc:	04f71063          	bne	a4,a5,800058fc <sys_chdir+0x92>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
    ...
    800058c6:	dbe080e7          	jalr	-578(ra) # 80003680 <iunlock>
  iput(p->cwd);
    800058ca:	15093503          	ld	a0,336(s2)
    800058ce:	ffffe097          	auipc	ra,0xffffe
    800058d2:	eaa080e7          	jalr	-342(ra) # 80003778 <iput>
  end_op();
    800058d6:	ffffe097          	auipc	ra,0xffffe
    800058da:	7aa080e7          	jalr	1962(ra) # 80004080 <end_op>
  p->cwd = ip;
    800058de:	14993823          	sd	s1,336(s2)
  return 0;
    800058e2:	4501                	li	a0,0
}
    800058e4:	60ea                	ld	ra,152(sp)
    800058e6:	644a                	ld	s0,144(sp)
    800058e8:	64aa                	ld	s1,136(sp)
    800058ea:	690a                	ld	s2,128(sp)
    800058ec:	610d                	addi	sp,sp,160
    800058ee:	8082                	ret
    end_op();
    800058f0:	ffffe097          	auipc	ra,0xffffe
    800058f4:	790080e7          	jalr	1936(ra) # 80004080 <end_op>
    return -1;
    800058f8:	557d                	li	a0,-1
    800058fa:	b7ed                	j	800058e4 <sys_chdir+0x7a>
    iunlockput(ip);
    800058fc:	8526                	mv	a0,s1
    800058fe:	ffffe097          	auipc	ra,0xffffe
    80005902:	f22080e7          	jalr	-222(ra) # 80003820 <iunlockput>
    end_op();
    80005906:	ffffe097          	auipc	ra,0xffffe
    8000590a:	77a080e7          	jalr	1914(ra) # 80004080 <end_op>
    return -1;
    8000590e:	557d                	li	a0,-1
    80005910:	bfd1                	j	800058e4 <sys_chdir+0x7a>

0000000080005912 <sys_exec>:

uint64
sys_exec(void)
{
    80005912:	7145                	addi	sp,sp,-464
    80005914:	e786                	sd	ra,456(sp)
    80005916:	e3a2                	sd	s0,448(sp)
    80005918:	ff26                	sd	s1,440(sp)
    8000591a:	fb4a                	sd	s2,432(sp)
    8000591c:	f74e                	sd	s3,424(sp)
    8000591e:	f352                	sd	s4,416(sp)
    80005920:	ef56                	sd	s5,408(sp)
    80005922:	0b80                	addi	s0,sp,464
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005928:	f4040593          	addi	a1,s0,-192
    8000592c:	4501                	li	a0,0
    8000592e:	ffffd097          	auipc	ra,0xffffd
    80005932:	162080e7          	jalr	354(ra) # 80002a90 <argstr>
    return -1;
    80005936:	597d                	li	s2,-1
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    80005938:	0c054b63          	bltz	a0,80005a0e <sys_exec+0xfc>
    8000593c:	e3840593          	addi	a1,s0,-456
    80005940:	4505                	li	a0,1
    80005942:	ffffd097          	auipc	ra,0xffffd
    80005946:	12c080e7          	jalr	300(ra) # 80002a6e <argaddr>
    8000594a:	0c054263          	bltz	a0,80005a0e <sys_exec+0xfc>
  }
  memset(argv, 0, sizeof(argv));
    8000594e:	10000613          	li	a2,256
    80005952:	4581                	li	a1,0
    80005954:	e4040513          	addi	a0,s0,-448
    80005958:	ffffb097          	auipc	ra,0xffffb
    8000595c:	374080e7          	jalr	884(ra) # 80000ccc <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
    80005960:	e4040493          	addi	s1,s0,-448
  memset(argv, 0, sizeof(argv));
    80005964:	89a6                	mv	s3,s1
    80005966:	4901                	li	s2,0
    if(i >= NELEM(argv)){
    80005968:	02000a13          	li	s4,32
    8000596c:	00090a9b          	sext.w	s5,s2
      goto bad;
    }
    if(fetchaddr(uargv+sizeof(uint64)*i, (uint64*)&uarg) < 0){
    80005970:	00391513          	slli	a0,s2,0x3
    80005974:	e3040593          	addi	a1,s0,-464
    80005978:	e3843783          	ld	a5,-456(s0)
    8000597c:	953e                	add	a0,a0,a5
    8000597e:	ffffd097          	auipc	ra,0xffffd
    80005982:	034080e7          	jalr	52(ra) # 800029b2 <fetchaddr>
    80005986:	02054a63          	bltz	a0,800059ba <sys_exec+0xa8>
      goto bad;
    }
    if(uarg == 0){
    8000598a:	e3043783          	ld	a5,-464(s0)
    8000598e:	c3b9                	beqz	a5,800059d4 <sys_exec+0xc2>
      argv[i] = 0;
      break;
    }
    argv[i] = kalloc();
    80005990:	ffffb097          	auipc	ra,0xffffb
    80005994:	150080e7          	jalr	336(ra) # 80000ae0 <kalloc>
    80005998:	85aa                	mv	a1,a0
    8000599a:	00a9b023          	sd	a0,0(s3)
    if(argv[i] == 0)
    8000599e:	cd11                	beqz	a0,800059ba <sys_exec+0xa8>
      goto bad;
    if(fetchstr(uarg, argv[i], PGSIZE) < 0)
    800059a0:	6605                	lui	a2,0x1
    800059a2:	e3043503          	ld	a0,-464(s0)
    800059a6:	ffffd097          	auipc	ra,0xffffd
    800059aa:	05e080e7          	jalr	94(ra) # 80002a04 <fetchstr>
    800059ae:	00054663          	bltz	a0,800059ba <sys_exec+0xa8>
    if(i >= NELEM(argv)){
    800059b2:	0905                	addi	s2,s2,1
    800059b4:	09a1                	addi	s3,s3,8
    800059b6:	fb491be3          	bne	s2,s4,8000596c <sys_exec+0x5a>
    kfree(argv[i]);
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    800059ba:	f4040913          	addi	s2,s0,-192
    800059be:	6088                	ld	a0,0(s1)
    800059c0:	c531                	beqz	a0,80005a0c <sys_exec+0xfa>
    kfree(argv[i]);
    800059c2:	ffffb097          	auipc	ra,0xffffb
    800059c6:	020080e7          	jalr	32(ra) # 800009e2 <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    800059ca:	04a1                	addi	s1,s1,8
    800059cc:	ff2499e3          	bne	s1,s2,800059be <sys_exec+0xac>
  return -1;
    800059d0:	597d                	li	s2,-1
    800059d2:	a835                	j	80005a0e <sys_exec+0xfc>
      argv[i] = 0;
    800059d4:	0a8e                	slli	s5,s5,0x3
    800059d6:	fc0a8793          	addi	a5,s5,-64 # ffffffffffffefc0 <end+0xffffffff7ffd8fc0>
    800059da:	00878ab3          	add	s5,a5,s0
    800059de:	e80ab023          	sd	zero,-384(s5)
  int ret = exec(path, argv);
    800059e2:	e4040593          	addi	a1,s0,-448
    800059e6:	f4040513          	addi	a0,s0,-192
    800059ea:	fffff097          	auipc	ra,0xfffff
    800059ee:	134080e7          	jalr	308(ra) # 80004b1e <exec>
    800059f2:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    800059f4:	f4040993          	addi	s3,s0,-192
    800059f8:	6088                	ld	a0,0(s1)
    800059fa:	c911                	beqz	a0,80005a0e <sys_exec+0xfc>
    kfree(argv[i]);
    800059fc:	ffffb097          	auipc	ra,0xffffb
    80005a00:	fe6080e7          	jalr	-26(ra) # 800009e2 <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005a04:	04a1                	addi	s1,s1,8
    80005a06:	ff3499e3          	bne	s1,s3,800059f8 <sys_exec+0xe6>
    80005a0a:	a011                	j	80005a0e <sys_exec+0xfc>
  return -1;
    80005a0c:	597d                	li	s2,-1
}
    80005a0e:	854a                	mv	a0,s2
    80005a10:	60be                	ld	ra,456(sp)
    80005a12:	641e                	ld	s0,448(sp)
    80005a14:	74fa                	ld	s1,440(sp)
    80005a16:	795a                	ld	s2,432(sp)
    80005a18:	79ba                	ld	s3,424(sp)
    80005a1a:	7a1a                	ld	s4,416(sp)
    80005a1c:	6afa                	ld	s5,408(sp)
    80005a1e:	6179                	addi	sp,sp,464
    80005a20:	8082                	ret

0000000080005a22 <sys_pipe>:

uint64
sys_pipe(void)
{
    80005a22:	7139                	addi	sp,sp,-64
    80005a24:	fc06                	sd	ra,56(sp)
    80005a26:	f822                	sd	s0,48(sp)
    80005a28:	f426                	sd	s1,40(sp)
  ...
  struct proc *p = myproc();
    ...
    80005a30:	f6a080e7          	jalr	-150(ra) # 80001996 <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    80005a40:	032080e7          	jalr	50(ra) # 80002a6e <argaddr>
    return -1;
    80005a44:	57fd                	li	a5,-1
  if(argaddr(0, &fdarray) < 0)
    80005a46:	0e054063          	bltz	a0,80005b26 <sys_pipe+0x104>
  if(pipealloc(&rf, &wf) < 0)
    80005a4a:	fc840593          	addi	a1,s0,-56
    80005a4e:	fd040513          	addi	a0,s0,-48
    80005a52:	fffff097          	auipc	ra,0xfffff
    80005a56:	da8080e7          	jalr	-600(ra) # 800047fa <pipealloc>
    return -1;
    80005a5a:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    80005a5c:	0c054563          	bltz	a0,80005b26 <sys_pipe+0x104>
  fd0 = -1;
    80005a60:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    80005a64:	fd043503          	ld	a0,-48(s0)
    80005a68:	fffff097          	auipc	ra,0xfffff
    80005a6c:	4c6080e7          	jalr	1222(ra) # 80004f2e <fdalloc>
    80005a70:	fca42223          	sw	a0,-60(s0)
    80005a74:	08054c63          	bltz	a0,80005b0c <sys_pipe+0xea>
    80005a78:	fc843503          	ld	a0,-56(s0)
    80005a7c:	fffff097          	auipc	ra,0xfffff
    80005a80:	4b2080e7          	jalr	1202(ra) # 80004f2e <fdalloc>
    80005a84:	fca42023          	sw	a0,-64(s0)
    80005a88:	06054963          	bltz	a0,80005afa <sys_pipe+0xd8>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80005a8e:	fc440613          	addi	a2,s0,-60
    80005a92:	fd843583          	ld	a1,-40(s0)
    80005a96:	68a8                	ld	a0,80(s1)
    80005a98:	ffffc097          	auipc	ra,0xffffc
    80005a9c:	bc2080e7          	jalr	-1086(ra) # 8000165a <copyout>
    80005aa0:	02054063          	bltz	a0,80005ac0 <sys_pipe+0x9e>
     copyout(p->pagetable, fdarray+sizeof(fd0), (char *)&fd1, sizeof(fd1)) < 0){
    80005aa4:	4691                	li	a3,4
    80005aa6:	fc040613          	addi	a2,s0,-64
    80005aaa:	fd843583          	ld	a1,-40(s0)
    80005aae:	0591                	addi	a1,a1,4
    80005ab0:	68a8                	ld	a0,80(s1)
    80005ab2:	ffffc097          	auipc	ra,0xffffc
    80005ab6:	ba8080e7          	jalr	-1112(ra) # 8000165a <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  return 0;
    80005aba:	4781                	li	a5,0
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    80005abc:	06055563          	bgez	a0,80005b26 <sys_pipe+0x104>
    p->ofile[fd0] = 0;
    80005ac0:	fc442783          	lw	a5,-60(s0)
    80005ac4:	07e9                	addi	a5,a5,26
    80005ac6:	078e                	slli	a5,a5,0x3
    80005ac8:	97a6                	add	a5,a5,s1
    80005aca:	0007b023          	sd	zero,0(a5)
    p->ofile[fd1] = 0;
    80005ace:	fc042783          	lw	a5,-64(s0)
    80005ad2:	07e9                	addi	a5,a5,26
    80005ad4:	078e                	slli	a5,a5,0x3
    80005ad6:	00f48533          	add	a0,s1,a5
    80005ada:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    80005ade:	fd043503          	ld	a0,-48(s0)
    80005ae2:	fffff097          	auipc	ra,0xfffff
    80005ae6:	9e8080e7          	jalr	-1560(ra) # 800044ca <fileclose>
    fileclose(wf);
    80005aea:	fc843503          	ld	a0,-56(s0)
    80005aee:	fffff097          	auipc	ra,0xfffff
    80005af2:	9dc080e7          	jalr	-1572(ra) # 800044ca <fileclose>
    return -1;
    80005af6:	57fd                	li	a5,-1
    80005af8:	a03d                	j	80005b26 <sys_pipe+0x104>
    if(fd0 >= 0)
    80005afa:	fc442783          	lw	a5,-60(s0)
    80005afe:	0007c763          	bltz	a5,80005b0c <sys_pipe+0xea>
      p->ofile[fd0] = 0;
    ...
    80005b14:	9ba080e7          	jalr	-1606(ra) # 800044ca <fileclose>
    fileclose(wf);
    80005b18:	fc843503          	ld	a0,-56(s0)
    80005b1c:	fffff097          	auipc	ra,0xfffff
    80005b20:	9ae080e7          	jalr	-1618(ra) # 800044ca <fileclose>
    return -1;
    80005b24:	57fd                	li	a5,-1
}
    80005b26:	853e                	mv	a0,a5
    80005b28:	70e2                	ld	ra,56(sp)
    80005b2a:	7442                	ld	s0,48(sp)
    80005b2c:	74a2                	ld	s1,40(sp)
    80005b2e:	6121                	addi	sp,sp,64
    80005b30:	8082                	ret
	...
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80005d14:	a5850513          	addi	a0,a0,-1448 # 80008768 <syscalls+0x320>
    80005d18:	ffffb097          	auipc	ra,0xffffb
    80005d1c:	822080e7          	jalr	-2014(ra) # 8000053a <panic>
    panic("free_desc 2");
    80005d20:	00003517          	auipc	a0,0x3
    80005d24:	a5850513          	addi	a0,a0,-1448 # 80008778 <syscalls+0x330>
...
0000000080005d30 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005d3e:	a4e58593          	addi	a1,a1,-1458 # 80008788 <syscalls+0x340>
...
virtio_disk_intr()
{
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    800061b6:	64650513          	addi	a0,a0,1606 # 800087f8 <syscalls+0x3b0>
