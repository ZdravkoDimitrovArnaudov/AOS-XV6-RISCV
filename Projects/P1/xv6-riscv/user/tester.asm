...
main(int argc, char *argv[])
{
  ...
  printf("%s", "** Placeholder program for grading scripts **\n");
   ...
   c:	7b858593          	addi	a1,a1,1976 # 7c0 <malloc+0xea>
  10:	00000517          	auipc	a0,0x0
  14:	7e050513          	addi	a0,a0,2016 # 7f0 <malloc+0x11a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 388:	47c50513          	addi	a0,a0,1148 # 800 <digits>
 38c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 454:	3b0b8b93          	addi	s7,s7,944 # 800 <digits>
 ...
 594:	26890913          	addi	s2,s2,616 # 7f8 <malloc+0x122>
        while(*s != 0){
...
free(void *ap)
{
 ...
 65c:	1c07b783          	ld	a5,448(a5) # 818 <freep>
 ...
 68a:	00e6ea63          	bltu	a3,a4,69e <free+0x50>
{
 ...
 6cc:	14f73823          	sd	a5,336(a4) # 818 <freep>
}
 6d0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6fe:	11e53503          	ld	a0,286(a0) # 818 <freep>
 ...
 726:	0f690913          	addi	s2,s2,246 # 818 <freep>
  if(p == (char*)-1)
 72a:	5afd                	li	s5,-1
 72c:	a88d                	j	79e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 72e:	00000797          	auipc	a5,0x0
 732:	0f278793          	addi	a5,a5,242 # 820 <base>
 736:	00000717          	auipc	a4,0x0
 73a:	0ef73123          	sd	a5,226(a4) # 818 <freep>
 73e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 760:	0aa73e23          	sd	a0,188(a4) # 818 <freep>
      return (void*)(p + 1);
