...
main(int argc, char *argv[])
{
  ...
  14:	7d050513          	addi	a0,a0,2000 # 7e0 <malloc+0x118>
  18:	00000097          	auipc	ra,0x0
  1c:	5f8080e7          	jalr	1528(ra) # 610 <printf>
  exit(0);
  20:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 43e:	3b6c8c93          	addi	s9,s9,950 # 7f0 <malloc+0x128>
 ...
 572:	27a98993          	addi	s3,s3,634 # 7e8 <malloc+0x120>
        while(*s != 0){
 576:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 654:	2107b783          	ld	a5,528(a5) # 860 <freep>
 ...
 67c:	00e6ea63          	bltu	a3,a4,690 <free+0x4a>
{
 ...
 6be:	1af73323          	sd	a5,422(a4) # 860 <freep>
}
 6c2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6f0:	17453503          	ld	a0,372(a0) # 860 <freep>
 ...
 718:	14c90913          	addi	s2,s2,332 # 860 <freep>
  if(p == (char*)-1)
 71c:	5afd                	li	s5,-1
 71e:	a895                	j	792 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 720:	00000797          	auipc	a5,0x0
 724:	14878793          	addi	a5,a5,328 # 868 <base>
 728:	00000717          	auipc	a4,0x0
 72c:	12f73c23          	sd	a5,312(a4) # 860 <freep>
 730:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 754:	10a73823          	sd	a0,272(a4) # 860 <freep>
      return (void*)(p + 1);
