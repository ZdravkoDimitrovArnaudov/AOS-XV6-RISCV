...
user/_ps:     formato del fichero elf64-littleriscv
...
int main (void)
{
  ...
  10:	81010113          	addi	sp,sp,-2032
    struct pstat ps ;
    if (getpinfo(&ps) < 0){
  14:	74fd                	lui	s1,0xfffff
  16:	7d048793          	addi	a5,s1,2000 # fffffffffffff7d0 <__global_pointer$+0xffffffffffffe6e7>
  1a:	00f40533          	add	a0,s0,a5
  1e:	00000097          	auipc	ra,0x0
  22:	376080e7          	jalr	886(ra) # 394 <getpinfo>
  26:	7d048793          	addi	a5,s1,2000
  2a:	00f404b3          	add	s1,s0,a5
  2e:	9d040993          	addi	s3,s0,-1584
  ...
  38:	814a0a13          	addi	s4,s4,-2028 # 848 <malloc+0x11a>
    if (getpinfo(&ps) < 0){
  3c:	02055263          	bgez	a0,60 <main+0x60>
        printf ("ERROR. La llamada ha devuelto codigo -1\n");
  40:	00000517          	auipc	a0,0x0
  44:	7d850513          	addi	a0,a0,2008 # 818 <malloc+0xea>
  48:	00000097          	auipc	ra,0x0
  4c:	62e080e7          	jalr	1582(ra) # 676 <printf>
        exit(1);
  50:	4505                	li	a0,1
  52:	00000097          	auipc	ra,0x0
  56:	2a2080e7          	jalr	674(ra) # 2f4 <exit>
    for (int i = 0; i < NPROC; i++){
  5a:	04a1                	addi	s1,s1,8
  5c:	03348163          	beq	s1,s3,7e <main+0x7e>
        if (ps.inuse[i]==1){
  60:	609c                	ld	a5,0(s1)
  62:	ff279ce3          	bne	a5,s2,5a <main+0x5a>
            printf ("PID:   %d; LTICKS:     %d; HTICKS:     %d\n", ps.pid[i], ps.lticks[i], ps.hticks[i]);   
  66:	4004b683          	ld	a3,1024(s1)
  6a:	6004b603          	ld	a2,1536(s1)
  6e:	2004b583          	ld	a1,512(s1)
  72:	8552                	mv	a0,s4
  74:	00000097          	auipc	ra,0x0
  78:	602080e7          	jalr	1538(ra) # 676 <printf>
  7c:	bff9                	j	5a <main+0x5a>
        }
    }
  ...
  84:	274080e7          	jalr	628(ra) # 2f4 <exit>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a4:	3e0c8c93          	addi	s9,s9,992 # 880 <malloc+0x152>
 ...
 4b2:	42ab8b93          	addi	s7,s7,1066 # 8d8 <digits>
 ...
 5d8:	2a498993          	addi	s3,s3,676 # 878 <malloc+0x14a>
        while(*s != 0){
 5dc:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6ba:	23a7b783          	ld	a5,570(a5) # 8f0 <freep>
 ...
 6e2:	00e6ea63          	bltu	a3,a4,6f6 <free+0x4a>
{
 ...
 724:	1cf73823          	sd	a5,464(a4) # 8f0 <freep>
}
 728:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 756:	19e53503          	ld	a0,414(a0) # 8f0 <freep>
 ...
 77e:	17690913          	addi	s2,s2,374 # 8f0 <freep>
  if(p == (char*)-1)
 782:	5afd                	li	s5,-1
 784:	a895                	j	7f8 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 786:	00000797          	auipc	a5,0x0
 78a:	17278793          	addi	a5,a5,370 # 8f8 <base>
 78e:	00000717          	auipc	a4,0x0
 792:	16f73123          	sd	a5,354(a4) # 8f0 <freep>
 796:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ba:	12a73d23          	sd	a0,314(a4) # 8f0 <freep>
      return (void*)(p + 1);
