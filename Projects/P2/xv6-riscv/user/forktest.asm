...
forktest(void)
{
  ...
  44:	66850513          	addi	a0,a0,1640 # 6a8 <setpri+0x8>
  ...
  b2:	60a50513          	addi	a0,a0,1546 # 6b8 <setpri+0x18>
  ...
  dc:	60050513          	addi	a0,a0,1536 # 6d8 <setpri+0x38>
 ...
 11e:	5d650513          	addi	a0,a0,1494 # 6f0 <setpri+0x50>
 ...
 138:	5d450513          	addi	a0,a0,1492 # 708 <setpri+0x68>
