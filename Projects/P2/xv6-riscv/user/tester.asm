...
user/_tester:     formato del fichero elf64-littleriscv
...
main(int argc, char *argv[])
{
  ...
  14:	7d850513          	addi	a0,a0,2008 # 7e8 <malloc+0x118>
  18:	00000097          	auipc	ra,0x0
  1c:	600080e7          	jalr	1536(ra) # 618 <printf>
  exit(0);
  20:	4501                	li	a0,0
  22:	00000097          	auipc	ra,0x0
  26:	274080e7          	jalr	628(ra) # 296 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 386:	4ce50513          	addi	a0,a0,1230 # 850 <digits>
 38a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 446:	3b6c8c93          	addi	s9,s9,950 # 7f8 <malloc+0x128>
 ...
 454:	400b8b93          	addi	s7,s7,1024 # 850 <digits>
 ...
 57a:	27a98993          	addi	s3,s3,634 # 7f0 <malloc+0x120>
        while(*s != 0){
 57e:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 65c:	2107b783          	ld	a5,528(a5) # 868 <freep>
 ...
 684:	00e6ea63          	bltu	a3,a4,698 <free+0x4a>
{
 ...
 6c6:	1af73323          	sd	a5,422(a4) # 868 <freep>
}
 6ca:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 6f8:	17453503          	ld	a0,372(a0) # 868 <freep>
 ...
 720:	14c90913          	addi	s2,s2,332 # 868 <freep>
  if(p == (char*)-1)
 724:	5afd                	li	s5,-1
 726:	a895                	j	79a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 728:	00000797          	auipc	a5,0x0
 72c:	14878793          	addi	a5,a5,328 # 870 <base>
 730:	00000717          	auipc	a4,0x0
 734:	12f73c23          	sd	a5,312(a4) # 868 <freep>
 738:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 75c:	10a73823          	sd	a0,272(a4) # 868 <freep>
      return (void*)(p + 1);
